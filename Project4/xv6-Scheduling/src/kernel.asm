...
80100046:	e8 b4 42 00 00       	call   801042ff <acquire>
...
8010007c:	e8 e3 42 00 00       	call   80104364 <release>
      acquiresleep(&b->lock);
80100081:	8d 43 0c             	lea    0xc(%ebx),%eax
80100084:	89 04 24             	mov    %eax,(%esp)
80100087:	e8 5f 40 00 00       	call   801040eb <acquiresleep>
      return b;
...
801000ca:	e8 95 42 00 00       	call   80104364 <release>
      acquiresleep(&b->lock);
801000cf:	8d 43 0c             	lea    0xc(%ebx),%eax
801000d2:	89 04 24             	mov    %eax,(%esp)
801000d5:	e8 11 40 00 00       	call   801040eb <acquiresleep>
      return b;
...
801000ea:	68 80 6c 10 80       	push   $0x80106c80
...
801000fb:	68 91 6c 10 80       	push   $0x80106c91
80100100:	68 c0 b5 10 80       	push   $0x8010b5c0
80100105:	e8 b9 40 00 00       	call   801041c3 <initlock>
...
8010013a:	68 98 6c 10 80       	push   $0x80106c98
8010013f:	8d 43 0c             	lea    0xc(%ebx),%eax
80100142:	50                   	push   %eax
80100143:	e8 70 3f 00 00       	call   801040b8 <initsleeplock>
...
801001a8:	e8 c8 3f 00 00       	call   80104175 <holdingsleep>
...
801001cb:	68 9f 6c 10 80       	push   $0x80106c9f
...
801001e4:	e8 8c 3f 00 00       	call   80104175 <holdingsleep>
...
801001f4:	e8 41 3f 00 00       	call   8010413a <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100200:	e8 fa 40 00 00       	call   801042ff <acquire>
  b->refcnt--;
...
8010024c:	e8 13 41 00 00       	call   80104364 <release>
}
...
8010025e:	68 a6 6c 10 80       	push   $0x80106ca6
...
8010028a:	e8 70 40 00 00       	call   801042ff <acquire>
  while(n > 0){
...
801002d1:	e8 8e 40 00 00       	call   80104364 <release>
        ilock(ip);
...
80100331:	e8 2e 40 00 00       	call   80104364 <release>
  ilock(ip);
...
80100363:	68 ad 6c 10 80       	push   $0x80106cad
...
80100373:	e8 93 02 00 00       	call   8010060b <cprintf>
  cprintf("\n");
80100378:	c7 04 24 b3 72 10 80 	movl   $0x801072b3,(%esp)
...
8010038f:	e8 4a 3e 00 00       	call   801041de <getcallerpcs>
  for(i=0; i<10; i++)
...
801003a5:	68 c1 6c 10 80       	push   $0x80106cc1
...
8010049e:	68 c5 6c 10 80       	push   $0x80106cc5
...
801004ba:	e8 67 3f 00 00       	call   80104426 <memmove>
    pos -= 80;
...
801004d9:	e8 cd 3e 00 00       	call   801043ab <memset>
...
80100506:	e8 49 53 00 00       	call   80105854 <uartputc>
...
8010051f:	e8 30 53 00 00       	call   80105854 <uartputc>
80100524:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010052b:	e8 24 53 00 00       	call   80105854 <uartputc>
80100530:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100537:	e8 18 53 00 00       	call   80105854 <uartputc>
...
80100576:	0f b6 92 f0 6c 10 80 	movzbl -0x7fef9310(%edx),%edx
...
801005ca:	e8 30 3d 00 00       	call   801042ff <acquire>
  for(i = 0; i < n; i++)
...
801005f1:	e8 6e 3d 00 00       	call   80104364 <release>
  ilock(ip);
...
80100638:	e8 c2 3c 00 00       	call   801042ff <acquire>
8010063d:	83 c4 10             	add    $0x10,%esp
80100640:	eb de                	jmp    80100620 <cprintf+0x15>
    panic("null fmt");
80100642:	83 ec 0c             	sub    $0xc,%esp
80100645:	68 df 6c 10 80       	push   $0x80106cdf
...
801006ec:	75 12                	jne    80100700 <cprintf+0xf5>
        s = "(null)";
801006ee:	be d8 6c 10 80       	mov    $0x80106cd8,%esi
...
80100734:	e8 2b 3c 00 00       	call   80104364 <release>
...
8010074f:	e8 ab 3b 00 00       	call   801042ff <acquire>
  while((c = getc()) >= 0){
...
80100873:	e8 ec 3a 00 00       	call   80104364 <release>
  if(doprocdump) {
...
80100894:	68 e8 6c 10 80       	push   $0x80106ce8
80100899:	68 20 a5 10 80       	push   $0x8010a520
8010089e:	e8 20 39 00 00       	call   801041c3 <initlock>
...
80100952:	68 01 6d 10 80       	push   $0x80106d01
...
80100970:	75 b2                	jne    80100924 <exec+0x52>
  if((pgdir = setupkvm()) == 0)
80100972:	e8 9d 60 00 00       	call   80106a14 <setupkvm>
...
80100a06:	e8 af 5e 00 00       	call   801068ba <allocuvm>
...
80100a38:	e8 4b 5d 00 00       	call   80106788 <loaduvm>
...
80100a74:	e8 41 5e 00 00       	call   801068ba <allocuvm>
...
80100a9d:	e8 02 5f 00 00       	call   801069a4 <freevm>
...
80100abc:	e8 d8 5f 00 00       	call   80106a99 <clearpteu>
...
80100ae2:	e8 66 3a 00 00       	call   8010454d <strlen>
...
80100af4:	e8 54 3a 00 00       	call   8010454d <strlen>
80100af9:	83 c0 01             	add    $0x1,%eax
80100afc:	50                   	push   %eax
80100afd:	ff 36                	pushl  (%esi)
80100aff:	57                   	push   %edi
80100b00:	ff b5 ec fe ff ff    	pushl  -0x114(%ebp)
80100b06:	e8 dc 60 00 00       	call   80106be7 <copyout>
...
80100b66:	e8 7c 60 00 00       	call   80106be7 <copyout>
...
80100ba3:	e8 6a 39 00 00       	call   80104512 <safestrcpy>
...
80100bd1:	e8 31 5a 00 00       	call   80106607 <switchuvm>
  freevm(oldpgdir);
80100bd6:	89 1c 24             	mov    %ebx,(%esp)
80100bd9:	e8 c6 5d 00 00       	call   801069a4 <freevm>
  return 0;
...
80100c19:	68 0d 6d 10 80       	push   $0x80106d0d
80100c1e:	68 c0 ff 10 80       	push   $0x8010ffc0
80100c23:	e8 9b 35 00 00       	call   801041c3 <initlock>
}
...
80100c39:	e8 c1 36 00 00       	call   801042ff <acquire>
...
80100c68:	e8 f7 36 00 00       	call   80104364 <release>
      return f;
...
80100c7f:	e8 e0 36 00 00       	call   80104364 <release>
  return 0;
...
80100c9d:	e8 5d 36 00 00       	call   801042ff <acquire>
  if(f->ref < 1)
...
80100cba:	e8 a5 36 00 00       	call   80104364 <release>
  return f;
}
...
80100cc9:	68 14 6d 10 80       	push   $0x80106d14
...
80100ce2:	e8 18 36 00 00       	call   801042ff <acquire>
  if(f->ref < 1)
...
80100d03:	e8 5c 36 00 00       	call   80104364 <release>
    return;
...
80100d13:	68 1c 6d 10 80       	push   $0x80106d1c
...
80100d49:	e8 16 36 00 00       	call   80104364 <release>
  if(ff.type == FD_PIPE)
...
80100e4b:	68 26 6d 10 80       	push   $0x80106d26
...
80100f10:	68 2f 6d 10 80       	push   $0x80106d2f
...
80100f2d:	68 35 6d 10 80       	push   $0x80106d35
...
80100f8a:	e8 97 34 00 00       	call   80104426 <memmove>
...
80100f9a:	e8 87 34 00 00       	call   80104426 <memmove>
    name[len] = 0;
...
80100fdf:	e8 c7 33 00 00       	call   801043ab <memset>
  log_write(bp);
...
801010a3:	68 3f 6d 10 80       	push   $0x80106d3f
...
8010117d:	68 55 6d 10 80       	push   $0x80106d55
...
8010119a:	e8 60 31 00 00       	call   801042ff <acquire>
...
801011e1:	e8 7e 31 00 00       	call   80104364 <release>
      return ip;
...
80101217:	e8 48 31 00 00       	call   80104364 <release>
  return ip;
...
8010122c:	68 68 6d 10 80       	push   $0x80106d68
...
80101255:	e8 cc 31 00 00       	call   80104426 <memmove>
  brelse(bp);
...
801012e2:	68 78 6d 10 80       	push   $0x80106d78
...
801012f3:	68 8b 6d 10 80       	push   $0x80106d8b
801012f8:	68 e0 09 11 80       	push   $0x801109e0
801012fd:	e8 c1 2e 00 00       	call   801041c3 <initlock>
  for(i = 0; i < NINODE; i++) {
...
8010130f:	68 92 6d 10 80       	push   $0x80106d92
80101314:	8d 14 db             	lea    (%ebx,%ebx,8),%edx
80101317:	89 d0                	mov    %edx,%eax
80101319:	c1 e0 04             	shl    $0x4,%eax
8010131c:	05 20 0a 11 80       	add    $0x80110a20,%eax
80101321:	50                   	push   %eax
80101322:	e8 91 2d 00 00       	call   801040b8 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010136c:	68 f8 6d 10 80       	push   $0x80106df8
...
801013df:	68 98 6d 10 80       	push   $0x80106d98
...
801013f1:	e8 b5 2f 00 00       	call   801043ab <memset>
      dip->type = type;
...
80101480:	e8 a1 2f 00 00       	call   80104426 <memmove>
  log_write(bp);
...
80101560:	e8 9a 2d 00 00       	call   801042ff <acquire>
  ip->ref++;
...
80101575:	e8 ea 2d 00 00       	call   80104364 <release>
}
...
8010159a:	e8 4c 2b 00 00       	call   801040eb <acquiresleep>
  if(ip->valid == 0){
...
801015b2:	68 aa 6d 10 80       	push   $0x80106daa
...
80101614:	e8 0d 2e 00 00       	call   80104426 <memmove>
    brelse(bp);
...
80101639:	68 b0 6d 10 80       	push   $0x80106db0
...
80101656:	e8 1a 2b 00 00       	call   80104175 <holdingsleep>
...
8010166c:	e8 c9 2a 00 00       	call   8010413a <releasesleep>
}
...
8010167e:	68 bf 6d 10 80       	push   $0x80106dbf
...
80101698:	e8 4e 2a 00 00       	call   801040eb <acquiresleep>
...
801016b1:	e8 84 2a 00 00       	call   8010413a <releasesleep>
  acquire(&icache.lock);
801016b6:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016bd:	e8 3d 2c 00 00       	call   801042ff <acquire>
  ip->ref--;
...
801016d2:	e8 8d 2c 00 00       	call   80104364 <release>
}
...
801016ea:	e8 10 2c 00 00       	call   801042ff <acquire>
    int r = ip->ref;
801016ef:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016f2:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016f9:	e8 66 2c 00 00       	call   80104364 <release>
    if(r == 1){
...
8010182a:	e8 f7 2b 00 00       	call   80104426 <memmove>
    brelse(bp);
...
80101926:	e8 fb 2a 00 00       	call   80104426 <memmove>
    log_write(bp);
...
801019a9:	e8 df 2a 00 00       	call   8010448d <strncmp>
}
801019ae:	c9                   	leave  
801019af:	c3                   	ret    
...
801019d0:	68 c7 6d 10 80       	push   $0x80106dc7
801019d5:	e8 6e e9 ff ff       	call   80100348 <panic>
      panic("dirlookup read");
801019da:	83 ec 0c             	sub    $0xc,%esp
801019dd:	68 d9 6d 10 80       	push   $0x80106dd9
...
80101b92:	68 e8 6d 10 80       	push   $0x80106de8
...
80101ba9:	e8 1c 29 00 00       	call   801044ca <strncpy>
  de.inum = inum;
...
80101ccc:	68 4b 6e 10 80       	push   $0x80106e4b
80101cd1:	e8 72 e6 ff ff       	call   80100348 <panic>
    panic("incorrect blockno");
80101cd6:	83 ec 0c             	sub    $0xc,%esp
80101cd9:	68 54 6e 10 80       	push   $0x80106e54
...
80101d06:	68 66 6e 10 80       	push   $0x80106e66
80101d0b:	68 80 a5 10 80       	push   $0x8010a580
80101d10:	e8 ae 24 00 00       	call   801041c3 <initlock>
...
80101d80:	e8 7a 25 00 00       	call   801042ff <acquire>
...
80101dcb:	e8 94 25 00 00       	call   80104364 <release>
...
80101de2:	e8 7d 25 00 00       	call   80104364 <release>
    return;
...
80101e1a:	e8 56 23 00 00       	call   80104175 <holdingsleep>
...
80101e47:	e8 b3 24 00 00       	call   801042ff <acquire>
...
80101e60:	68 6a 6e 10 80       	push   $0x80106e6a
80101e65:	e8 de e4 ff ff       	call   80100348 <panic>
    panic("iderw: nothing to do");
80101e6a:	83 ec 0c             	sub    $0xc,%esp
80101e6d:	68 80 6e 10 80       	push   $0x80106e80
80101e72:	e8 d1 e4 ff ff       	call   80100348 <panic>
    panic("iderw: ide disk 1 not present");
80101e77:	83 ec 0c             	sub    $0xc,%esp
80101e7a:	68 95 6e 10 80       	push   $0x80106e95
...
80101ec3:	e8 9c 24 00 00       	call   80104364 <release>
}
...
80101f3f:	68 b4 6e 10 80       	push   $0x80106eb4
...
80101fd6:	e8 d0 23 00 00       	call   801043ab <memset>
...
8010206f:	68 ec 6e 10 80       	push   $0x80106eec
80102074:	68 40 26 11 80       	push   $0x80112640
80102079:	e8 45 21 00 00       	call   801041c3 <initlock>
  kmem.use_lock = 0;
...
80102150:	0f b6 8a 20 70 10 80 	movzbl -0x7fef8fe0(%edx),%ecx
80102157:	0b 0d b4 a5 10 80    	or     0x8010a5b4,%ecx
  shift ^= togglecode[data];
8010215d:	0f b6 82 20 6f 10 80 	movzbl -0x7fef90e0(%edx),%eax
...
80102171:	8b 04 85 00 6f 10 80 	mov    -0x7fef9100(,%eax,4),%eax
...
801021a9:	83 e2 7f             	and    $0x7f,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801021ac:	0f b6 82 20 70 10 80 	movzbl -0x7fef8fe0(%edx),%eax
...
80102497:	e8 55 1f 00 00       	call   801043f1 <memcmp>
...
80102602:	e8 1f 1e 00 00       	call   80104426 <memmove>
...
80102701:	e8 20 1d 00 00       	call   80104426 <memmove>
...
8010276f:	68 20 71 10 80       	push   $0x80107120
80102774:	68 80 26 11 80       	push   $0x80112680
80102779:	e8 45 1a 00 00       	call   801041c3 <initlock>
  readsb(dev, &sb);
...
801027b9:	e8 41 1b 00 00       	call   801042ff <acquire>
...
8010281e:	e8 41 1b 00 00       	call   80104364 <release>
}
...
80102834:	e8 c6 1a 00 00       	call   801042ff <acquire>
  log.outstanding -= 1;
...
8010286e:	e8 f1 1a 00 00       	call   80104364 <release>
  if(do_commit){
...
80102882:	68 24 71 10 80       	push   $0x80107124
...
801028ab:	e8 4f 1a 00 00       	call   801042ff <acquire>
    log.committing = 0;
...
801028cd:	e8 92 1a 00 00       	call   80104364 <release>
...
80102909:	e8 f1 19 00 00       	call   801042ff <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102934:	68 33 71 10 80       	push   $0x80107133
80102939:	e8 0a da ff ff       	call   80100348 <panic>
    panic("log_write outside of trans");
8010293e:	83 ec 0c             	sub    $0xc,%esp
80102941:	68 49 71 10 80       	push   $0x80107149
...
80102964:	e8 fb 19 00 00       	call   80104364 <release>
}
...
80102992:	e8 8f 1a 00 00       	call   80104426 <memmove>
...
80102a23:	68 64 71 10 80       	push   $0x80107164
80102a28:	e8 de db ff ff       	call   8010060b <cprintf>
  idtinit();       // load idt register
80102a2d:	e8 ba 2b 00 00       	call   801055ec <idtinit>
...
80102a45:	e8 08 13 00 00       	call   80103d52 <scheduler>
...
80102a4d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a50:	e8 a0 3b 00 00       	call   801065f5 <switchkvm>
  seginit();
80102a55:	e8 4f 3a 00 00       	call   801064a9 <seginit>
  lapicinit();
...
80102aa7:	e8 ee 2d 00 00       	call   8010589a <uartinit>
  pinit();         // process table
80102aac:	e8 ef 07 00 00       	call   801032a0 <pinit>
  tvinit();        // trap vectors
80102ab1:	e8 85 2a 00 00       	call   8010553b <tvinit>
  binit();         // buffer cache
...
80102b27:	68 78 71 10 80       	push   $0x80107178
80102b2c:	53                   	push   %ebx
80102b2d:	e8 bf 18 00 00       	call   801043f1 <memcmp>
...
80102bec:	68 7d 71 10 80       	push   $0x8010717d
80102bf1:	56                   	push   %esi
80102bf2:	e8 fa 17 00 00       	call   801043f1 <memcmp>
...
80102c88:	68 82 71 10 80       	push   $0x80107182
...
80102cc7:	ff 24 85 bc 71 10 80 	jmp    *-0x7fef8e44(,%eax,4)
      continue;
    case MPIOAPIC:
...
80102d15:	68 9c 71 10 80       	push   $0x8010719c
...
80102dd1:	68 d0 71 10 80       	push   $0x801071d0
80102dd6:	50                   	push   %eax
80102dd7:	e8 e7 13 00 00       	call   801041c3 <initlock>
  (*f0)->type = FD_PIPE;
...
80102e2d:	e8 cd 14 00 00       	call   801042ff <acquire>
  if(writable){
...
80102e6d:	e8 f2 14 00 00       	call   80104364 <release>
...
80102e9c:	e8 c3 14 00 00       	call   80104364 <release>
    kfree((char*)p);
...
80102ebd:	e8 3d 14 00 00       	call   801042ff <acquire>
  for(i = 0; i < n; i++){
...
80102f24:	e8 3b 14 00 00       	call   80104364 <release>
        return -1;
...
80102f6d:	e8 f2 13 00 00       	call   80104364 <release>
  return n;
...
80102f89:	e8 71 13 00 00       	call   801042ff <acquire>
...
80102fcd:	e8 92 13 00 00       	call   80104364 <release>
      return -1;
...
80103024:	e8 3b 13 00 00       	call   80104364 <release>
  return i;
...
80103126:	e8 d4 11 00 00       	call   801042ff <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103151:	e8 0e 12 00 00       	call   80104364 <release>
  return 0;
...
80103183:	e8 dc 11 00 00       	call   80104364 <release>
...
801031a4:	c7 80 b0 0f 00 00 30 	movl   $0x80105530,0xfb0(%eax)
801031ab:	55 10 80 
  sp -= sizeof *p->context;
...
801031be:	e8 e8 11 00 00       	call   801043ab <memset>
...
80103268:	e8 f7 10 00 00       	call   80104364 <release>
  if (first) {
...
801032a6:	68 d5 71 10 80       	push   $0x801071d5
801032ab:	68 20 39 11 80       	push   $0x80113920
801032b0:	e8 0e 0f 00 00       	call   801041c3 <initlock>
...
8010331a:	68 e0 72 10 80       	push   $0x801072e0
8010331f:	e8 24 d0 ff ff       	call   80100348 <panic>
  panic("unknown apicid\n");
80103324:	83 ec 0c             	sub    $0xc,%esp
80103327:	68 dc 71 10 80       	push   $0x801071dc
...
8010335d:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103360:	e8 bd 0e 00 00       	call   80104222 <pushcli>
  c = mycpu();
80103365:	e8 78 ff ff ff       	call   801032e2 <mycpu>
  p = c->proc;
8010336a:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103370:	e8 ea 0e 00 00       	call   8010425f <popcli>
}
...
80103390:	e8 7f 36 00 00       	call   80106a14 <setupkvm>
...
801033ae:	e8 6c 33 00 00       	call   8010671f <inituvm>
  p->sz = PGSIZE;
...
801033c3:	e8 e3 0f 00 00       	call   801043ab <memset>
...
80103416:	68 05 72 10 80       	push   $0x80107205
8010341b:	50                   	push   %eax
8010341c:	e8 f1 10 00 00       	call   80104512 <safestrcpy>
  p->cwd = namei("/");
80103421:	c7 04 24 0e 72 10 80 	movl   $0x8010720e,(%esp)
...
80103437:	e8 c3 0e 00 00       	call   801042ff <acquire>
  p->state = RUNNABLE;
...
80103469:	e8 f6 0e 00 00       	call   80104364 <release>
}
...
80103479:	68 ec 71 10 80       	push   $0x801071ec
...
801034a6:	e8 7d 33 00 00       	call   80106828 <deallocuvm>
...
801034c3:	e8 f2 33 00 00       	call   801068ba <allocuvm>
...
801034d5:	e8 2d 31 00 00       	call   80106607 <switchuvm>
  return 0;
...
80103504:	e8 b6 0d 00 00       	call   801042bf <holding>
...
80103545:	e8 1b 10 00 00       	call   80104565 <swtch>
  mycpu()->intena = intena;
...
801035b1:	68 50 72 10 80       	push   $0x80107250
...
80103604:	e8 f6 0c 00 00       	call   801042ff <acquire>
...
80103652:	68 5d 72 10 80       	push   $0x8010725d
...
80103667:	e8 93 0c 00 00       	call   801042ff <acquire>
...
80103684:	e8 db 0c 00 00       	call   80104364 <release>
}
...
801036b5:	e8 45 0c 00 00       	call   801042ff <acquire>
    release(lk);
801036ba:	89 1c 24             	mov    %ebx,(%esp)
801036bd:	e8 a2 0c 00 00       	call   80104364 <release>
...
801036ee:	e8 71 0c 00 00       	call   80104364 <release>
    acquire(lk);
801036f3:	89 1c 24             	mov    %ebx,(%esp)
801036f6:	e8 04 0c 00 00       	call   801042ff <acquire>
...
80103708:	68 69 72 10 80       	push   $0x80107269
8010370d:	e8 36 cc ff ff       	call   80100348 <panic>
    panic("sleep without lk");
80103712:	83 ec 0c             	sub    $0xc,%esp
80103715:	68 6f 72 10 80       	push   $0x8010726f
...
80103733:	e8 c7 0b 00 00       	call   801042ff <acquire>
...
80103762:	e8 3d 32 00 00       	call   801069a4 <freevm>
        p->pid = 0;
...
8010378e:	e8 d1 0b 00 00       	call   80104364 <release>
        return pid;
...
801037d1:	e8 8e 0b 00 00       	call   80104364 <release>
      return -1;
...
80103801:	e8 f9 0a 00 00       	call   801042ff <acquire>
  wakeup1(chan);
...
80103815:	e8 4a 0b 00 00       	call   80104364 <release>
}
...
8010382e:	e8 cc 0a 00 00       	call   801042ff <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103863:	e8 fc 0a 00 00       	call   80104364 <release>
      return 0;
...
801038b9:	e8 a6 0a 00 00       	call   80104364 <release>
  return -1;
...
801038fa:	68 b3 72 10 80       	push   $0x801072b3
...
80103921:	8b 04 85 08 73 10 80 	mov    -0x7fef8cf8(,%eax,4),%eax
80103928:	85 c0                	test   %eax,%eax
8010392a:	75 b0                	jne    801038dc <procdump+0x14>
      state = "???";
8010392c:	b8 80 72 10 80       	mov    $0x80107280,%eax
...
80103944:	e8 95 08 00 00       	call   801041de <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80103957:	68 c1 6c 10 80       	push   $0x80106cc1
...
80103983:	83 ec 18             	sub    $0x18,%esp
80103986:	8b 75 08             	mov    0x8(%ebp),%esi
80103989:	8b 7d 0c             	mov    0xc(%ebp),%edi
    struct proc *p;
    int count = 0;
    cprintf("Executing setpri\n");
8010398c:	68 8d 72 10 80       	push   $0x8010728d
80103991:	e8 75 cc ff ff       	call   8010060b <cprintf>
    if(pri < 0 || pri > 3) {
80103996:	83 c4 10             	add    $0x10,%esp
80103999:	83 ff 03             	cmp    $0x3,%edi
8010399c:	0f 87 20 01 00 00    	ja     80103ac2 <setpri+0x145>
    int count = 0;
801039a2:	b8 00 00 00 00       	mov    $0x0,%eax
      return -1;
    }
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039a7:	bb 54 39 11 80       	mov    $0x80113954,%ebx
801039ac:	81 fb 54 65 11 80    	cmp    $0x80116554,%ebx
801039b2:	0f 83 03 01 00 00    	jae    80103abb <setpri+0x13e>
        if(p->pid == PID) {
801039b8:	39 73 10             	cmp    %esi,0x10(%ebx)
801039bb:	74 0b                	je     801039c8 <setpri+0x4b>
...
801039bd:	83 c0 01             	add    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039c0:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801039c6:	eb e4                	jmp    801039ac <setpri+0x2f>
            pstat.priority[count]  = pri; 
801039c8:	89 3c 85 20 2f 11 80 	mov    %edi,-0x7feed0e0(,%eax,4)
	    acquire(&ptable.lock);
801039cf:	83 ec 0c             	sub    $0xc,%esp
801039d2:	68 20 39 11 80       	push   $0x80113920
801039d7:	e8 23 09 00 00       	call   801042ff <acquire>
	    if(p->priority == pri) {
801039dc:	8b 4b 7c             	mov    0x7c(%ebx),%ecx
801039df:	83 c4 10             	add    $0x10,%esp
801039e2:	39 f9                	cmp    %edi,%ecx
801039e4:	74 46                	je     80103a2c <setpri+0xaf>
	    p->priority = pri;
801039e6:	89 7b 7c             	mov    %edi,0x7c(%ebx)
	    p->qtail[p->priority] = p->qtail[p->priority] + 1;
801039e9:	8d 57 20             	lea    0x20(%edi),%edx
801039ec:	8b 04 93             	mov    (%ebx,%edx,4),%eax
801039ef:	83 c0 01             	add    $0x1,%eax
801039f2:	89 04 93             	mov    %eax,(%ebx,%edx,4)
	    ptable.priorityLevelCount[p->priority]++;
801039f5:	8d 97 0c 0c 00 00    	lea    0xc0c(%edi),%edx
801039fb:	8b 04 95 24 39 11 80 	mov    -0x7feec6dc(,%edx,4),%eax
80103a02:	83 c0 01             	add    $0x1,%eax
80103a05:	89 04 95 24 39 11 80 	mov    %eax,-0x7feec6dc(,%edx,4)
	    ptable.queue[pri][ptable.priorityLevelCount[pri]] = p->pid;
80103a0c:	8b 53 10             	mov    0x10(%ebx),%edx
80103a0f:	c1 e7 06             	shl    $0x6,%edi
80103a12:	8d 84 38 0c 0b 00 00 	lea    0xb0c(%eax,%edi,1),%eax
80103a19:	89 14 85 24 39 11 80 	mov    %edx,-0x7feec6dc(,%eax,4)
	    for(int i =0; i< ptable.priorityLevelCount[prevPriority]; i++) {
80103a20:	ba 00 00 00 00       	mov    $0x0,%edx
	    int pLoc = 0;
80103a25:	b8 00 00 00 00       	mov    $0x0,%eax
	    for(int i =0; i< ptable.priorityLevelCount[prevPriority]; i++) {
80103a2a:	eb 1a                	jmp    80103a46 <setpri+0xc9>
	       release(&ptable.lock);
80103a2c:	83 ec 0c             	sub    $0xc,%esp
80103a2f:	68 20 39 11 80       	push   $0x80113920
80103a34:	e8 2b 09 00 00       	call   80104364 <release>
	       return 0;
80103a39:	83 c4 10             	add    $0x10,%esp
80103a3c:	b8 00 00 00 00       	mov    $0x0,%eax
80103a41:	eb 70                	jmp    80103ab3 <setpri+0x136>
	    for(int i =0; i< ptable.priorityLevelCount[prevPriority]; i++) {
80103a43:	83 c2 01             	add    $0x1,%edx
80103a46:	8b 1c 8d 54 69 11 80 	mov    -0x7fee96ac(,%ecx,4),%ebx
80103a4d:	39 d3                	cmp    %edx,%ebx
80103a4f:	7e 3f                	jle    80103a90 <setpri+0x113>
	        if(PID == ptable.queue[prevPriority][i]) {
80103a51:	89 cb                	mov    %ecx,%ebx
80103a53:	c1 e3 06             	shl    $0x6,%ebx
80103a56:	8d 9c 1a 0c 0b 00 00 	lea    0xb0c(%edx,%ebx,1),%ebx
80103a5d:	39 34 9d 24 39 11 80 	cmp    %esi,-0x7feec6dc(,%ebx,4)
80103a64:	75 dd                	jne    80103a43 <setpri+0xc6>
	            pLoc = i;
80103a66:	89 d0                	mov    %edx,%eax
80103a68:	eb d9                	jmp    80103a43 <setpri+0xc6>
	        ptable.queue[prevPriority][i] = ptable.queue[prevPriority][i+1];
80103a6a:	8d 50 01             	lea    0x1(%eax),%edx
80103a6d:	89 ce                	mov    %ecx,%esi
80103a6f:	c1 e6 06             	shl    $0x6,%esi
80103a72:	8d bc 32 0c 0b 00 00 	lea    0xb0c(%edx,%esi,1),%edi
80103a79:	8b 3c bd 24 39 11 80 	mov    -0x7feec6dc(,%edi,4),%edi
80103a80:	8d 84 30 0c 0b 00 00 	lea    0xb0c(%eax,%esi,1),%eax
80103a87:	89 3c 85 24 39 11 80 	mov    %edi,-0x7feec6dc(,%eax,4)
	    for(int i = pLoc; i < ptable.priorityLevelCount[prevPriority]; i++) {
80103a8e:	89 d0                	mov    %edx,%eax
80103a90:	39 c3                	cmp    %eax,%ebx
80103a92:	7f d6                	jg     80103a6a <setpri+0xed>
	    ptable.priorityLevelCount[prevPriority]--;
80103a94:	83 eb 01             	sub    $0x1,%ebx
80103a97:	89 1c 8d 54 69 11 80 	mov    %ebx,-0x7fee96ac(,%ecx,4)
	    release(&ptable.lock);
80103a9e:	83 ec 0c             	sub    $0xc,%esp
80103aa1:	68 20 39 11 80       	push   $0x80113920
80103aa6:	e8 b9 08 00 00       	call   80104364 <release>
            return 0;
80103aab:	83 c4 10             	add    $0x10,%esp
80103aae:	b8 00 00 00 00       	mov    $0x0,%eax
    }
    return -1;
}
80103ab3:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103ab6:	5b                   	pop    %ebx
80103ab7:	5e                   	pop    %esi
80103ab8:	5f                   	pop    %edi
80103ab9:	5d                   	pop    %ebp
...
80103ac0:	eb f1                	jmp    80103ab3 <setpri+0x136>
      return -1;
80103ac2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ac7:	eb ea                	jmp    80103ab3 <setpri+0x136>
...
80103acc:	8b 4d 08             	mov    0x8(%ebp),%ecx
    struct proc *p;
    int count = 0;
80103acf:	ba 00 00 00 00       	mov    $0x0,%edx
    //cprintf("Executing getpri\n");
     for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ad4:	b8 54 39 11 80       	mov    $0x80113954,%eax
80103ad9:	3d 54 65 11 80       	cmp    $0x80116554,%eax
80103ade:	73 18                	jae    80103af8 <getpri+0x2f>
         if(p->pid == PID) {
80103ae0:	39 48 10             	cmp    %ecx,0x10(%eax)
80103ae3:	74 0a                	je     80103aef <getpri+0x26>
		 return pstat.priority[count];
	 }
	 count++;
80103ae5:	83 c2 01             	add    $0x1,%edx
     for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ae8:	05 b0 00 00 00       	add    $0xb0,%eax
80103aed:	eb ea                	jmp    80103ad9 <getpri+0x10>
		 return pstat.priority[count];
80103aef:	8b 04 95 20 2f 11 80 	mov    -0x7feed0e0(,%edx,4),%eax
     }
     return -1;
 }
80103af6:	5d                   	pop    %ebp
...
80103afd:	eb f7                	jmp    80103af6 <getpri+0x2d>
...
80103b02:	57                   	push   %edi
80103b03:	56                   	push   %esi
80103b04:	53                   	push   %ebx
80103b05:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int i = 0;
	if(!ps) {
80103b08:	85 db                	test   %ebx,%ebx
80103b0a:	0f 84 9b 00 00 00    	je     80103bab <getpinfo+0xac>
	 return -1;
	}
	struct proc *p;
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b10:	ba 54 39 11 80       	mov    $0x80113954,%edx
	int i = 0;
80103b15:	b9 00 00 00 00       	mov    $0x0,%ecx
80103b1a:	eb 4b                	jmp    80103b67 <getpinfo+0x68>
	    if(p->state == UNUSED)
	    {
		    ps->inuse[i] = 0;
		   }
		    ...
		    ps->inuse[i] = 1;
80103b1c:	c7 04 8b 01 00 00 00 	movl   $0x1,(%ebx,%ecx,4)
80103b23:	eb 61                	jmp    80103b86 <getpinfo+0x87>
	    }
	    ps->priority[i] = p->priority;
	    ps->state[i] = p->state;
	    for(int j = 0; j< 4; j++) {
	        ps->ticks[i][j] = p->ticks[j];
80103b25:	8d b4 88 00 01 00 00 	lea    0x100(%eax,%ecx,4),%esi
80103b2c:	8b bc 82 90 00 00 00 	mov    0x90(%edx,%eax,4),%edi
80103b33:	89 3c b3             	mov    %edi,(%ebx,%esi,4)
	    for(int j = 0; j< 4; j++) {
80103b36:	83 c0 01             	add    $0x1,%eax
80103b39:	83 f8 03             	cmp    $0x3,%eax
80103b3c:	7e e7                	jle    80103b25 <getpinfo+0x26>
	    }
	    for(int j = 0; j<4; j++) {
80103b3e:	b8 00 00 00 00       	mov    $0x0,%eax
80103b43:	eb 14                	jmp    80103b59 <getpinfo+0x5a>
		    ps->qtail[i][j] = p->qtail[j];
80103b45:	8d b4 88 00 02 00 00 	lea    0x200(%eax,%ecx,4),%esi
80103b4c:	8b bc 82 80 00 00 00 	mov    0x80(%edx,%eax,4),%edi
80103b53:	89 3c b3             	mov    %edi,(%ebx,%esi,4)
	    for(int j = 0; j<4; j++) {
80103b56:	83 c0 01             	add    $0x1,%eax
80103b59:	83 f8 03             	cmp    $0x3,%eax
80103b5c:	7e e7                	jle    80103b45 <getpinfo+0x46>
	    }
	    //cprintf("%d : %d : %d\n",ps->pid[i],ps->priority[i],ps->state[i]);
	    i++;
80103b5e:	83 c1 01             	add    $0x1,%ecx
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b61:	81 c2 b0 00 00 00    	add    $0xb0,%edx
80103b67:	81 fa 54 65 11 80    	cmp    $0x80116554,%edx
80103b6d:	73 32                	jae    80103ba1 <getpinfo+0xa2>
	    ps->pid[i] = p->pid;
80103b6f:	8b 42 10             	mov    0x10(%edx),%eax
80103b72:	89 84 8b 00 01 00 00 	mov    %eax,0x100(%ebx,%ecx,4)
	    if(p->state == UNUSED)
80103b79:	83 7a 0c 00          	cmpl   $0x0,0xc(%edx)
80103b7d:	75 9d                	jne    80103b1c <getpinfo+0x1d>
		    ps->inuse[i] = 0;
80103b7f:	c7 04 8b 00 00 00 00 	movl   $0x0,(%ebx,%ecx,4)
	    ps->priority[i] = p->priority;
80103b86:	8b 42 7c             	mov    0x7c(%edx),%eax
80103b89:	89 84 8b 00 02 00 00 	mov    %eax,0x200(%ebx,%ecx,4)
	    ps->state[i] = p->state;
80103b90:	8b 42 0c             	mov    0xc(%edx),%eax
80103b93:	89 84 8b 00 03 00 00 	mov    %eax,0x300(%ebx,%ecx,4)
	    for(int j = 0; j< 4; j++) {
80103b9a:	b8 00 00 00 00       	mov    $0x0,%eax
80103b9f:	eb 98                	jmp    80103b39 <getpinfo+0x3a>
        }
	return 0;
80103ba1:	b8 00 00 00 00       	mov    $0x0,%eax
}
80103ba6:	5b                   	pop    %ebx
80103ba7:	5e                   	pop    %esi
80103ba8:	5f                   	pop    %edi
...
80103bb0:	eb f4                	jmp    80103ba6 <getpinfo+0xa7>
...
80103bb8:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *curproc = myproc();
80103bbb:	e8 99 f7 ff ff       	call   80103359 <myproc>
80103bc0:	89 c7                	mov    %eax,%edi
80103bc2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if((np = allocproc()) == 0){
80103bc5:	e8 50 f5 ff ff       	call   8010311a <allocproc>
80103bca:	85 c0                	test   %eax,%eax
80103bcc:	0f 84 79 01 00 00    	je     80103d4b <fork+0x199>
80103bd2:	89 c3                	mov    %eax,%ebx
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103bd4:	83 ec 08             	sub    $0x8,%esp
80103bd7:	ff 37                	pushl  (%edi)
80103bd9:	ff 77 04             	pushl  0x4(%edi)
80103bdc:	e8 e4 2e 00 00       	call   80106ac5 <copyuvm>
80103be1:	89 43 04             	mov    %eax,0x4(%ebx)
80103be4:	83 c4 10             	add    $0x10,%esp
80103be7:	85 c0                	test   %eax,%eax
80103be9:	74 28                	je     80103c13 <fork+0x61>
  np->sz = curproc->sz;
80103beb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103bee:	8b 02                	mov    (%edx),%eax
80103bf0:	89 03                	mov    %eax,(%ebx)
  np->parent = curproc;
80103bf2:	89 53 14             	mov    %edx,0x14(%ebx)
  *np->tf = *curproc->tf;
80103bf5:	8b 72 18             	mov    0x18(%edx),%esi
80103bf8:	b9 13 00 00 00       	mov    $0x13,%ecx
80103bfd:	8b 7b 18             	mov    0x18(%ebx),%edi
80103c00:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->eax = 0;
80103c02:	8b 43 18             	mov    0x18(%ebx),%eax
80103c05:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103c0c:	be 00 00 00 00       	mov    $0x0,%esi
80103c11:	eb 29                	jmp    80103c3c <fork+0x8a>
    kfree(np->kstack);
80103c13:	83 ec 0c             	sub    $0xc,%esp
80103c16:	ff 73 08             	pushl  0x8(%ebx)
80103c19:	e8 86 e3 ff ff       	call   80101fa4 <kfree>
    np->kstack = 0;
80103c1e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
80103c25:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103c2c:	83 c4 10             	add    $0x10,%esp
80103c2f:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80103c34:	e9 c3 00 00 00       	jmp    80103cfc <fork+0x14a>
  for(i = 0; i < NOFILE; i++)
80103c39:	83 c6 01             	add    $0x1,%esi
80103c3c:	83 fe 0f             	cmp    $0xf,%esi
80103c3f:	7f 1d                	jg     80103c5e <fork+0xac>
    if(curproc->ofile[i])
80103c41:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103c44:	8b 44 b0 28          	mov    0x28(%eax,%esi,4),%eax
80103c48:	85 c0                	test   %eax,%eax
80103c4a:	74 ed                	je     80103c39 <fork+0x87>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103c4c:	83 ec 0c             	sub    $0xc,%esp
80103c4f:	50                   	push   %eax
80103c50:	e8 39 d0 ff ff       	call   80100c8e <filedup>
80103c55:	89 44 b3 28          	mov    %eax,0x28(%ebx,%esi,4)
80103c59:	83 c4 10             	add    $0x10,%esp
80103c5c:	eb db                	jmp    80103c39 <fork+0x87>
  np->cwd = idup(curproc->cwd);
80103c5e:	83 ec 0c             	sub    $0xc,%esp
80103c61:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103c64:	ff 77 68             	pushl  0x68(%edi)
80103c67:	e8 e5 d8 ff ff       	call   80101551 <idup>
80103c6c:	89 43 68             	mov    %eax,0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103c6f:	8d 47 6c             	lea    0x6c(%edi),%eax
80103c72:	8d 73 6c             	lea    0x6c(%ebx),%esi
80103c75:	83 c4 0c             	add    $0xc,%esp
80103c78:	6a 10                	push   $0x10
80103c7a:	50                   	push   %eax
80103c7b:	56                   	push   %esi
80103c7c:	e8 91 08 00 00       	call   80104512 <safestrcpy>
  pid = np->pid;
80103c81:	8b 7b 10             	mov    0x10(%ebx),%edi
  acquire(&ptable.lock);
80103c84:	c7 04 24 20 39 11 80 	movl   $0x80113920,(%esp)
80103c8b:	e8 6f 06 00 00       	call   801042ff <acquire>
  np->state = RUNNABLE;
80103c90:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  if(!np->parent) {
80103c97:	8b 43 14             	mov    0x14(%ebx),%eax
80103c9a:	83 c4 10             	add    $0x10,%esp
80103c9d:	85 c0                	test   %eax,%eax
80103c9f:	74 65                	je     80103d06 <fork+0x154>
       int parentPriority = np->parent->priority;
80103ca1:	8b 40 7c             	mov    0x7c(%eax),%eax
       np->priority = parentPriority;
80103ca4:	89 43 7c             	mov    %eax,0x7c(%ebx)
       ptable.priorityLevelCount[parentPriority]++;
80103ca7:	8d 88 0c 0c 00 00    	lea    0xc0c(%eax),%ecx
80103cad:	8b 14 8d 24 39 11 80 	mov    -0x7feec6dc(,%ecx,4),%edx
80103cb4:	83 c2 01             	add    $0x1,%edx
80103cb7:	89 14 8d 24 39 11 80 	mov    %edx,-0x7feec6dc(,%ecx,4)
       ptable.queue[parentPriority][ptable.priorityLevelCount[parentPriority]] = np->pid;
80103cbe:	8b 4b 10             	mov    0x10(%ebx),%ecx
80103cc1:	89 c6                	mov    %eax,%esi
80103cc3:	c1 e6 06             	shl    $0x6,%esi
80103cc6:	8d 94 32 0c 0b 00 00 	lea    0xb0c(%edx,%esi,1),%edx
80103ccd:	89 0c 95 24 39 11 80 	mov    %ecx,-0x7feec6dc(,%edx,4)
       np->qtail[parentPriority] = np->qtail[parentPriority] + 1;
80103cd4:	83 c0 20             	add    $0x20,%eax
80103cd7:	8b 0c 83             	mov    (%ebx,%eax,4),%ecx
80103cda:	8d 51 01             	lea    0x1(%ecx),%edx
80103cdd:	89 14 83             	mov    %edx,(%ebx,%eax,4)
  release(&ptable.lock);
80103ce0:	83 ec 0c             	sub    $0xc,%esp
80103ce3:	68 20 39 11 80       	push   $0x80113920
80103ce8:	e8 77 06 00 00       	call   80104364 <release>
  getpinfo(&pstat);
80103ced:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103cf4:	e8 06 fe ff ff       	call   80103aff <getpinfo>
  return pid;
80103cf9:	83 c4 10             	add    $0x10,%esp
}
80103cfc:	89 f8                	mov    %edi,%eax
...
80103d05:	c3                   	ret    
       ptable.priorityLevelCount[3]++;
80103d06:	a1 60 69 11 80       	mov    0x80116960,%eax
80103d0b:	83 c0 01             	add    $0x1,%eax
80103d0e:	a3 60 69 11 80       	mov    %eax,0x80116960
       np->priority = 3;
80103d13:	c7 43 7c 03 00 00 00 	movl   $0x3,0x7c(%ebx)
       cprintf("Entered in queue %s \n", np->name);
80103d1a:	83 ec 08             	sub    $0x8,%esp
80103d1d:	56                   	push   %esi
80103d1e:	68 9f 72 10 80       	push   $0x8010729f
80103d23:	e8 e3 c8 ff ff       	call   8010060b <cprintf>
       ptable.queue[3][ptable.priorityLevelCount[3]] = np->pid;
80103d28:	8b 53 10             	mov    0x10(%ebx),%edx
80103d2b:	a1 60 69 11 80       	mov    0x80116960,%eax
80103d30:	89 14 85 54 68 11 80 	mov    %edx,-0x7fee97ac(,%eax,4)
       np->qtail[3] = np->qtail[3] + 1;
80103d37:	8b 83 8c 00 00 00    	mov    0x8c(%ebx),%eax
80103d3d:	83 c0 01             	add    $0x1,%eax
80103d40:	89 83 8c 00 00 00    	mov    %eax,0x8c(%ebx)
80103d46:	83 c4 10             	add    $0x10,%esp
80103d49:	eb 95                	jmp    80103ce0 <fork+0x12e>
    return -1;
80103d4b:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80103d50:	eb aa                	jmp    80103cfc <fork+0x14a>

80103d52 <scheduler>:
{
80103d52:	55                   	push   %ebp
80103d53:	89 e5                	mov    %esp,%ebp
80103d55:	57                   	push   %edi
80103d56:	56                   	push   %esi
80103d57:	53                   	push   %ebx
80103d58:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103d5b:	e8 82 f5 ff ff       	call   801032e2 <mycpu>
80103d60:	89 c7                	mov    %eax,%edi
  c->proc = 0;
80103d62:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103d69:	00 00 00 
80103d6c:	eb 74                	jmp    80103de2 <scheduler+0x90>
      if(p->state == RUNNABLE) {
80103d6e:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103d72:	74 51                	je     80103dc5 <scheduler+0x73>
     for(y = 0; y <= ptable.priorityLevelCount[priority]; y++) {
80103d74:	83 c2 01             	add    $0x1,%edx
80103d77:	39 14 b5 54 69 11 80 	cmp    %edx,-0x7fee96ac(,%esi,4)
80103d7e:	7c 2d                	jl     80103dad <scheduler+0x5b>
      int processToBeRunPID = ptable.queue[priority][y];
80103d80:	89 f0                	mov    %esi,%eax
80103d82:	c1 e0 06             	shl    $0x6,%eax
80103d85:	8d 84 02 0c 0b 00 00 	lea    0xb0c(%edx,%eax,1),%eax
80103d8c:	8b 04 85 24 39 11 80 	mov    -0x7feec6dc(,%eax,4),%eax
      for(p = ptable.proc ; p < &ptable.proc[NPROC]; p++) {
80103d93:	bb 54 39 11 80       	mov    $0x80113954,%ebx
80103d98:	81 fb 54 65 11 80    	cmp    $0x80116554,%ebx
80103d9e:	73 ce                	jae    80103d6e <scheduler+0x1c>
        if(p->pid == processToBeRunPID) {
80103da0:	39 43 10             	cmp    %eax,0x10(%ebx)
80103da3:	74 c9                	je     80103d6e <scheduler+0x1c>
      for(p = ptable.proc ; p < &ptable.proc[NPROC]; p++) {
80103da5:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80103dab:	eb eb                	jmp    80103d98 <scheduler+0x46>
     int found = 0;
80103dad:	b8 00 00 00 00       	mov    $0x0,%eax
     if(found == 1) {
80103db2:	83 f8 01             	cmp    $0x1,%eax
80103db5:	74 15                	je     80103dcc <scheduler+0x7a>
   for(priority = 3; priority >=0; priority--) {
80103db7:	83 ee 01             	sub    $0x1,%esi
80103dba:	85 f6                	test   %esi,%esi
80103dbc:	78 0e                	js     80103dcc <scheduler+0x7a>
     for(y = 0; y <= ptable.priorityLevelCount[priority]; y++) {
80103dbe:	ba 00 00 00 00       	mov    $0x0,%edx
80103dc3:	eb b2                	jmp    80103d77 <scheduler+0x25>
         found = 1;
80103dc5:	b8 01 00 00 00       	mov    $0x1,%eax
80103dca:	eb e6                	jmp    80103db2 <scheduler+0x60>
   if(p->state == RUNNABLE) {
80103dcc:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103dd0:	74 28                	je     80103dfa <scheduler+0xa8>
   release(&ptable.lock);
80103dd2:	83 ec 0c             	sub    $0xc,%esp
80103dd5:	68 20 39 11 80       	push   $0x80113920
80103dda:	e8 85 05 00 00       	call   80104364 <release>
  for(;;) {
...
80103de6:	68 20 39 11 80       	push   $0x80113920
80103deb:	e8 0f 05 00 00       	call   801042ff <acquire>
   for(priority = 3; priority >=0; priority--) {
80103df0:	83 c4 10             	add    $0x10,%esp
80103df3:	be 03 00 00 00       	mov    $0x3,%esi
80103df8:	eb c0                	jmp    80103dba <scheduler+0x68>
   if(p->time[p->priority] > 0) {
80103dfa:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103dfd:	83 bc 83 a0 00 00 00 	cmpl   $0x0,0xa0(%ebx,%eax,4)
80103e04:	00 
80103e05:	7f 41                	jg     80103e48 <scheduler+0xf6>
   if((p->ticks[p->priority] != 0 && p->ticks[p->priority] % ticksPerPriority[p->priority] == 0 && p->time[p->priority] == 0)) {
80103e07:	8b 4b 7c             	mov    0x7c(%ebx),%ecx
80103e0a:	8b 84 8b 90 00 00 00 	mov    0x90(%ebx,%ecx,4),%eax
80103e11:	85 c0                	test   %eax,%eax
80103e13:	74 17                	je     80103e2c <scheduler+0xda>
80103e15:	99                   	cltd   
80103e16:	f7 3c 8d 04 a0 10 80 	idivl  -0x7fef5ffc(,%ecx,4)
80103e1d:	85 d2                	test   %edx,%edx
80103e1f:	75 0b                	jne    80103e2c <scheduler+0xda>
80103e21:	8b 84 8b a0 00 00 00 	mov    0xa0(%ebx,%ecx,4),%eax
80103e28:	85 c0                	test   %eax,%eax
80103e2a:	74 75                	je     80103ea1 <scheduler+0x14f>
   getpinfo(&pstat);
80103e2c:	83 ec 0c             	sub    $0xc,%esp
80103e2f:	68 20 2d 11 80       	push   $0x80112d20
80103e34:	e8 c6 fc ff ff       	call   80103aff <getpinfo>
   c->proc = 0;
80103e39:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103e40:	00 00 00 
80103e43:	83 c4 10             	add    $0x10,%esp
80103e46:	eb 8a                	jmp    80103dd2 <scheduler+0x80>
     c->proc = p;
80103e48:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
     switchuvm(p);
80103e4e:	83 ec 0c             	sub    $0xc,%esp
80103e51:	53                   	push   %ebx
80103e52:	e8 b0 27 00 00       	call   80106607 <switchuvm>
     p->state = RUNNING;
80103e57:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
     swtch(&(c->scheduler), p->context);
80103e5e:	83 c4 08             	add    $0x8,%esp
80103e61:	ff 73 1c             	pushl  0x1c(%ebx)
80103e64:	8d 47 04             	lea    0x4(%edi),%eax
80103e67:	50                   	push   %eax
80103e68:	e8 f8 06 00 00       	call   80104565 <swtch>
     switchkvm();
80103e6d:	e8 83 27 00 00       	call   801065f5 <switchkvm>
     p->ticks[priority] = p->ticks[priority] + 1;
80103e72:	8d 56 24             	lea    0x24(%esi),%edx
80103e75:	8b 04 93             	mov    (%ebx,%edx,4),%eax
80103e78:	83 c0 01             	add    $0x1,%eax
80103e7b:	89 04 93             	mov    %eax,(%ebx,%edx,4)
     p->time[p->priority] = p->time[p->priority] - 1;
80103e7e:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103e81:	83 c0 28             	add    $0x28,%eax
80103e84:	8b 0c 83             	mov    (%ebx,%eax,4),%ecx
80103e87:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103e8a:	89 14 83             	mov    %edx,(%ebx,%eax,4)
     getpinfo(&pstat);
80103e8d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e94:	e8 66 fc ff ff       	call   80103aff <getpinfo>
80103e99:	83 c4 10             	add    $0x10,%esp
80103e9c:	e9 66 ff ff ff       	jmp    80103e07 <scheduler+0xb5>
80103ea1:	89 7d e0             	mov    %edi,-0x20(%ebp)
80103ea4:	eb 03                	jmp    80103ea9 <scheduler+0x157>
       for(a = 0; a < ptable.priorityLevelCount[priority]; a++) {
80103ea6:	83 c0 01             	add    $0x1,%eax
80103ea9:	8b 0c b5 54 69 11 80 	mov    -0x7fee96ac(,%esi,4),%ecx
80103eb0:	39 c1                	cmp    %eax,%ecx
80103eb2:	7e 20                	jle    80103ed4 <scheduler+0x182>
             if(ptable.queue[priority][a] == p->pid) {
80103eb4:	89 f2                	mov    %esi,%edx
80103eb6:	c1 e2 06             	shl    $0x6,%edx
80103eb9:	8d 94 10 0c 0b 00 00 	lea    0xb0c(%eax,%edx,1),%edx
80103ec0:	8b 7b 10             	mov    0x10(%ebx),%edi
80103ec3:	39 3c 95 24 39 11 80 	cmp    %edi,-0x7feec6dc(,%edx,4)
80103eca:	75 da                	jne    80103ea6 <scheduler+0x154>
80103ecc:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80103ecf:	8b 7d e0             	mov    -0x20(%ebp),%edi
80103ed2:	eb 06                	jmp    80103eda <scheduler+0x188>
80103ed4:	8b 7d e0             	mov    -0x20(%ebp),%edi
80103ed7:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
       for(int z = a; z < ptable.priorityLevelCount[priority]; z++) {
80103eda:	39 c1                	cmp    %eax,%ecx
80103edc:	7e 32                	jle    80103f10 <scheduler+0x1be>
	     ptable.queue[priority][z] = ptable.queue[priority][z+1];
80103ede:	8d 58 01             	lea    0x1(%eax),%ebx
80103ee1:	89 f2                	mov    %esi,%edx
80103ee3:	c1 e2 06             	shl    $0x6,%edx
80103ee6:	89 5d e0             	mov    %ebx,-0x20(%ebp)
80103ee9:	89 55 dc             	mov    %edx,-0x24(%ebp)
80103eec:	8d 94 13 0c 0b 00 00 	lea    0xb0c(%ebx,%edx,1),%edx
80103ef3:	8b 14 95 24 39 11 80 	mov    -0x7feec6dc(,%edx,4),%edx
80103efa:	8b 5d dc             	mov    -0x24(%ebp),%ebx
80103efd:	8d 84 18 0c 0b 00 00 	lea    0xb0c(%eax,%ebx,1),%eax
80103f04:	89 14 85 24 39 11 80 	mov    %edx,-0x7feec6dc(,%eax,4)
       for(int z = a; z < ptable.priorityLevelCount[priority]; z++) {
80103f0b:	8b 45 e0             	mov    -0x20(%ebp),%eax
80103f0e:	eb ca                	jmp    80103eda <scheduler+0x188>
80103f10:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
       ptable.queue[priority][ptable.priorityLevelCount[priority]] = p->pid;
80103f13:	8b 53 10             	mov    0x10(%ebx),%edx
80103f16:	89 f0                	mov    %esi,%eax
80103f18:	c1 e0 06             	shl    $0x6,%eax
80103f1b:	8d 84 01 0c 0b 00 00 	lea    0xb0c(%ecx,%eax,1),%eax
80103f22:	89 14 85 24 39 11 80 	mov    %edx,-0x7feec6dc(,%eax,4)
       p->qtail[priority] = p->qtail[priority] + 1;
80103f29:	83 c6 20             	add    $0x20,%esi
80103f2c:	8b 04 b3             	mov    (%ebx,%esi,4),%eax
80103f2f:	83 c0 01             	add    $0x1,%eax
80103f32:	89 04 b3             	mov    %eax,(%ebx,%esi,4)
       p->time[p->priority] = ticksPerPriority[p->priority];
80103f35:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103f38:	8b 14 85 04 a0 10 80 	mov    -0x7fef5ffc(,%eax,4),%edx
80103f3f:	89 94 83 a0 00 00 00 	mov    %edx,0xa0(%ebx,%eax,4)
80103f46:	e9 e1 fe ff ff       	jmp    80103e2c <scheduler+0xda>
...
80103f4e:	57                   	push   %edi
80103f4f:	56                   	push   %esi
80103f50:	53                   	push   %ebx
80103f51:	83 ec 1c             	sub    $0x1c,%esp
    //cprintf("fork2:%d\n",pri);
    if(pri < 0 || pri > 3){
80103f54:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
80103f58:	0f 87 4c 01 00 00    	ja     801040aa <fork2+0x15f>
    if(setpri(pid, pri) == -1) {
	    return -1;
    }*/
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
80103f5e:	e8 f6 f3 ff ff       	call   80103359 <myproc>
...
80103f65:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  // Allocate process.
  if((np = allocproc()) == 0){
80103f68:	e8 ad f1 ff ff       	call   8010311a <allocproc>
80103f6d:	89 c3                	mov    %eax,%ebx
80103f6f:	85 c0                	test   %eax,%eax
80103f71:	0f 84 3a 01 00 00    	je     801040b1 <fork2+0x166>
    return -1;
  }
...
80103f7a:	ff 37                	pushl  (%edi)
80103f7c:	ff 77 04             	pushl  0x4(%edi)
80103f7f:	e8 41 2b 00 00       	call   80106ac5 <copyuvm>
80103f84:	89 43 04             	mov    %eax,0x4(%ebx)
80103f87:	83 c4 10             	add    $0x10,%esp
80103f8a:	85 c0                	test   %eax,%eax
80103f8c:	74 2a                	je     80103fb8 <fork2+0x6d>
    kfree(np->kstack);
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
  ...
  np->sz = curproc->sz;
80103f8e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103f91:	8b 02                	mov    (%edx),%eax
80103f93:	89 03                	mov    %eax,(%ebx)
  np->parent = curproc;
80103f95:	89 53 14             	mov    %edx,0x14(%ebx)
  *np->tf = *curproc->tf;
80103f98:	8b 72 18             	mov    0x18(%edx),%esi
80103f9b:	b9 13 00 00 00       	mov    $0x13,%ecx
80103fa0:	8b 7b 18             	mov    0x18(%ebx),%edi
80103fa3:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
80103fa5:	8b 43 18             	mov    0x18(%ebx),%eax
80103fa8:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
80103faf:	be 00 00 00 00       	mov    $0x0,%esi
80103fb4:	89 d7                	mov    %edx,%edi
80103fb6:	eb 29                	jmp    80103fe1 <fork2+0x96>
    kfree(np->kstack);
80103fb8:	83 ec 0c             	sub    $0xc,%esp
80103fbb:	ff 73 08             	pushl  0x8(%ebx)
80103fbe:	e8 e1 df ff ff       	call   80101fa4 <kfree>
    np->kstack = 0;
80103fc3:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
80103fca:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103fd1:	83 c4 10             	add    $0x10,%esp
80103fd4:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103fd9:	e9 be 00 00 00       	jmp    8010409c <fork2+0x151>
  for(i = 0; i < NOFILE; i++)
80103fde:	83 c6 01             	add    $0x1,%esi
80103fe1:	83 fe 0f             	cmp    $0xf,%esi
80103fe4:	7f 1a                	jg     80104000 <fork2+0xb5>
    if(curproc->ofile[i])
80103fe6:	8b 44 b7 28          	mov    0x28(%edi,%esi,4),%eax
80103fea:	85 c0                	test   %eax,%eax
80103fec:	74 f0                	je     80103fde <fork2+0x93>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103fee:	83 ec 0c             	sub    $0xc,%esp
80103ff1:	50                   	push   %eax
80103ff2:	e8 97 cc ff ff       	call   80100c8e <filedup>
80103ff7:	89 44 b3 28          	mov    %eax,0x28(%ebx,%esi,4)
80103ffb:	83 c4 10             	add    $0x10,%esp
80103ffe:	eb de                	jmp    80103fde <fork2+0x93>
  np->cwd = idup(curproc->cwd);
80104000:	83 ec 0c             	sub    $0xc,%esp
80104003:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80104006:	ff 77 68             	pushl  0x68(%edi)
80104009:	e8 43 d5 ff ff       	call   80101551 <idup>
8010400e:	89 43 68             	mov    %eax,0x68(%ebx)

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80104011:	8d 47 6c             	lea    0x6c(%edi),%eax
80104014:	8d 53 6c             	lea    0x6c(%ebx),%edx
80104017:	83 c4 0c             	add    $0xc,%esp
8010401a:	6a 10                	push   $0x10
8010401c:	50                   	push   %eax
8010401d:	52                   	push   %edx
8010401e:	e8 ef 04 00 00       	call   80104512 <safestrcpy>

  pid = np->pid;
80104023:	8b 73 10             	mov    0x10(%ebx),%esi

  acquire(&ptable.lock);
80104026:	c7 04 24 20 39 11 80 	movl   $0x80113920,(%esp)
8010402d:	e8 cd 02 00 00       	call   801042ff <acquire>

  np->state = RUNNABLE;
80104032:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  np->priority = pri;
80104039:	8b 45 08             	mov    0x8(%ebp),%eax
8010403c:	89 43 7c             	mov    %eax,0x7c(%ebx)
  ptable.priorityLevelCount[pri]++;
8010403f:	8d 90 0c 0c 00 00    	lea    0xc0c(%eax),%edx
80104045:	8b 04 95 24 39 11 80 	mov    -0x7feec6dc(,%edx,4),%eax
8010404c:	83 c0 01             	add    $0x1,%eax
8010404f:	89 04 95 24 39 11 80 	mov    %eax,-0x7feec6dc(,%edx,4)
  ptable.queue[pri][ptable.priorityLevelCount[pri]] = np->pid;
80104056:	8b 53 10             	mov    0x10(%ebx),%edx
80104059:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010405c:	c1 e1 06             	shl    $0x6,%ecx
8010405f:	8d 84 08 0c 0b 00 00 	lea    0xb0c(%eax,%ecx,1),%eax
80104066:	89 14 85 24 39 11 80 	mov    %edx,-0x7feec6dc(,%eax,4)
  np->qtail[pri] = np->qtail[pri] + 1;
8010406d:	8b 45 08             	mov    0x8(%ebp),%eax
80104070:	83 c0 20             	add    $0x20,%eax
80104073:	8b 0c 83             	mov    (%ebx,%eax,4),%ecx
80104076:	8d 51 01             	lea    0x1(%ecx),%edx
80104079:	89 14 83             	mov    %edx,(%ebx,%eax,4)
  release(&ptable.lock);
8010407c:	c7 04 24 20 39 11 80 	movl   $0x80113920,(%esp)
80104083:	e8 dc 02 00 00       	call   80104364 <release>
  if(getpinfo(&pstat) == -1) {
80104088:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010408f:	e8 6b fa ff ff       	call   80103aff <getpinfo>
80104094:	83 c4 10             	add    $0x10,%esp
80104097:	83 f8 ff             	cmp    $0xffffffff,%eax
8010409a:	74 0a                	je     801040a6 <fork2+0x15b>
     return -1;
  }
  return pid;
}
...
801040a8:	eb f2                	jmp    8010409c <fork2+0x151>
	    return -1;
801040aa:	be ff ff ff ff       	mov    $0xffffffff,%esi
801040af:	eb eb                	jmp    8010409c <fork2+0x151>
    return -1;
801040b1:	be ff ff ff ff       	mov    $0xffffffff,%esi
801040b6:	eb e4                	jmp    8010409c <fork2+0x151>

801040b8 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
801040bf:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&lk->lk, "sleep lock");
801040c2:	68 20 73 10 80       	push   $0x80107320
801040c7:	8d 43 04             	lea    0x4(%ebx),%eax
801040ca:	50                   	push   %eax
801040cb:	e8 f3 00 00 00       	call   801041c3 <initlock>
  lk->name = name;
801040d0:	8b 45 0c             	mov    0xc(%ebp),%eax
801040d3:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
...
801040f0:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
801040f3:	8d 73 04             	lea    0x4(%ebx),%esi
801040f6:	83 ec 0c             	sub    $0xc,%esp
801040f9:	56                   	push   %esi
801040fa:	e8 00 02 00 00       	call   801042ff <acquire>
  while (lk->locked) {
801040ff:	83 c4 10             	add    $0x10,%esp
80104102:	eb 0d                	jmp    80104111 <acquiresleep+0x26>
    sleep(lk, &lk->lk);
80104104:	83 ec 08             	sub    $0x8,%esp
80104107:	56                   	push   %esi
80104108:	53                   	push   %ebx
80104109:	e8 80 f5 ff ff       	call   8010368e <sleep>
8010410e:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80104111:	83 3b 00             	cmpl   $0x0,(%ebx)
80104114:	75 ee                	jne    80104104 <acquiresleep+0x19>
  }
  lk->locked = 1;
80104116:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
8010411c:	e8 38 f2 ff ff       	call   80103359 <myproc>
80104121:	8b 40 10             	mov    0x10(%eax),%eax
80104124:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80104127:	83 ec 0c             	sub    $0xc,%esp
8010412a:	56                   	push   %esi
8010412b:	e8 34 02 00 00       	call   80104364 <release>
}
...
8010413f:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80104142:	8d 73 04             	lea    0x4(%ebx),%esi
80104145:	83 ec 0c             	sub    $0xc,%esp
80104148:	56                   	push   %esi
80104149:	e8 b1 01 00 00       	call   801042ff <acquire>
  lk->locked = 0;
8010414e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80104154:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
8010415b:	89 1c 24             	mov    %ebx,(%esp)
8010415e:	e8 93 f6 ff ff       	call   801037f6 <wakeup>
  release(&lk->lk);
80104163:	89 34 24             	mov    %esi,(%esp)
80104166:	e8 f9 01 00 00       	call   80104364 <release>
}
...
8010417a:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
8010417d:	8d 73 04             	lea    0x4(%ebx),%esi
80104180:	83 ec 0c             	sub    $0xc,%esp
80104183:	56                   	push   %esi
80104184:	e8 76 01 00 00       	call   801042ff <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104189:	83 c4 10             	add    $0x10,%esp
8010418c:	83 3b 00             	cmpl   $0x0,(%ebx)
8010418f:	75 17                	jne    801041a8 <holdingsleep+0x33>
80104191:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80104196:	83 ec 0c             	sub    $0xc,%esp
80104199:	56                   	push   %esi
8010419a:	e8 c5 01 00 00       	call   80104364 <release>
  return r;
}
...
801041a7:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
801041a8:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
801041ab:	e8 a9 f1 ff ff       	call   80103359 <myproc>
801041b0:	3b 58 10             	cmp    0x10(%eax),%ebx
801041b3:	74 07                	je     801041bc <holdingsleep+0x47>
801041b5:	bb 00 00 00 00       	mov    $0x0,%ebx
801041ba:	eb da                	jmp    80104196 <holdingsleep+0x21>
801041bc:	bb 01 00 00 00       	mov    $0x1,%ebx
801041c1:	eb d3                	jmp    80104196 <holdingsleep+0x21>
...
801041cc:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
801041cf:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
801041d5:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
801041dc:	5d                   	pop    %ebp
801041dd:	c3                   	ret    

801041de <getcallerpcs>:
}
...
801041e2:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  uint *ebp;
  int i;

  ebp = (uint*)v - 2;
801041e5:	8b 45 08             	mov    0x8(%ebp),%eax
801041e8:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
801041eb:	b8 00 00 00 00       	mov    $0x0,%eax
801041f0:	83 f8 09             	cmp    $0x9,%eax
801041f3:	7f 25                	jg     8010421a <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801041f5:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
801041fb:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80104201:	77 17                	ja     8010421a <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104203:	8b 5a 04             	mov    0x4(%edx),%ebx
80104206:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80104209:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
8010420b:	83 c0 01             	add    $0x1,%eax
8010420e:	eb e0                	jmp    801041f0 <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80104210:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80104217:	83 c0 01             	add    $0x1,%eax
8010421a:	83 f8 09             	cmp    $0x9,%eax
8010421d:	7e f1                	jle    80104210 <getcallerpcs+0x32>
}
8010421f:	5b                   	pop    %ebx
80104220:	5d                   	pop    %ebp
80104221:	c3                   	ret    
...
8010422b:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010422c:	e8 b1 f0 ff ff       	call   801032e2 <mycpu>
80104231:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80104238:	74 12                	je     8010424c <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
8010423a:	e8 a3 f0 ff ff       	call   801032e2 <mycpu>
...
8010424b:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
8010424c:	e8 91 f0 ff ff       	call   801032e2 <mycpu>
80104251:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104257:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
8010425d:	eb db                	jmp    8010423a <pushcli+0x18>
...
8010426a:	75 28                	jne    80104294 <popcli+0x35>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
8010426c:	e8 71 f0 ff ff       	call   801032e2 <mycpu>
80104271:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80104277:	8d 51 ff             	lea    -0x1(%ecx),%edx
8010427a:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80104280:	85 d2                	test   %edx,%edx
80104282:	78 1d                	js     801042a1 <popcli+0x42>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104284:	e8 59 f0 ff ff       	call   801032e2 <mycpu>
80104289:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80104290:	74 1c                	je     801042ae <popcli+0x4f>
    sti();
}
80104292:	c9                   	leave  
80104293:	c3                   	ret    
...
80104297:	68 2b 73 10 80       	push   $0x8010732b
8010429c:	e8 a7 c0 ff ff       	call   80100348 <panic>
    panic("popcli");
801042a1:	83 ec 0c             	sub    $0xc,%esp
801042a4:	68 42 73 10 80       	push   $0x80107342
801042a9:	e8 9a c0 ff ff       	call   80100348 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
801042ae:	e8 2f f0 ff ff       	call   801032e2 <mycpu>
801042b3:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
801042ba:	74 d6                	je     80104292 <popcli+0x33>
  asm volatile("sti");
801042bc:	fb                   	sti    
}
801042bd:	eb d3                	jmp    80104292 <popcli+0x33>
...
801042c6:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801042c9:	e8 54 ff ff ff       	call   80104222 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801042ce:	83 3b 00             	cmpl   $0x0,(%ebx)
801042d1:	75 12                	jne    801042e5 <holding+0x26>
801042d3:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
801042d8:	e8 82 ff ff ff       	call   8010425f <popcli>
}
801042dd:	89 d8                	mov    %ebx,%eax
801042df:	83 c4 04             	add    $0x4,%esp
801042e2:	5b                   	pop    %ebx
801042e3:	5d                   	pop    %ebp
801042e4:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
801042e5:	8b 5b 08             	mov    0x8(%ebx),%ebx
801042e8:	e8 f5 ef ff ff       	call   801032e2 <mycpu>
801042ed:	39 c3                	cmp    %eax,%ebx
801042ef:	74 07                	je     801042f8 <holding+0x39>
801042f1:	bb 00 00 00 00       	mov    $0x0,%ebx
801042f6:	eb e0                	jmp    801042d8 <holding+0x19>
801042f8:	bb 01 00 00 00       	mov    $0x1,%ebx
801042fd:	eb d9                	jmp    801042d8 <holding+0x19>
...
80104306:	e8 17 ff ff ff       	call   80104222 <pushcli>
  if(holding(lk))
8010430b:	83 ec 0c             	sub    $0xc,%esp
8010430e:	ff 75 08             	pushl  0x8(%ebp)
80104311:	e8 a9 ff ff ff       	call   801042bf <holding>
80104316:	83 c4 10             	add    $0x10,%esp
80104319:	85 c0                	test   %eax,%eax
8010431b:	75 3a                	jne    80104357 <acquire+0x58>
  while(xchg(&lk->locked, 1) != 0)
8010431d:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80104320:	b8 01 00 00 00       	mov    $0x1,%eax
80104325:	f0 87 02             	lock xchg %eax,(%edx)
80104328:	85 c0                	test   %eax,%eax
8010432a:	75 f1                	jne    8010431d <acquire+0x1e>
  __sync_synchronize();
8010432c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104331:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104334:	e8 a9 ef ff ff       	call   801032e2 <mycpu>
...
8010434a:	e8 8f fe ff ff       	call   801041de <getcallerpcs>
}
...
8010435a:	68 49 73 10 80       	push   $0x80107349
8010435f:	e8 e4 bf ff ff       	call   80100348 <panic>
...
8010436f:	e8 4b ff ff ff       	call   801042bf <holding>
80104374:	83 c4 10             	add    $0x10,%esp
80104377:	85 c0                	test   %eax,%eax
80104379:	74 23                	je     8010439e <release+0x3a>
  lk->pcs[0] = 0;
8010437b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104382:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104389:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010438e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80104394:	e8 c6 fe ff ff       	call   8010425f <popcli>
}
80104399:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010439c:	c9                   	leave  
8010439d:	c3                   	ret    
    panic("release");
8010439e:	83 ec 0c             	sub    $0xc,%esp
801043a1:	68 51 73 10 80       	push   $0x80107351
801043a6:	e8 9d bf ff ff       	call   80100348 <panic>
...
801043cd:	c3                   	ret    
    c &= 0xFF;
801043ce:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801043d2:	c1 e9 02             	shr    $0x2,%ecx
801043d5:	89 f8                	mov    %edi,%eax
801043d7:	c1 e0 18             	shl    $0x18,%eax
801043da:	89 fb                	mov    %edi,%ebx
801043dc:	c1 e3 10             	shl    $0x10,%ebx
801043df:	09 d8                	or     %ebx,%eax
801043e1:	89 fb                	mov    %edi,%ebx
801043e3:	c1 e3 08             	shl    $0x8,%ebx
801043e6:	09 d8                	or     %ebx,%eax
801043e8:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
801043ea:	89 d7                	mov    %edx,%edi
801043ec:	fc                   	cld    
801043ed:	f3 ab                	rep stos %eax,%es:(%edi)
801043ef:	eb d7                	jmp    801043c8 <memset+0x1d>
...
801043f6:	8b 4d 08             	mov    0x8(%ebp),%ecx
801043f9:	8b 55 0c             	mov    0xc(%ebp),%edx
801043fc:	8b 45 10             	mov    0x10(%ebp),%eax
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
801043ff:	8d 70 ff             	lea    -0x1(%eax),%esi
80104402:	85 c0                	test   %eax,%eax
80104404:	74 1c                	je     80104422 <memcmp+0x31>
    if(*s1 != *s2)
80104406:	0f b6 01             	movzbl (%ecx),%eax
80104409:	0f b6 1a             	movzbl (%edx),%ebx
8010440c:	38 d8                	cmp    %bl,%al
8010440e:	75 0a                	jne    8010441a <memcmp+0x29>
      return *s1 - *s2;
    s1++, s2++;
80104410:	83 c1 01             	add    $0x1,%ecx
80104413:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80104416:	89 f0                	mov    %esi,%eax
80104418:	eb e5                	jmp    801043ff <memcmp+0xe>
      return *s1 - *s2;
8010441a:	0f b6 c0             	movzbl %al,%eax
8010441d:	0f b6 db             	movzbl %bl,%ebx
80104420:	29 d8                	sub    %ebx,%eax
  }
...
8010442e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104431:	8b 55 10             	mov    0x10(%ebp),%edx
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104434:	39 c1                	cmp    %eax,%ecx
80104436:	73 3a                	jae    80104472 <memmove+0x4c>
80104438:	8d 1c 11             	lea    (%ecx,%edx,1),%ebx
8010443b:	39 c3                	cmp    %eax,%ebx
8010443d:	76 37                	jbe    80104476 <memmove+0x50>
    s += n;
    d += n;
8010443f:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
    while(n-- > 0)
80104442:	eb 0d                	jmp    80104451 <memmove+0x2b>
      *--d = *--s;
80104444:	83 eb 01             	sub    $0x1,%ebx
80104447:	83 e9 01             	sub    $0x1,%ecx
8010444a:	0f b6 13             	movzbl (%ebx),%edx
8010444d:	88 11                	mov    %dl,(%ecx)
    while(n-- > 0)
8010444f:	89 f2                	mov    %esi,%edx
80104451:	8d 72 ff             	lea    -0x1(%edx),%esi
80104454:	85 d2                	test   %edx,%edx
80104456:	75 ec                	jne    80104444 <memmove+0x1e>
80104458:	eb 14                	jmp    8010446e <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
8010445a:	0f b6 11             	movzbl (%ecx),%edx
8010445d:	88 13                	mov    %dl,(%ebx)
8010445f:	8d 5b 01             	lea    0x1(%ebx),%ebx
80104462:	8d 49 01             	lea    0x1(%ecx),%ecx
    while(n-- > 0)
80104465:	89 f2                	mov    %esi,%edx
80104467:	8d 72 ff             	lea    -0x1(%edx),%esi
8010446a:	85 d2                	test   %edx,%edx
8010446c:	75 ec                	jne    8010445a <memmove+0x34>
...
80104474:	eb f1                	jmp    80104467 <memmove+0x41>
80104476:	89 c3                	mov    %eax,%ebx
80104478:	eb ed                	jmp    80104467 <memmove+0x41>
...
8010447d:	ff 75 10             	pushl  0x10(%ebp)
80104480:	ff 75 0c             	pushl  0xc(%ebp)
80104483:	ff 75 08             	pushl  0x8(%ebp)
80104486:	e8 9b ff ff ff       	call   80104426 <memmove>
}
8010448b:	c9                   	leave  
8010448c:	c3                   	ret    
...
80104494:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104497:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
8010449a:	eb 09                	jmp    801044a5 <strncmp+0x18>
    n--, p++, q++;
8010449c:	83 e8 01             	sub    $0x1,%eax
8010449f:	83 c2 01             	add    $0x1,%edx
801044a2:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
801044a5:	85 c0                	test   %eax,%eax
801044a7:	74 0b                	je     801044b4 <strncmp+0x27>
801044a9:	0f b6 1a             	movzbl (%edx),%ebx
801044ac:	84 db                	test   %bl,%bl
801044ae:	74 04                	je     801044b4 <strncmp+0x27>
801044b0:	3a 19                	cmp    (%ecx),%bl
801044b2:	74 e8                	je     8010449c <strncmp+0xf>
  if(n == 0)
801044b4:	85 c0                	test   %eax,%eax
801044b6:	74 0b                	je     801044c3 <strncmp+0x36>
    return 0;
  return (uchar)*p - (uchar)*q;
801044b8:	0f b6 02             	movzbl (%edx),%eax
801044bb:	0f b6 11             	movzbl (%ecx),%edx
801044be:	29 d0                	sub    %edx,%eax
}
801044c0:	5b                   	pop    %ebx
801044c1:	5d                   	pop    %ebp
801044c2:	c3                   	ret    
...
801044c8:	eb f6                	jmp    801044c0 <strncmp+0x33>
...
801044d0:	8b 5d 0c             	mov    0xc(%ebp),%ebx
...
801044d9:	eb 04                	jmp    801044df <strncpy+0x15>
801044db:	89 fb                	mov    %edi,%ebx
801044dd:	89 f0                	mov    %esi,%eax
801044df:	8d 51 ff             	lea    -0x1(%ecx),%edx
801044e2:	85 c9                	test   %ecx,%ecx
801044e4:	7e 1d                	jle    80104503 <strncpy+0x39>
801044e6:	8d 7b 01             	lea    0x1(%ebx),%edi
801044e9:	8d 70 01             	lea    0x1(%eax),%esi
801044ec:	0f b6 1b             	movzbl (%ebx),%ebx
801044ef:	88 18                	mov    %bl,(%eax)
801044f1:	89 d1                	mov    %edx,%ecx
801044f3:	84 db                	test   %bl,%bl
801044f5:	75 e4                	jne    801044db <strncpy+0x11>
801044f7:	89 f0                	mov    %esi,%eax
801044f9:	eb 08                	jmp    80104503 <strncpy+0x39>
    ;
  while(n-- > 0)
    *s++ = 0;
801044fb:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
801044fe:	89 ca                	mov    %ecx,%edx
    *s++ = 0;
80104500:	8d 40 01             	lea    0x1(%eax),%eax
  while(n-- > 0)
80104503:	8d 4a ff             	lea    -0x1(%edx),%ecx
80104506:	85 d2                	test   %edx,%edx
80104508:	7f f1                	jg     801044fb <strncpy+0x31>
  return os;
}
...
80104515:	57                   	push   %edi
80104516:	56                   	push   %esi
80104517:	53                   	push   %ebx
80104518:	8b 45 08             	mov    0x8(%ebp),%eax
8010451b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010451e:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;

  os = s;
  if(n <= 0)
80104521:	85 d2                	test   %edx,%edx
80104523:	7e 23                	jle    80104548 <safestrcpy+0x36>
80104525:	89 c1                	mov    %eax,%ecx
80104527:	eb 04                	jmp    8010452d <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80104529:	89 fb                	mov    %edi,%ebx
8010452b:	89 f1                	mov    %esi,%ecx
8010452d:	83 ea 01             	sub    $0x1,%edx
80104530:	85 d2                	test   %edx,%edx
80104532:	7e 11                	jle    80104545 <safestrcpy+0x33>
80104534:	8d 7b 01             	lea    0x1(%ebx),%edi
80104537:	8d 71 01             	lea    0x1(%ecx),%esi
8010453a:	0f b6 1b             	movzbl (%ebx),%ebx
8010453d:	88 19                	mov    %bl,(%ecx)
8010453f:	84 db                	test   %bl,%bl
80104541:	75 e6                	jne    80104529 <safestrcpy+0x17>
80104543:	89 f1                	mov    %esi,%ecx
    ;
  *s = 0;
...
80104558:	eb 03                	jmp    8010455d <strlen+0x10>
8010455a:	83 c0 01             	add    $0x1,%eax
8010455d:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80104561:	75 f7                	jne    8010455a <strlen+0xd>
    ;
  return n;
}
80104563:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80104565:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104569:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010456f:	56                   	push   %esi
  pushl %edi
80104570:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80104571:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104573:	89 d4                	mov    %edx,%esp
...
80104581:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104584:	e8 d0 ed ff ff       	call   80103359 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104589:	8b 00                	mov    (%eax),%eax
8010458b:	39 d8                	cmp    %ebx,%eax
8010458d:	76 19                	jbe    801045a8 <fetchint+0x2e>
8010458f:	8d 53 04             	lea    0x4(%ebx),%edx
80104592:	39 d0                	cmp    %edx,%eax
80104594:	72 19                	jb     801045af <fetchint+0x35>
    return -1;
  *ip = *(int*)(addr);
80104596:	8b 13                	mov    (%ebx),%edx
...
801045ad:	eb f3                	jmp    801045a2 <fetchint+0x28>
801045af:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045b4:	eb ec                	jmp    801045a2 <fetchint+0x28>
...
801045bd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801045c0:	e8 94 ed ff ff       	call   80103359 <myproc>

  if(addr >= curproc->sz)
801045c5:	39 18                	cmp    %ebx,(%eax)
801045c7:	76 26                	jbe    801045ef <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
801045c9:	8b 55 0c             	mov    0xc(%ebp),%edx
801045cc:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
801045ce:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
801045d0:	89 d8                	mov    %ebx,%eax
801045d2:	39 d0                	cmp    %edx,%eax
801045d4:	73 0e                	jae    801045e4 <fetchstr+0x2e>
    if(*s == 0)
801045d6:	80 38 00             	cmpb   $0x0,(%eax)
801045d9:	74 05                	je     801045e0 <fetchstr+0x2a>
  for(s = *pp; s < ep; s++){
801045db:	83 c0 01             	add    $0x1,%eax
801045de:	eb f2                	jmp    801045d2 <fetchstr+0x1c>
      return s - *pp;
801045e0:	29 d8                	sub    %ebx,%eax
801045e2:	eb 05                	jmp    801045e9 <fetchstr+0x33>
  }
  return -1;
...
801045f4:	eb f3                	jmp    801045e9 <fetchstr+0x33>
...
801045fc:	e8 58 ed ff ff       	call   80103359 <myproc>
80104601:	8b 50 18             	mov    0x18(%eax),%edx
80104604:	8b 45 08             	mov    0x8(%ebp),%eax
80104607:	c1 e0 02             	shl    $0x2,%eax
8010460a:	03 42 44             	add    0x44(%edx),%eax
8010460d:	83 ec 08             	sub    $0x8,%esp
80104610:	ff 75 0c             	pushl  0xc(%ebp)
80104613:	83 c0 04             	add    $0x4,%eax
80104616:	50                   	push   %eax
80104617:	e8 5e ff ff ff       	call   8010457a <fetchint>
}
8010461c:	c9                   	leave  
8010461d:	c3                   	ret    
...
80104623:	83 ec 10             	sub    $0x10,%esp
80104626:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104629:	e8 2b ed ff ff       	call   80103359 <myproc>
8010462e:	89 c6                	mov    %eax,%esi
...
8010463a:	e8 b7 ff ff ff       	call   801045f6 <argint>
8010463f:	83 c4 10             	add    $0x10,%esp
80104642:	85 c0                	test   %eax,%eax
80104644:	78 24                	js     8010466a <argptr+0x4c>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104646:	85 db                	test   %ebx,%ebx
80104648:	78 27                	js     80104671 <argptr+0x53>
8010464a:	8b 16                	mov    (%esi),%edx
8010464c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010464f:	39 c2                	cmp    %eax,%edx
80104651:	76 25                	jbe    80104678 <argptr+0x5a>
80104653:	01 c3                	add    %eax,%ebx
80104655:	39 da                	cmp    %ebx,%edx
80104657:	72 26                	jb     8010467f <argptr+0x61>
    return -1;
  *pp = (char*)i;
80104659:	8b 55 0c             	mov    0xc(%ebp),%edx
8010465c:	89 02                	mov    %eax,(%edx)
  return 0;
...
8010466f:	eb f2                	jmp    80104663 <argptr+0x45>
    return -1;
80104671:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104676:	eb eb                	jmp    80104663 <argptr+0x45>
80104678:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010467d:	eb e4                	jmp    80104663 <argptr+0x45>
8010467f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104684:	eb dd                	jmp    80104663 <argptr+0x45>
...
80104689:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
8010468c:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010468f:	50                   	push   %eax
80104690:	ff 75 08             	pushl  0x8(%ebp)
80104693:	e8 5e ff ff ff       	call   801045f6 <argint>
80104698:	83 c4 10             	add    $0x10,%esp
8010469b:	85 c0                	test   %eax,%eax
8010469d:	78 13                	js     801046b2 <argstr+0x2c>
    return -1;
  return fetchstr(addr, pp);
8010469f:	83 ec 08             	sub    $0x8,%esp
801046a2:	ff 75 0c             	pushl  0xc(%ebp)
801046a5:	ff 75 f4             	pushl  -0xc(%ebp)
801046a8:	e8 09 ff ff ff       	call   801045b6 <fetchstr>
...
801046b7:	eb f7                	jmp    801046b0 <argstr+0x2a>
...
801046bd:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801046c0:	e8 94 ec ff ff       	call   80103359 <myproc>
801046c5:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
801046c7:	8b 40 18             	mov    0x18(%eax),%eax
801046ca:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801046cd:	8d 50 ff             	lea    -0x1(%eax),%edx
801046d0:	83 fa 18             	cmp    $0x18,%edx
801046d3:	77 18                	ja     801046ed <syscall+0x34>
801046d5:	8b 14 85 80 73 10 80 	mov    -0x7fef8c80(,%eax,4),%edx
801046dc:	85 d2                	test   %edx,%edx
801046de:	74 0d                	je     801046ed <syscall+0x34>
    curproc->tf->eax = syscalls[num]();
801046e0:	ff d2                	call   *%edx
801046e2:	8b 53 18             	mov    0x18(%ebx),%edx
801046e5:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
801046ec:	c3                   	ret    
            curproc->pid, curproc->name, num);
801046ed:	8d 53 6c             	lea    0x6c(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
801046f0:	50                   	push   %eax
801046f1:	52                   	push   %edx
801046f2:	ff 73 10             	pushl  0x10(%ebx)
801046f5:	68 59 73 10 80       	push   $0x80107359
801046fa:	e8 0c bf ff ff       	call   8010060b <cprintf>
    curproc->tf->eax = -1;
801046ff:	8b 43 18             	mov    0x18(%ebx),%eax
80104702:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
80104709:	83 c4 10             	add    $0x10,%esp
}
8010470c:	eb da                	jmp    801046e8 <syscall+0x2f>
...
80104716:	89 d6                	mov    %edx,%esi
80104718:	89 cb                	mov    %ecx,%ebx
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
8010471a:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010471d:	52                   	push   %edx
8010471e:	50                   	push   %eax
8010471f:	e8 d2 fe ff ff       	call   801045f6 <argint>
80104724:	83 c4 10             	add    $0x10,%esp
80104727:	85 c0                	test   %eax,%eax
80104729:	78 2e                	js     80104759 <argfd+0x4b>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010472b:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010472f:	77 2f                	ja     80104760 <argfd+0x52>
80104731:	e8 23 ec ff ff       	call   80103359 <myproc>
80104736:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104739:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
8010473d:	85 c0                	test   %eax,%eax
8010473f:	74 26                	je     80104767 <argfd+0x59>
    return -1;
  if(pfd)
80104741:	85 f6                	test   %esi,%esi
80104743:	74 02                	je     80104747 <argfd+0x39>
    *pfd = fd;
80104745:	89 16                	mov    %edx,(%esi)
  if(pf)
80104747:	85 db                	test   %ebx,%ebx
80104749:	74 23                	je     8010476e <argfd+0x60>
    *pf = f;
8010474b:	89 03                	mov    %eax,(%ebx)
  return 0;
8010474d:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80104758:	c3                   	ret    
    return -1;
80104759:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010475e:	eb f2                	jmp    80104752 <argfd+0x44>
    return -1;
80104760:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104765:	eb eb                	jmp    80104752 <argfd+0x44>
80104767:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010476c:	eb e4                	jmp    80104752 <argfd+0x44>
  return 0;
8010476e:	b8 00 00 00 00       	mov    $0x0,%eax
80104773:	eb dd                	jmp    80104752 <argfd+0x44>
...
8010477c:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
8010477e:	e8 d6 eb ff ff       	call   80103359 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
80104783:	ba 00 00 00 00       	mov    $0x0,%edx
80104788:	83 fa 0f             	cmp    $0xf,%edx
8010478b:	7f 18                	jg     801047a5 <fdalloc+0x30>
    if(curproc->ofile[fd] == 0){
8010478d:	83 7c 90 28 00       	cmpl   $0x0,0x28(%eax,%edx,4)
80104792:	74 05                	je     80104799 <fdalloc+0x24>
  for(fd = 0; fd < NOFILE; fd++){
80104794:	83 c2 01             	add    $0x1,%edx
80104797:	eb ef                	jmp    80104788 <fdalloc+0x13>
      curproc->ofile[fd] = f;
80104799:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
      return fd;
    }
  }
  return -1;
...
8010479f:	83 c4 04             	add    $0x4,%esp
801047a2:	5b                   	pop    %ebx
801047a3:	5d                   	pop    %ebp
801047a4:	c3                   	ret    
  return -1;
801047a5:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801047aa:	eb f1                	jmp    8010479d <fdalloc+0x28>
...
801047b1:	83 ec 10             	sub    $0x10,%esp
801047b4:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801047b6:	b8 20 00 00 00       	mov    $0x20,%eax
801047bb:	89 c6                	mov    %eax,%esi
801047bd:	39 43 58             	cmp    %eax,0x58(%ebx)
801047c0:	76 2e                	jbe    801047f0 <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801047c2:	6a 10                	push   $0x10
801047c4:	50                   	push   %eax
801047c5:	8d 45 e8             	lea    -0x18(%ebp),%eax
801047c8:	50                   	push   %eax
801047c9:	53                   	push   %ebx
801047ca:	e8 a4 cf ff ff       	call   80101773 <readi>
801047cf:	83 c4 10             	add    $0x10,%esp
801047d2:	83 f8 10             	cmp    $0x10,%eax
801047d5:	75 0c                	jne    801047e3 <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
801047d7:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
801047dc:	75 1e                	jne    801047fc <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801047de:	8d 46 10             	lea    0x10(%esi),%eax
801047e1:	eb d8                	jmp    801047bb <isdirempty+0xf>
      panic("isdirempty: readi");
801047e3:	83 ec 0c             	sub    $0xc,%esp
801047e6:	68 e8 73 10 80       	push   $0x801073e8
801047eb:	e8 58 bb ff ff       	call   80100348 <panic>
      return 0;
  }
  return 1;
...
80104801:	eb f2                	jmp    801047f5 <isdirempty+0x49>
...
8010480c:	89 55 c4             	mov    %edx,-0x3c(%ebp)
8010480f:	89 4d c0             	mov    %ecx,-0x40(%ebp)
80104812:	8b 7d 08             	mov    0x8(%ebp),%edi
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80104815:	8d 55 d6             	lea    -0x2a(%ebp),%edx
80104818:	52                   	push   %edx
80104819:	50                   	push   %eax
8010481a:	e8 da d3 ff ff       	call   80101bf9 <nameiparent>
8010481f:	89 c6                	mov    %eax,%esi
80104821:	83 c4 10             	add    $0x10,%esp
80104824:	85 c0                	test   %eax,%eax
80104826:	0f 84 3a 01 00 00    	je     80104966 <create+0x163>
    return 0;
  ilock(dp);
8010482c:	83 ec 0c             	sub    $0xc,%esp
8010482f:	50                   	push   %eax
80104830:	e8 4c cd ff ff       	call   80101581 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80104835:	83 c4 0c             	add    $0xc,%esp
80104838:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010483b:	50                   	push   %eax
8010483c:	8d 45 d6             	lea    -0x2a(%ebp),%eax
...
8010484d:	74 3f                	je     8010488e <create+0x8b>
    iunlockput(dp);
...
8010485b:	e8 21 cd ff ff       	call   80101581 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104860:	83 c4 10             	add    $0x10,%esp
80104863:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104868:	75 11                	jne    8010487b <create+0x78>
8010486a:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
8010486f:	75 0a                	jne    8010487b <create+0x78>
...
80104871:	89 d8                	mov    %ebx,%eax
80104873:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104876:	5b                   	pop    %ebx
80104877:	5e                   	pop    %esi
80104878:	5f                   	pop    %edi
80104879:	5d                   	pop    %ebp
...
80104887:	bb 00 00 00 00       	mov    $0x0,%ebx
8010488c:	eb e3                	jmp    80104871 <create+0x6e>
  if((ip = ialloc(dp->dev, type)) == 0)
8010488e:	0f bf 45 c4          	movswl -0x3c(%ebp),%eax
80104892:	83 ec 08             	sub    $0x8,%esp
80104895:	50                   	push   %eax
80104896:	ff 36                	pushl  (%esi)
80104898:	e8 e1 ca ff ff       	call   8010137e <ialloc>
8010489d:	89 c3                	mov    %eax,%ebx
8010489f:	83 c4 10             	add    $0x10,%esp
801048a2:	85 c0                	test   %eax,%eax
801048a4:	74 55                	je     801048fb <create+0xf8>
  ilock(ip);
801048a6:	83 ec 0c             	sub    $0xc,%esp
801048a9:	50                   	push   %eax
801048aa:	e8 d2 cc ff ff       	call   80101581 <ilock>
  ip->major = major;
801048af:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
801048b3:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
801048b7:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
801048bb:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
801048c1:	89 1c 24             	mov    %ebx,(%esp)
801048c4:	e8 57 cb ff ff       	call   80101420 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801048c9:	83 c4 10             	add    $0x10,%esp
801048cc:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
801048d1:	74 35                	je     80104908 <create+0x105>
  if(dirlink(dp, name, ip->inum) < 0)
801048d3:	83 ec 04             	sub    $0x4,%esp
801048d6:	ff 73 04             	pushl  0x4(%ebx)
801048d9:	8d 45 d6             	lea    -0x2a(%ebp),%eax
801048dc:	50                   	push   %eax
801048dd:	56                   	push   %esi
801048de:	e8 4d d2 ff ff       	call   80101b30 <dirlink>
801048e3:	83 c4 10             	add    $0x10,%esp
801048e6:	85 c0                	test   %eax,%eax
801048e8:	78 6f                	js     80104959 <create+0x156>
  iunlockput(dp);
801048ea:	83 ec 0c             	sub    $0xc,%esp
801048ed:	56                   	push   %esi
801048ee:	e8 35 ce ff ff       	call   80101728 <iunlockput>
  return ip;
801048f3:	83 c4 10             	add    $0x10,%esp
801048f6:	e9 76 ff ff ff       	jmp    80104871 <create+0x6e>
    panic("create: ialloc");
801048fb:	83 ec 0c             	sub    $0xc,%esp
801048fe:	68 fa 73 10 80       	push   $0x801073fa
80104903:	e8 40 ba ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
80104908:	0f b7 46 56          	movzwl 0x56(%esi),%eax
8010490c:	83 c0 01             	add    $0x1,%eax
8010490f:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104913:	83 ec 0c             	sub    $0xc,%esp
80104916:	56                   	push   %esi
80104917:	e8 04 cb ff ff       	call   80101420 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010491c:	83 c4 0c             	add    $0xc,%esp
8010491f:	ff 73 04             	pushl  0x4(%ebx)
80104922:	68 0a 74 10 80       	push   $0x8010740a
80104927:	53                   	push   %ebx
80104928:	e8 03 d2 ff ff       	call   80101b30 <dirlink>
8010492d:	83 c4 10             	add    $0x10,%esp
80104930:	85 c0                	test   %eax,%eax
80104932:	78 18                	js     8010494c <create+0x149>
80104934:	83 ec 04             	sub    $0x4,%esp
80104937:	ff 76 04             	pushl  0x4(%esi)
8010493a:	68 09 74 10 80       	push   $0x80107409
8010493f:	53                   	push   %ebx
80104940:	e8 eb d1 ff ff       	call   80101b30 <dirlink>
80104945:	83 c4 10             	add    $0x10,%esp
80104948:	85 c0                	test   %eax,%eax
8010494a:	79 87                	jns    801048d3 <create+0xd0>
      panic("create dots");
8010494c:	83 ec 0c             	sub    $0xc,%esp
8010494f:	68 0c 74 10 80       	push   $0x8010740c
80104954:	e8 ef b9 ff ff       	call   80100348 <panic>
    panic("create: dirlink");
80104959:	83 ec 0c             	sub    $0xc,%esp
8010495c:	68 18 74 10 80       	push   $0x80107418
80104961:	e8 e2 b9 ff ff       	call   80100348 <panic>
    return 0;
80104966:	89 c3                	mov    %eax,%ebx
80104968:	e9 04 ff ff ff       	jmp    80104871 <create+0x6e>
...
80104971:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
80104974:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104977:	ba 00 00 00 00       	mov    $0x0,%edx
8010497c:	b8 00 00 00 00       	mov    $0x0,%eax
80104981:	e8 88 fd ff ff       	call   8010470e <argfd>
80104986:	85 c0                	test   %eax,%eax
80104988:	78 23                	js     801049ad <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
8010498a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010498d:	e8 e3 fd ff ff       	call   80104775 <fdalloc>
80104992:	89 c3                	mov    %eax,%ebx
80104994:	85 c0                	test   %eax,%eax
80104996:	78 1c                	js     801049b4 <sys_dup+0x47>
  filedup(f);
80104998:	83 ec 0c             	sub    $0xc,%esp
8010499b:	ff 75 f4             	pushl  -0xc(%ebp)
8010499e:	e8 eb c2 ff ff       	call   80100c8e <filedup>
  return fd;
801049a3:	83 c4 10             	add    $0x10,%esp
}
801049a6:	89 d8                	mov    %ebx,%eax
801049a8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801049ab:	c9                   	leave  
801049ac:	c3                   	ret    
    return -1;
801049ad:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801049b2:	eb f2                	jmp    801049a6 <sys_dup+0x39>
    return -1;
801049b4:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801049b9:	eb eb                	jmp    801049a6 <sys_dup+0x39>

801049bb <sys_read>:
{
801049bb:	55                   	push   %ebp
801049bc:	89 e5                	mov    %esp,%ebp
801049be:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
801049c1:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801049c4:	ba 00 00 00 00       	mov    $0x0,%edx
801049c9:	b8 00 00 00 00       	mov    $0x0,%eax
801049ce:	e8 3b fd ff ff       	call   8010470e <argfd>
801049d3:	85 c0                	test   %eax,%eax
801049d5:	78 43                	js     80104a1a <sys_read+0x5f>
801049d7:	83 ec 08             	sub    $0x8,%esp
801049da:	8d 45 f0             	lea    -0x10(%ebp),%eax
801049dd:	50                   	push   %eax
801049de:	6a 02                	push   $0x2
801049e0:	e8 11 fc ff ff       	call   801045f6 <argint>
801049e5:	83 c4 10             	add    $0x10,%esp
801049e8:	85 c0                	test   %eax,%eax
801049ea:	78 35                	js     80104a21 <sys_read+0x66>
801049ec:	83 ec 04             	sub    $0x4,%esp
801049ef:	ff 75 f0             	pushl  -0x10(%ebp)
801049f2:	8d 45 ec             	lea    -0x14(%ebp),%eax
801049f5:	50                   	push   %eax
801049f6:	6a 01                	push   $0x1
801049f8:	e8 21 fc ff ff       	call   8010461e <argptr>
801049fd:	83 c4 10             	add    $0x10,%esp
80104a00:	85 c0                	test   %eax,%eax
80104a02:	78 24                	js     80104a28 <sys_read+0x6d>
  return fileread(f, p, n);
80104a04:	83 ec 04             	sub    $0x4,%esp
80104a07:	ff 75 f0             	pushl  -0x10(%ebp)
80104a0a:	ff 75 ec             	pushl  -0x14(%ebp)
80104a0d:	ff 75 f4             	pushl  -0xc(%ebp)
80104a10:	e8 c2 c3 ff ff       	call   80100dd7 <fileread>
...
80104a1f:	eb f7                	jmp    80104a18 <sys_read+0x5d>
80104a21:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a26:	eb f0                	jmp    80104a18 <sys_read+0x5d>
80104a28:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a2d:	eb e9                	jmp    80104a18 <sys_read+0x5d>
...
80104a32:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104a35:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104a38:	ba 00 00 00 00       	mov    $0x0,%edx
80104a3d:	b8 00 00 00 00       	mov    $0x0,%eax
80104a42:	e8 c7 fc ff ff       	call   8010470e <argfd>
80104a47:	85 c0                	test   %eax,%eax
80104a49:	78 43                	js     80104a8e <sys_write+0x5f>
80104a4b:	83 ec 08             	sub    $0x8,%esp
80104a4e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104a51:	50                   	push   %eax
80104a52:	6a 02                	push   $0x2
80104a54:	e8 9d fb ff ff       	call   801045f6 <argint>
80104a59:	83 c4 10             	add    $0x10,%esp
80104a5c:	85 c0                	test   %eax,%eax
80104a5e:	78 35                	js     80104a95 <sys_write+0x66>
80104a60:	83 ec 04             	sub    $0x4,%esp
80104a63:	ff 75 f0             	pushl  -0x10(%ebp)
80104a66:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104a69:	50                   	push   %eax
80104a6a:	6a 01                	push   $0x1
80104a6c:	e8 ad fb ff ff       	call   8010461e <argptr>
80104a71:	83 c4 10             	add    $0x10,%esp
80104a74:	85 c0                	test   %eax,%eax
80104a76:	78 24                	js     80104a9c <sys_write+0x6d>
  return filewrite(f, p, n);
80104a78:	83 ec 04             	sub    $0x4,%esp
80104a7b:	ff 75 f0             	pushl  -0x10(%ebp)
80104a7e:	ff 75 ec             	pushl  -0x14(%ebp)
80104a81:	ff 75 f4             	pushl  -0xc(%ebp)
80104a84:	e8 d3 c3 ff ff       	call   80100e5c <filewrite>
...
80104a93:	eb f7                	jmp    80104a8c <sys_write+0x5d>
80104a95:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a9a:	eb f0                	jmp    80104a8c <sys_write+0x5d>
80104a9c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104aa1:	eb e9                	jmp    80104a8c <sys_write+0x5d>
...
80104aa6:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
80104aa9:	8d 4d f0             	lea    -0x10(%ebp),%ecx
80104aac:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104aaf:	b8 00 00 00 00       	mov    $0x0,%eax
80104ab4:	e8 55 fc ff ff       	call   8010470e <argfd>
80104ab9:	85 c0                	test   %eax,%eax
80104abb:	78 25                	js     80104ae2 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
80104abd:	e8 97 e8 ff ff       	call   80103359 <myproc>
80104ac2:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104ac5:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104acc:	00 
  fileclose(f);
80104acd:	83 ec 0c             	sub    $0xc,%esp
80104ad0:	ff 75 f0             	pushl  -0x10(%ebp)
80104ad3:	e8 fb c1 ff ff       	call   80100cd3 <fileclose>
  return 0;
...
80104ae7:	eb f7                	jmp    80104ae0 <sys_close+0x3d>
...
80104aef:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104af2:	ba 00 00 00 00       	mov    $0x0,%edx
80104af7:	b8 00 00 00 00       	mov    $0x0,%eax
80104afc:	e8 0d fc ff ff       	call   8010470e <argfd>
80104b01:	85 c0                	test   %eax,%eax
80104b03:	78 2a                	js     80104b2f <sys_fstat+0x46>
80104b05:	83 ec 04             	sub    $0x4,%esp
80104b08:	6a 14                	push   $0x14
80104b0a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104b0d:	50                   	push   %eax
80104b0e:	6a 01                	push   $0x1
80104b10:	e8 09 fb ff ff       	call   8010461e <argptr>
80104b15:	83 c4 10             	add    $0x10,%esp
80104b18:	85 c0                	test   %eax,%eax
80104b1a:	78 1a                	js     80104b36 <sys_fstat+0x4d>
  return filestat(f, st);
80104b1c:	83 ec 08             	sub    $0x8,%esp
80104b1f:	ff 75 f0             	pushl  -0x10(%ebp)
80104b22:	ff 75 f4             	pushl  -0xc(%ebp)
80104b25:	e8 66 c2 ff ff       	call   80100d90 <filestat>
...
80104b34:	eb f7                	jmp    80104b2d <sys_fstat+0x44>
80104b36:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b3b:	eb f0                	jmp    80104b2d <sys_fstat+0x44>
...
80104b45:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104b48:	50                   	push   %eax
80104b49:	6a 00                	push   $0x0
80104b4b:	e8 36 fb ff ff       	call   80104686 <argstr>
80104b50:	83 c4 10             	add    $0x10,%esp
80104b53:	85 c0                	test   %eax,%eax
80104b55:	0f 88 32 01 00 00    	js     80104c8d <sys_link+0x150>
80104b5b:	83 ec 08             	sub    $0x8,%esp
80104b5e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104b61:	50                   	push   %eax
80104b62:	6a 01                	push   $0x1
80104b64:	e8 1d fb ff ff       	call   80104686 <argstr>
80104b69:	83 c4 10             	add    $0x10,%esp
80104b6c:	85 c0                	test   %eax,%eax
80104b6e:	0f 88 20 01 00 00    	js     80104c94 <sys_link+0x157>
  begin_op();
80104b74:	e8 35 dc ff ff       	call   801027ae <begin_op>
  if((ip = namei(old)) == 0){
80104b79:	83 ec 0c             	sub    $0xc,%esp
80104b7c:	ff 75 e0             	pushl  -0x20(%ebp)
80104b7f:	e8 5d d0 ff ff       	call   80101be1 <namei>
80104b84:	89 c3                	mov    %eax,%ebx
80104b86:	83 c4 10             	add    $0x10,%esp
80104b89:	85 c0                	test   %eax,%eax
80104b8b:	0f 84 99 00 00 00    	je     80104c2a <sys_link+0xed>
  ilock(ip);
80104b91:	83 ec 0c             	sub    $0xc,%esp
80104b94:	50                   	push   %eax
80104b95:	e8 e7 c9 ff ff       	call   80101581 <ilock>
  if(ip->type == T_DIR){
80104b9a:	83 c4 10             	add    $0x10,%esp
80104b9d:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104ba2:	0f 84 8e 00 00 00    	je     80104c36 <sys_link+0xf9>
  ip->nlink++;
80104ba8:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104bac:	83 c0 01             	add    $0x1,%eax
80104baf:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
...
80104bbf:	e8 7f ca ff ff       	call   80101643 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104bc4:	83 c4 08             	add    $0x8,%esp
80104bc7:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104bca:	50                   	push   %eax
80104bcb:	ff 75 e4             	pushl  -0x1c(%ebp)
80104bce:	e8 26 d0 ff ff       	call   80101bf9 <nameiparent>
80104bd3:	89 c6                	mov    %eax,%esi
80104bd5:	83 c4 10             	add    $0x10,%esp
80104bd8:	85 c0                	test   %eax,%eax
80104bda:	74 7e                	je     80104c5a <sys_link+0x11d>
  ilock(dp);
80104bdc:	83 ec 0c             	sub    $0xc,%esp
80104bdf:	50                   	push   %eax
80104be0:	e8 9c c9 ff ff       	call   80101581 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104be5:	83 c4 10             	add    $0x10,%esp
80104be8:	8b 03                	mov    (%ebx),%eax
80104bea:	39 06                	cmp    %eax,(%esi)
80104bec:	75 60                	jne    80104c4e <sys_link+0x111>
80104bee:	83 ec 04             	sub    $0x4,%esp
80104bf1:	ff 73 04             	pushl  0x4(%ebx)
80104bf4:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104bf7:	50                   	push   %eax
80104bf8:	56                   	push   %esi
80104bf9:	e8 32 cf ff ff       	call   80101b30 <dirlink>
80104bfe:	83 c4 10             	add    $0x10,%esp
80104c01:	85 c0                	test   %eax,%eax
80104c03:	78 49                	js     80104c4e <sys_link+0x111>
  iunlockput(dp);
80104c05:	83 ec 0c             	sub    $0xc,%esp
80104c08:	56                   	push   %esi
80104c09:	e8 1a cb ff ff       	call   80101728 <iunlockput>
  iput(ip);
80104c0e:	89 1c 24             	mov    %ebx,(%esp)
80104c11:	e8 72 ca ff ff       	call   80101688 <iput>
  end_op();
...
80104c29:	c3                   	ret    
    end_op();
80104c2a:	e8 f9 db ff ff       	call   80102828 <end_op>
    return -1;
80104c2f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c34:	eb ed                	jmp    80104c23 <sys_link+0xe6>
    iunlockput(ip);
80104c36:	83 ec 0c             	sub    $0xc,%esp
80104c39:	53                   	push   %ebx
80104c3a:	e8 e9 ca ff ff       	call   80101728 <iunlockput>
    end_op();
80104c3f:	e8 e4 db ff ff       	call   80102828 <end_op>
    return -1;
80104c44:	83 c4 10             	add    $0x10,%esp
80104c47:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c4c:	eb d5                	jmp    80104c23 <sys_link+0xe6>
    iunlockput(dp);
80104c4e:	83 ec 0c             	sub    $0xc,%esp
80104c51:	56                   	push   %esi
80104c52:	e8 d1 ca ff ff       	call   80101728 <iunlockput>
    goto bad;
...
80104c8b:	eb 96                	jmp    80104c23 <sys_link+0xe6>
    return -1;
80104c8d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c92:	eb 8f                	jmp    80104c23 <sys_link+0xe6>
80104c94:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c99:	eb 88                	jmp    80104c23 <sys_link+0xe6>
...
80104ca1:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
80104ca4:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104ca7:	50                   	push   %eax
80104ca8:	6a 00                	push   $0x0
80104caa:	e8 d7 f9 ff ff       	call   80104686 <argstr>
80104caf:	83 c4 10             	add    $0x10,%esp
80104cb2:	85 c0                	test   %eax,%eax
80104cb4:	0f 88 83 01 00 00    	js     80104e3d <sys_unlink+0x1a2>
  begin_op();
80104cba:	e8 ef da ff ff       	call   801027ae <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104cbf:	83 ec 08             	sub    $0x8,%esp
80104cc2:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104cc5:	50                   	push   %eax
80104cc6:	ff 75 c4             	pushl  -0x3c(%ebp)
80104cc9:	e8 2b cf ff ff       	call   80101bf9 <nameiparent>
80104cce:	89 c6                	mov    %eax,%esi
80104cd0:	83 c4 10             	add    $0x10,%esp
80104cd3:	85 c0                	test   %eax,%eax
80104cd5:	0f 84 ed 00 00 00    	je     80104dc8 <sys_unlink+0x12d>
  ilock(dp);
80104cdb:	83 ec 0c             	sub    $0xc,%esp
80104cde:	50                   	push   %eax
80104cdf:	e8 9d c8 ff ff       	call   80101581 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104ce4:	83 c4 08             	add    $0x8,%esp
80104ce7:	68 0a 74 10 80       	push   $0x8010740a
80104cec:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104cef:	50                   	push   %eax
80104cf0:	e8 a6 cc ff ff       	call   8010199b <namecmp>
80104cf5:	83 c4 10             	add    $0x10,%esp
80104cf8:	85 c0                	test   %eax,%eax
80104cfa:	0f 84 fc 00 00 00    	je     80104dfc <sys_unlink+0x161>
80104d00:	83 ec 08             	sub    $0x8,%esp
80104d03:	68 09 74 10 80       	push   $0x80107409
80104d08:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104d0b:	50                   	push   %eax
80104d0c:	e8 8a cc ff ff       	call   8010199b <namecmp>
80104d11:	83 c4 10             	add    $0x10,%esp
80104d14:	85 c0                	test   %eax,%eax
80104d16:	0f 84 e0 00 00 00    	je     80104dfc <sys_unlink+0x161>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104d1c:	83 ec 04             	sub    $0x4,%esp
80104d1f:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104d22:	50                   	push   %eax
80104d23:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104d26:	50                   	push   %eax
80104d27:	56                   	push   %esi
80104d28:	e8 83 cc ff ff       	call   801019b0 <dirlookup>
80104d2d:	89 c3                	mov    %eax,%ebx
80104d2f:	83 c4 10             	add    $0x10,%esp
80104d32:	85 c0                	test   %eax,%eax
80104d34:	0f 84 c2 00 00 00    	je     80104dfc <sys_unlink+0x161>
  ilock(ip);
80104d3a:	83 ec 0c             	sub    $0xc,%esp
80104d3d:	50                   	push   %eax
80104d3e:	e8 3e c8 ff ff       	call   80101581 <ilock>
  if(ip->nlink < 1)
80104d43:	83 c4 10             	add    $0x10,%esp
80104d46:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104d4b:	0f 8e 83 00 00 00    	jle    80104dd4 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104d51:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104d56:	0f 84 85 00 00 00    	je     80104de1 <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
80104d5c:	83 ec 04             	sub    $0x4,%esp
80104d5f:	6a 10                	push   $0x10
80104d61:	6a 00                	push   $0x0
80104d63:	8d 7d d8             	lea    -0x28(%ebp),%edi
80104d66:	57                   	push   %edi
80104d67:	e8 3f f6 ff ff       	call   801043ab <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104d6c:	6a 10                	push   $0x10
80104d6e:	ff 75 c0             	pushl  -0x40(%ebp)
80104d71:	57                   	push   %edi
80104d72:	56                   	push   %esi
80104d73:	e8 f8 ca ff ff       	call   80101870 <writei>
80104d78:	83 c4 20             	add    $0x20,%esp
80104d7b:	83 f8 10             	cmp    $0x10,%eax
80104d7e:	0f 85 90 00 00 00    	jne    80104e14 <sys_unlink+0x179>
  if(ip->type == T_DIR){
80104d84:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104d89:	0f 84 92 00 00 00    	je     80104e21 <sys_unlink+0x186>
  iunlockput(dp);
80104d8f:	83 ec 0c             	sub    $0xc,%esp
80104d92:	56                   	push   %esi
80104d93:	e8 90 c9 ff ff       	call   80101728 <iunlockput>
  ip->nlink--;
80104d98:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104d9c:	83 e8 01             	sub    $0x1,%eax
80104d9f:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104da3:	89 1c 24             	mov    %ebx,(%esp)
80104da6:	e8 75 c6 ff ff       	call   80101420 <iupdate>
  iunlockput(ip);
80104dab:	89 1c 24             	mov    %ebx,(%esp)
80104dae:	e8 75 c9 ff ff       	call   80101728 <iunlockput>
  end_op();
80104db3:	e8 70 da ff ff       	call   80102828 <end_op>
  return 0;
...
80104dc7:	c3                   	ret    
    end_op();
80104dc8:	e8 5b da ff ff       	call   80102828 <end_op>
    return -1;
80104dcd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104dd2:	eb ec                	jmp    80104dc0 <sys_unlink+0x125>
    panic("unlink: nlink < 1");
80104dd4:	83 ec 0c             	sub    $0xc,%esp
80104dd7:	68 28 74 10 80       	push   $0x80107428
80104ddc:	e8 67 b5 ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104de1:	89 d8                	mov    %ebx,%eax
80104de3:	e8 c4 f9 ff ff       	call   801047ac <isdirempty>
80104de8:	85 c0                	test   %eax,%eax
80104dea:	0f 85 6c ff ff ff    	jne    80104d5c <sys_unlink+0xc1>
    iunlockput(ip);
80104df0:	83 ec 0c             	sub    $0xc,%esp
80104df3:	53                   	push   %ebx
80104df4:	e8 2f c9 ff ff       	call   80101728 <iunlockput>
    goto bad;
...
80104e12:	eb ac                	jmp    80104dc0 <sys_unlink+0x125>
    panic("unlink: writei");
80104e14:	83 ec 0c             	sub    $0xc,%esp
80104e17:	68 3a 74 10 80       	push   $0x8010743a
80104e1c:	e8 27 b5 ff ff       	call   80100348 <panic>
    dp->nlink--;
80104e21:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104e25:	83 e8 01             	sub    $0x1,%eax
80104e28:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104e2c:	83 ec 0c             	sub    $0xc,%esp
80104e2f:	56                   	push   %esi
80104e30:	e8 eb c5 ff ff       	call   80101420 <iupdate>
80104e35:	83 c4 10             	add    $0x10,%esp
80104e38:	e9 52 ff ff ff       	jmp    80104d8f <sys_unlink+0xf4>
    return -1;
80104e3d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e42:	e9 79 ff ff ff       	jmp    80104dc0 <sys_unlink+0x125>
...
80104e4d:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80104e50:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104e53:	50                   	push   %eax
80104e54:	6a 00                	push   $0x0
80104e56:	e8 2b f8 ff ff       	call   80104686 <argstr>
80104e5b:	83 c4 10             	add    $0x10,%esp
80104e5e:	85 c0                	test   %eax,%eax
80104e60:	0f 88 30 01 00 00    	js     80104f96 <sys_open+0x14f>
80104e66:	83 ec 08             	sub    $0x8,%esp
80104e69:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104e6c:	50                   	push   %eax
80104e6d:	6a 01                	push   $0x1
80104e6f:	e8 82 f7 ff ff       	call   801045f6 <argint>
80104e74:	83 c4 10             	add    $0x10,%esp
80104e77:	85 c0                	test   %eax,%eax
80104e79:	0f 88 21 01 00 00    	js     80104fa0 <sys_open+0x159>
    return -1;

  begin_op();
80104e7f:	e8 2a d9 ff ff       	call   801027ae <begin_op>

  if(omode & O_CREATE){
80104e84:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
80104e88:	0f 84 84 00 00 00    	je     80104f12 <sys_open+0xcb>
    ip = create(path, T_FILE, 0, 0);
80104e8e:	83 ec 0c             	sub    $0xc,%esp
80104e91:	6a 00                	push   $0x0
80104e93:	b9 00 00 00 00       	mov    $0x0,%ecx
80104e98:	ba 02 00 00 00       	mov    $0x2,%edx
80104e9d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104ea0:	e8 5e f9 ff ff       	call   80104803 <create>
80104ea5:	89 c6                	mov    %eax,%esi
    if(ip == 0){
80104ea7:	83 c4 10             	add    $0x10,%esp
80104eaa:	85 c0                	test   %eax,%eax
80104eac:	74 58                	je     80104f06 <sys_open+0xbf>
      end_op();
      return -1;
    }
  }
...
80104eae:	e8 7a bd ff ff       	call   80100c2d <filealloc>
80104eb3:	89 c3                	mov    %eax,%ebx
80104eb5:	85 c0                	test   %eax,%eax
80104eb7:	0f 84 ae 00 00 00    	je     80104f6b <sys_open+0x124>
80104ebd:	e8 b3 f8 ff ff       	call   80104775 <fdalloc>
80104ec2:	89 c7                	mov    %eax,%edi
80104ec4:	85 c0                	test   %eax,%eax
80104ec6:	0f 88 9f 00 00 00    	js     80104f6b <sys_open+0x124>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
80104ed0:	e8 6e c7 ff ff       	call   80101643 <iunlock>
  end_op();
80104ed5:	e8 4e d9 ff ff       	call   80102828 <end_op>

  f->type = FD_INODE;
80104eda:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
80104ee0:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
80104ee3:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80104eea:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104eed:	83 c4 10             	add    $0x10,%esp
80104ef0:	a8 01                	test   $0x1,%al
80104ef2:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104ef6:	a8 03                	test   $0x3,%al
80104ef8:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
80104efc:	89 f8                	mov    %edi,%eax
...
80104f06:	e8 1d d9 ff ff       	call   80102828 <end_op>
      return -1;
80104f0b:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104f10:	eb ea                	jmp    80104efc <sys_open+0xb5>
    if((ip = namei(path)) == 0){
80104f12:	83 ec 0c             	sub    $0xc,%esp
80104f15:	ff 75 e4             	pushl  -0x1c(%ebp)
80104f18:	e8 c4 cc ff ff       	call   80101be1 <namei>
80104f1d:	89 c6                	mov    %eax,%esi
80104f1f:	83 c4 10             	add    $0x10,%esp
80104f22:	85 c0                	test   %eax,%eax
80104f24:	74 39                	je     80104f5f <sys_open+0x118>
    ilock(ip);
80104f26:	83 ec 0c             	sub    $0xc,%esp
80104f29:	50                   	push   %eax
80104f2a:	e8 52 c6 ff ff       	call   80101581 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104f2f:	83 c4 10             	add    $0x10,%esp
80104f32:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104f37:	0f 85 71 ff ff ff    	jne    80104eae <sys_open+0x67>
80104f3d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104f41:	0f 84 67 ff ff ff    	je     80104eae <sys_open+0x67>
      iunlockput(ip);
80104f47:	83 ec 0c             	sub    $0xc,%esp
80104f4a:	56                   	push   %esi
80104f4b:	e8 d8 c7 ff ff       	call   80101728 <iunlockput>
      end_op();
80104f50:	e8 d3 d8 ff ff       	call   80102828 <end_op>
      return -1;
80104f55:	83 c4 10             	add    $0x10,%esp
80104f58:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104f5d:	eb 9d                	jmp    80104efc <sys_open+0xb5>
      end_op();
80104f5f:	e8 c4 d8 ff ff       	call   80102828 <end_op>
      return -1;
80104f64:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104f69:	eb 91                	jmp    80104efc <sys_open+0xb5>
    if(f)
80104f6b:	85 db                	test   %ebx,%ebx
80104f6d:	74 0c                	je     80104f7b <sys_open+0x134>
      fileclose(f);
80104f6f:	83 ec 0c             	sub    $0xc,%esp
80104f72:	53                   	push   %ebx
80104f73:	e8 5b bd ff ff       	call   80100cd3 <fileclose>
80104f78:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80104f7b:	83 ec 0c             	sub    $0xc,%esp
80104f7e:	56                   	push   %esi
80104f7f:	e8 a4 c7 ff ff       	call   80101728 <iunlockput>
    end_op();
80104f84:	e8 9f d8 ff ff       	call   80102828 <end_op>
    return -1;
80104f89:	83 c4 10             	add    $0x10,%esp
80104f8c:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104f91:	e9 66 ff ff ff       	jmp    80104efc <sys_open+0xb5>
    return -1;
80104f96:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104f9b:	e9 5c ff ff ff       	jmp    80104efc <sys_open+0xb5>
80104fa0:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104fa5:	e9 52 ff ff ff       	jmp    80104efc <sys_open+0xb5>
...
80104fad:	83 ec 18             	sub    $0x18,%esp
  char *path;
  struct inode *ip;

  begin_op();
80104fb0:	e8 f9 d7 ff ff       	call   801027ae <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80104fb5:	83 ec 08             	sub    $0x8,%esp
80104fb8:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104fbb:	50                   	push   %eax
80104fbc:	6a 00                	push   $0x0
80104fbe:	e8 c3 f6 ff ff       	call   80104686 <argstr>
80104fc3:	83 c4 10             	add    $0x10,%esp
80104fc6:	85 c0                	test   %eax,%eax
80104fc8:	78 36                	js     80105000 <sys_mkdir+0x56>
80104fca:	83 ec 0c             	sub    $0xc,%esp
80104fcd:	6a 00                	push   $0x0
80104fcf:	b9 00 00 00 00       	mov    $0x0,%ecx
80104fd4:	ba 01 00 00 00       	mov    $0x1,%edx
80104fd9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fdc:	e8 22 f8 ff ff       	call   80104803 <create>
80104fe1:	83 c4 10             	add    $0x10,%esp
80104fe4:	85 c0                	test   %eax,%eax
80104fe6:	74 18                	je     80105000 <sys_mkdir+0x56>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80104fec:	e8 37 c7 ff ff       	call   80101728 <iunlockput>
  end_op();
80104ff1:	e8 32 d8 ff ff       	call   80102828 <end_op>
  return 0;
...
80104fff:	c3                   	ret    
    end_op();
80105000:	e8 23 d8 ff ff       	call   80102828 <end_op>
    return -1;
80105005:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010500a:	eb f2                	jmp    80104ffe <sys_mkdir+0x54>
...
8010500f:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105012:	e8 97 d7 ff ff       	call   801027ae <begin_op>
  if((argstr(0, &path)) < 0 ||
80105017:	83 ec 08             	sub    $0x8,%esp
8010501a:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010501d:	50                   	push   %eax
8010501e:	6a 00                	push   $0x0
80105020:	e8 61 f6 ff ff       	call   80104686 <argstr>
80105025:	83 c4 10             	add    $0x10,%esp
80105028:	85 c0                	test   %eax,%eax
8010502a:	78 62                	js     8010508e <sys_mknod+0x82>
     argint(1, &major) < 0 ||
8010502c:	83 ec 08             	sub    $0x8,%esp
8010502f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105032:	50                   	push   %eax
80105033:	6a 01                	push   $0x1
80105035:	e8 bc f5 ff ff       	call   801045f6 <argint>
  if((argstr(0, &path)) < 0 ||
8010503a:	83 c4 10             	add    $0x10,%esp
8010503d:	85 c0                	test   %eax,%eax
8010503f:	78 4d                	js     8010508e <sys_mknod+0x82>
     argint(2, &minor) < 0 ||
80105041:	83 ec 08             	sub    $0x8,%esp
80105044:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105047:	50                   	push   %eax
80105048:	6a 02                	push   $0x2
8010504a:	e8 a7 f5 ff ff       	call   801045f6 <argint>
     argint(1, &major) < 0 ||
8010504f:	83 c4 10             	add    $0x10,%esp
80105052:	85 c0                	test   %eax,%eax
80105054:	78 38                	js     8010508e <sys_mknod+0x82>
     (ip = create(path, T_DEV, major, minor)) == 0){
80105056:	0f bf 45 ec          	movswl -0x14(%ebp),%eax
8010505a:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
     argint(2, &minor) < 0 ||
8010505e:	83 ec 0c             	sub    $0xc,%esp
80105061:	50                   	push   %eax
80105062:	ba 03 00 00 00       	mov    $0x3,%edx
80105067:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010506a:	e8 94 f7 ff ff       	call   80104803 <create>
8010506f:	83 c4 10             	add    $0x10,%esp
80105072:	85 c0                	test   %eax,%eax
80105074:	74 18                	je     8010508e <sys_mknod+0x82>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010507a:	e8 a9 c6 ff ff       	call   80101728 <iunlockput>
  end_op();
8010507f:	e8 a4 d7 ff ff       	call   80102828 <end_op>
  return 0;
80105084:	83 c4 10             	add    $0x10,%esp
80105087:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010508c:	c9                   	leave  
8010508d:	c3                   	ret    
    end_op();
8010508e:	e8 95 d7 ff ff       	call   80102828 <end_op>
    return -1;
80105093:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105098:	eb f2                	jmp    8010508c <sys_mknod+0x80>
...
8010509f:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801050a2:	e8 b2 e2 ff ff       	call   80103359 <myproc>
801050a7:	89 c6                	mov    %eax,%esi
  
  begin_op();
801050a9:	e8 00 d7 ff ff       	call   801027ae <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
801050ae:	83 ec 08             	sub    $0x8,%esp
801050b1:	8d 45 f4             	lea    -0xc(%ebp),%eax
801050b4:	50                   	push   %eax
801050b5:	6a 00                	push   $0x0
801050b7:	e8 ca f5 ff ff       	call   80104686 <argstr>
801050bc:	83 c4 10             	add    $0x10,%esp
801050bf:	85 c0                	test   %eax,%eax
801050c1:	78 52                	js     80105115 <sys_chdir+0x7b>
801050c3:	83 ec 0c             	sub    $0xc,%esp
801050c6:	ff 75 f4             	pushl  -0xc(%ebp)
801050c9:	e8 13 cb ff ff       	call   80101be1 <namei>
801050ce:	89 c3                	mov    %eax,%ebx
801050d0:	83 c4 10             	add    $0x10,%esp
801050d3:	85 c0                	test   %eax,%eax
801050d5:	74 3e                	je     80105115 <sys_chdir+0x7b>
    end_op();
    return -1;
  }
  ilock(ip);
...
801050db:	e8 a1 c4 ff ff       	call   80101581 <ilock>
  if(ip->type != T_DIR){
801050e0:	83 c4 10             	add    $0x10,%esp
801050e3:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801050e8:	75 37                	jne    80105121 <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
801050ee:	e8 50 c5 ff ff       	call   80101643 <iunlock>
  iput(curproc->cwd);
801050f3:	83 c4 04             	add    $0x4,%esp
801050f6:	ff 76 68             	pushl  0x68(%esi)
801050f9:	e8 8a c5 ff ff       	call   80101688 <iput>
  end_op();
801050fe:	e8 25 d7 ff ff       	call   80102828 <end_op>
  curproc->cwd = ip;
80105103:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
80105114:	c3                   	ret    
    end_op();
80105115:	e8 0e d7 ff ff       	call   80102828 <end_op>
    return -1;
8010511a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010511f:	eb ed                	jmp    8010510e <sys_chdir+0x74>
    iunlockput(ip);
80105121:	83 ec 0c             	sub    $0xc,%esp
80105124:	53                   	push   %ebx
80105125:	e8 fe c5 ff ff       	call   80101728 <iunlockput>
    end_op();
8010512a:	e8 f9 d6 ff ff       	call   80102828 <end_op>
    return -1;
8010512f:	83 c4 10             	add    $0x10,%esp
80105132:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105137:	eb d5                	jmp    8010510e <sys_chdir+0x74>
...
8010513d:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80105143:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105146:	50                   	push   %eax
80105147:	6a 00                	push   $0x0
80105149:	e8 38 f5 ff ff       	call   80104686 <argstr>
8010514e:	83 c4 10             	add    $0x10,%esp
80105151:	85 c0                	test   %eax,%eax
80105153:	0f 88 a8 00 00 00    	js     80105201 <sys_exec+0xc8>
80105159:	83 ec 08             	sub    $0x8,%esp
8010515c:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80105162:	50                   	push   %eax
80105163:	6a 01                	push   $0x1
80105165:	e8 8c f4 ff ff       	call   801045f6 <argint>
8010516a:	83 c4 10             	add    $0x10,%esp
8010516d:	85 c0                	test   %eax,%eax
8010516f:	0f 88 93 00 00 00    	js     80105208 <sys_exec+0xcf>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105175:	83 ec 04             	sub    $0x4,%esp
80105178:	68 80 00 00 00       	push   $0x80
8010517d:	6a 00                	push   $0x0
8010517f:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80105185:	50                   	push   %eax
80105186:	e8 20 f2 ff ff       	call   801043ab <memset>
8010518b:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
8010518e:	bb 00 00 00 00       	mov    $0x0,%ebx
    if(i >= NELEM(argv))
80105193:	83 fb 1f             	cmp    $0x1f,%ebx
80105196:	77 77                	ja     8010520f <sys_exec+0xd6>
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105198:	83 ec 08             	sub    $0x8,%esp
8010519b:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801051a1:	50                   	push   %eax
801051a2:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
801051a8:	8d 04 98             	lea    (%eax,%ebx,4),%eax
801051ab:	50                   	push   %eax
801051ac:	e8 c9 f3 ff ff       	call   8010457a <fetchint>
801051b1:	83 c4 10             	add    $0x10,%esp
801051b4:	85 c0                	test   %eax,%eax
801051b6:	78 5e                	js     80105216 <sys_exec+0xdd>
      return -1;
    if(uarg == 0){
801051b8:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801051be:	85 c0                	test   %eax,%eax
801051c0:	74 1d                	je     801051df <sys_exec+0xa6>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
801051c2:	83 ec 08             	sub    $0x8,%esp
801051c5:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
801051cc:	52                   	push   %edx
801051cd:	50                   	push   %eax
801051ce:	e8 e3 f3 ff ff       	call   801045b6 <fetchstr>
801051d3:	83 c4 10             	add    $0x10,%esp
801051d6:	85 c0                	test   %eax,%eax
801051d8:	78 46                	js     80105220 <sys_exec+0xe7>
  for(i=0;; i++){
801051da:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
801051dd:	eb b4                	jmp    80105193 <sys_exec+0x5a>
      argv[i] = 0;
801051df:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
801051e6:	00 00 00 00 
      return -1;
  }
  return exec(path, argv);
801051ea:	83 ec 08             	sub    $0x8,%esp
801051ed:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
801051f3:	50                   	push   %eax
801051f4:	ff 75 f4             	pushl  -0xc(%ebp)
801051f7:	e8 d6 b6 ff ff       	call   801008d2 <exec>
801051fc:	83 c4 10             	add    $0x10,%esp
801051ff:	eb 1a                	jmp    8010521b <sys_exec+0xe2>
    return -1;
80105201:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105206:	eb 13                	jmp    8010521b <sys_exec+0xe2>
80105208:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010520d:	eb 0c                	jmp    8010521b <sys_exec+0xe2>
      return -1;
8010520f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105214:	eb 05                	jmp    8010521b <sys_exec+0xe2>
      return -1;
...
80105225:	eb f4                	jmp    8010521b <sys_exec+0xe2>
...
8010524d:	e8 e3 da ff ff       	call   80102d35 <pipealloc>
80105252:	83 c4 10             	add    $0x10,%esp
80105255:	85 c0                	test   %eax,%eax
80105257:	78 67                	js     801052c0 <sys_pipe+0x99>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105259:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010525c:	e8 14 f5 ff ff       	call   80104775 <fdalloc>
80105261:	89 c3                	mov    %eax,%ebx
80105263:	85 c0                	test   %eax,%eax
80105265:	78 21                	js     80105288 <sys_pipe+0x61>
80105267:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010526a:	e8 06 f5 ff ff       	call   80104775 <fdalloc>
8010526f:	85 c0                	test   %eax,%eax
80105271:	78 15                	js     80105288 <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
8010527b:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
...
8010528a:	78 0d                	js     80105299 <sys_pipe+0x72>
      myproc()->ofile[fd0] = 0;
8010528c:	e8 c8 e0 ff ff       	call   80103359 <myproc>
80105291:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80105298:	00 
    fileclose(rf);
80105299:	83 ec 0c             	sub    $0xc,%esp
8010529c:	ff 75 f0             	pushl  -0x10(%ebp)
8010529f:	e8 2f ba ff ff       	call   80100cd3 <fileclose>
    fileclose(wf);
801052a4:	83 c4 04             	add    $0x4,%esp
801052a7:	ff 75 ec             	pushl  -0x14(%ebp)
801052aa:	e8 24 ba ff ff       	call   80100cd3 <fileclose>
    return -1;
801052af:	83 c4 10             	add    $0x10,%esp
801052b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052b7:	eb ca                	jmp    80105283 <sys_pipe+0x5c>
    return -1;
801052b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052be:	eb c3                	jmp    80105283 <sys_pipe+0x5c>
    return -1;
801052c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052c5:	eb bc                	jmp    80105283 <sys_pipe+0x5c>
...
801052ca:	83 ec 08             	sub    $0x8,%esp
  return fork();
801052cd:	e8 e0 e8 ff ff       	call   80103bb2 <fork>
}
801052d2:	c9                   	leave  
801052d3:	c3                   	ret    
...
801052d7:	83 ec 08             	sub    $0x8,%esp
  exit();
801052da:	e8 b4 e2 ff ff       	call   80103593 <exit>
...
801052e9:	83 ec 08             	sub    $0x8,%esp
  return wait();
801052ec:	e8 2e e4 ff ff       	call   8010371f <wait>
}
801052f1:	c9                   	leave  
801052f2:	c3                   	ret    
...
801052f6:	83 ec 20             	sub    $0x20,%esp
  int pid;
...
801052ff:	e8 f2 f2 ff ff       	call   801045f6 <argint>
80105304:	83 c4 10             	add    $0x10,%esp
80105307:	85 c0                	test   %eax,%eax
80105309:	78 10                	js     8010531b <sys_kill+0x28>
    return -1;
  return kill(pid);
8010530b:	83 ec 0c             	sub    $0xc,%esp
8010530e:	ff 75 f4             	pushl  -0xc(%ebp)
80105311:	e8 09 e5 ff ff       	call   8010381f <kill>
...
80105320:	eb f7                	jmp    80105319 <sys_kill+0x26>
...
80105325:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105328:	e8 2c e0 ff ff       	call   80103359 <myproc>
...
8010533f:	e8 b2 f2 ff ff       	call   801045f6 <argint>
80105344:	83 c4 10             	add    $0x10,%esp
80105347:	85 c0                	test   %eax,%eax
80105349:	78 27                	js     80105372 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010534b:	e8 09 e0 ff ff       	call   80103359 <myproc>
80105350:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105352:	83 ec 0c             	sub    $0xc,%esp
80105355:	ff 75 f4             	pushl  -0xc(%ebp)
80105358:	e8 26 e1 ff ff       	call   80103483 <growproc>
8010535d:	83 c4 10             	add    $0x10,%esp
80105360:	85 c0                	test   %eax,%eax
80105362:	78 07                	js     8010536b <sys_sbrk+0x39>
    return -1;
  return addr;
}
...
80105370:	eb f2                	jmp    80105364 <sys_sbrk+0x32>
    return -1;
80105372:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105377:	eb eb                	jmp    80105364 <sys_sbrk+0x32>
...
8010537d:	83 ec 1c             	sub    $0x1c,%esp
  int n;
  uint ticks0;

  if(argint(0, &n) < 0)
80105380:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105383:	50                   	push   %eax
80105384:	6a 00                	push   $0x0
80105386:	e8 6b f2 ff ff       	call   801045f6 <argint>
8010538b:	83 c4 10             	add    $0x10,%esp
8010538e:	85 c0                	test   %eax,%eax
80105390:	78 75                	js     80105407 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80105392:	83 ec 0c             	sub    $0xc,%esp
80105395:	68 80 69 11 80       	push   $0x80116980
8010539a:	e8 60 ef ff ff       	call   801042ff <acquire>
  ticks0 = ticks;
8010539f:	8b 1d c0 71 11 80    	mov    0x801171c0,%ebx
  while(ticks - ticks0 < n){
801053a5:	83 c4 10             	add    $0x10,%esp
801053a8:	a1 c0 71 11 80       	mov    0x801171c0,%eax
801053ad:	29 d8                	sub    %ebx,%eax
801053af:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801053b2:	73 39                	jae    801053ed <sys_sleep+0x74>
    if(myproc()->killed){
801053b4:	e8 a0 df ff ff       	call   80103359 <myproc>
801053b9:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
801053bd:	75 17                	jne    801053d6 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
801053bf:	83 ec 08             	sub    $0x8,%esp
801053c2:	68 80 69 11 80       	push   $0x80116980
801053c7:	68 c0 71 11 80       	push   $0x801171c0
801053cc:	e8 bd e2 ff ff       	call   8010368e <sleep>
801053d1:	83 c4 10             	add    $0x10,%esp
801053d4:	eb d2                	jmp    801053a8 <sys_sleep+0x2f>
      release(&tickslock);
801053d6:	83 ec 0c             	sub    $0xc,%esp
801053d9:	68 80 69 11 80       	push   $0x80116980
801053de:	e8 81 ef ff ff       	call   80104364 <release>
      return -1;
801053e3:	83 c4 10             	add    $0x10,%esp
801053e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053eb:	eb 15                	jmp    80105402 <sys_sleep+0x89>
  }
  release(&tickslock);
801053ed:	83 ec 0c             	sub    $0xc,%esp
801053f0:	68 80 69 11 80       	push   $0x80116980
801053f5:	e8 6a ef ff ff       	call   80104364 <release>
  return 0;
...
8010540c:	eb f4                	jmp    80105402 <sys_sleep+0x89>
...
80105412:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105415:	68 80 69 11 80       	push   $0x80116980
8010541a:	e8 e0 ee ff ff       	call   801042ff <acquire>
  xticks = ticks;
8010541f:	8b 1d c0 71 11 80    	mov    0x801171c0,%ebx
  release(&tickslock);
80105425:	c7 04 24 80 69 11 80 	movl   $0x80116980,(%esp)
8010542c:	e8 33 ef ff ff       	call   80104364 <release>
  return xticks;
}
...
80105444:	e8 ad f1 ff ff       	call   801045f6 <argint>
80105449:	83 c4 10             	add    $0x10,%esp
8010544c:	85 c0                	test   %eax,%eax
8010544e:	78 28                	js     80105478 <sys_setpri+0x40>
        return -1;
    if(argint(1, &pri) < 0)
...
8010547d:	eb f7                	jmp    80105476 <sys_setpri+0x3e>
        return -1;
8010547f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105484:	eb f0                	jmp    80105476 <sys_setpri+0x3e>
...
80105492:	e8 5f f1 ff ff       	call   801045f6 <argint>
80105497:	83 c4 10             	add    $0x10,%esp
8010549a:	85 c0                	test   %eax,%eax
8010549c:	78 10                	js     801054ae <sys_getpri+0x28>
        return -1;
    return getpri(PID);
8010549e:	83 ec 0c             	sub    $0xc,%esp
801054a1:	ff 75 f4             	pushl  -0xc(%ebp)
801054a4:	e8 20 e6 ff ff       	call   80103ac9 <getpri>
...
801054b3:	eb f7                	jmp    801054ac <sys_getpri+0x26>

801054b5 <sys_getpinfo>:
...
801054b8:	83 ec 1c             	sub    $0x1c,%esp
    struct pstat *ps;
    if(argptr(0, (void*)&ps, sizeof(*ps))< 0){
801054bb:	68 00 0c 00 00       	push   $0xc00
801054c0:	8d 45 f4             	lea    -0xc(%ebp),%eax
801054c3:	50                   	push   %eax
801054c4:	6a 00                	push   $0x0
801054c6:	e8 53 f1 ff ff       	call   8010461e <argptr>
801054cb:	83 c4 10             	add    $0x10,%esp
801054ce:	85 c0                	test   %eax,%eax
801054d0:	78 10                	js     801054e2 <sys_getpinfo+0x2d>
        return -1;
    }
    return getpinfo(ps);
801054d2:	83 ec 0c             	sub    $0xc,%esp
801054d5:	ff 75 f4             	pushl  -0xc(%ebp)
801054d8:	e8 22 e6 ff ff       	call   80103aff <getpinfo>
...
801054e7:	eb f7                	jmp    801054e0 <sys_getpinfo+0x2b>
...
801054ec:	83 ec 20             	sub    $0x20,%esp
    int pri;
    if(argint(0, &pri) < 0)
801054ef:	8d 45 f4             	lea    -0xc(%ebp),%eax
801054f2:	50                   	push   %eax
801054f3:	6a 00                	push   $0x0
801054f5:	e8 fc f0 ff ff       	call   801045f6 <argint>
801054fa:	83 c4 10             	add    $0x10,%esp
801054fd:	85 c0                	test   %eax,%eax
801054ff:	78 10                	js     80105511 <sys_fork2+0x28>
        return -1;
    return fork2(pri);
80105501:	83 ec 0c             	sub    $0xc,%esp
80105504:	ff 75 f4             	pushl  -0xc(%ebp)
80105507:	e8 3f ea ff ff       	call   80103f4b <fork2>
...
80105516:	eb f7                	jmp    8010550f <sys_fork2+0x26>
...
80105519:	06                   	push   %es
  pushl %fs
8010551a:	0f a0                	push   %fs
  pushl %gs
8010551c:	0f a8                	push   %gs
  pushal
8010551e:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010551f:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105523:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105525:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105527:	54                   	push   %esp
  call trap
80105528:	e8 e3 00 00 00       	call   80105610 <trap>
  addl $4, %esp
8010552d:	83 c4 04             	add    $0x4,%esp
...
80105530:	61                   	popa   
  popl %gs
80105531:	0f a9                	pop    %gs
  popl %fs
80105533:	0f a1                	pop    %fs
  popl %es
80105535:	07                   	pop    %es
  popl %ds
80105536:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105537:	83 c4 08             	add    $0x8,%esp
  iret
8010553a:	cf                   	iret   
...
80105546:	eb 4a                	jmp    80105592 <tvinit+0x57>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80105548:	8b 0c 85 18 a0 10 80 	mov    -0x7fef5fe8(,%eax,4),%ecx
8010554f:	66 89 0c c5 c0 69 11 	mov    %cx,-0x7fee9640(,%eax,8)
80105556:	80 
80105557:	66 c7 04 c5 c2 69 11 	movw   $0x8,-0x7fee963e(,%eax,8)
8010555e:	80 08 00 
80105561:	c6 04 c5 c4 69 11 80 	movb   $0x0,-0x7fee963c(,%eax,8)
80105568:	00 
80105569:	0f b6 14 c5 c5 69 11 	movzbl -0x7fee963b(,%eax,8),%edx
80105570:	80 
80105571:	83 e2 f0             	and    $0xfffffff0,%edx
80105574:	83 ca 0e             	or     $0xe,%edx
80105577:	83 e2 8f             	and    $0xffffff8f,%edx
8010557a:	83 ca 80             	or     $0xffffff80,%edx
8010557d:	88 14 c5 c5 69 11 80 	mov    %dl,-0x7fee963b(,%eax,8)
80105584:	c1 e9 10             	shr    $0x10,%ecx
80105587:	66 89 0c c5 c6 69 11 	mov    %cx,-0x7fee963a(,%eax,8)
8010558e:	80 
  for(i = 0; i < 256; i++)
8010558f:	83 c0 01             	add    $0x1,%eax
80105592:	3d ff 00 00 00       	cmp    $0xff,%eax
80105597:	7e af                	jle    80105548 <tvinit+0xd>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105599:	8b 15 18 a1 10 80    	mov    0x8010a118,%edx
8010559f:	66 89 15 c0 6b 11 80 	mov    %dx,0x80116bc0
801055a6:	66 c7 05 c2 6b 11 80 	movw   $0x8,0x80116bc2
801055ad:	08 00 
801055af:	c6 05 c4 6b 11 80 00 	movb   $0x0,0x80116bc4
801055b6:	0f b6 05 c5 6b 11 80 	movzbl 0x80116bc5,%eax
801055bd:	83 c8 0f             	or     $0xf,%eax
801055c0:	83 e0 ef             	and    $0xffffffef,%eax
801055c3:	83 c8 e0             	or     $0xffffffe0,%eax
801055c6:	a2 c5 6b 11 80       	mov    %al,0x80116bc5
801055cb:	c1 ea 10             	shr    $0x10,%edx
801055ce:	66 89 15 c6 6b 11 80 	mov    %dx,0x80116bc6

  initlock(&tickslock, "time");
801055d5:	83 ec 08             	sub    $0x8,%esp
801055d8:	68 49 74 10 80       	push   $0x80107449
801055dd:	68 80 69 11 80       	push   $0x80116980
801055e2:	e8 dc eb ff ff       	call   801041c3 <initlock>
}
...
801055ef:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
801055f2:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
801055f8:	b8 c0 69 11 80       	mov    $0x801169c0,%eax
801055fd:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105601:	c1 e8 10             	shr    $0x10,%eax
80105604:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105608:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010560b:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
8010560e:	c9                   	leave  
8010560f:	c3                   	ret    
...
80105622:	74 13                	je     80105637 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  //cprintf("%d TRAP CODE \n", tf->trapno);
  switch(tf->trapno){
80105624:	83 e8 20             	sub    $0x20,%eax
80105627:	83 f8 1f             	cmp    $0x1f,%eax
8010562a:	0f 87 3a 01 00 00    	ja     8010576a <trap+0x15a>
80105630:	ff 24 85 f0 74 10 80 	jmp    *-0x7fef8b10(,%eax,4)
    if(myproc()->killed)
80105637:	e8 1d dd ff ff       	call   80103359 <myproc>
8010563c:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105640:	75 1f                	jne    80105661 <trap+0x51>
    myproc()->tf = tf;
80105642:	e8 12 dd ff ff       	call   80103359 <myproc>
80105647:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
8010564a:	e8 6a f0 ff ff       	call   801046b9 <syscall>
    if(myproc()->killed)
8010564f:	e8 05 dd ff ff       	call   80103359 <myproc>
80105654:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105658:	74 7e                	je     801056d8 <trap+0xc8>
      exit();
8010565a:	e8 34 df ff ff       	call   80103593 <exit>
8010565f:	eb 77                	jmp    801056d8 <trap+0xc8>
      exit();
80105661:	e8 2d df ff ff       	call   80103593 <exit>
80105666:	eb da                	jmp    80105642 <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105668:	e8 d1 dc ff ff       	call   8010333e <cpuid>
8010566d:	85 c0                	test   %eax,%eax
8010566f:	74 6f                	je     801056e0 <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80105671:	e8 23 cd ff ff       	call   80102399 <lapiceoi>
  }
...
80105676:	e8 de dc ff ff       	call   80103359 <myproc>
8010567b:	85 c0                	test   %eax,%eax
8010567d:	74 1c                	je     8010569b <trap+0x8b>
8010567f:	e8 d5 dc ff ff       	call   80103359 <myproc>
80105684:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105688:	74 11                	je     8010569b <trap+0x8b>
8010568a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
8010568e:	83 e0 03             	and    $0x3,%eax
80105691:	66 83 f8 03          	cmp    $0x3,%ax
80105695:	0f 84 62 01 00 00    	je     801057fd <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
8010569b:	e8 b9 dc ff ff       	call   80103359 <myproc>
801056a0:	85 c0                	test   %eax,%eax
801056a2:	74 0f                	je     801056b3 <trap+0xa3>
801056a4:	e8 b0 dc ff ff       	call   80103359 <myproc>
801056a9:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801056ad:	0f 84 54 01 00 00    	je     80105807 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER) {
    yield();
  }
  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801056b3:	e8 a1 dc ff ff       	call   80103359 <myproc>
801056b8:	85 c0                	test   %eax,%eax
801056ba:	74 1c                	je     801056d8 <trap+0xc8>
801056bc:	e8 98 dc ff ff       	call   80103359 <myproc>
801056c1:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
801056c5:	74 11                	je     801056d8 <trap+0xc8>
801056c7:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801056cb:	83 e0 03             	and    $0x3,%eax
801056ce:	66 83 f8 03          	cmp    $0x3,%ax
801056d2:	0f 84 43 01 00 00    	je     8010581b <trap+0x20b>
    exit();
}
801056d8:	8d 65 f4             	lea    -0xc(%ebp),%esp
801056db:	5b                   	pop    %ebx
801056dc:	5e                   	pop    %esi
801056dd:	5f                   	pop    %edi
801056de:	5d                   	pop    %ebp
...
801056e3:	68 80 69 11 80       	push   $0x80116980
801056e8:	e8 12 ec ff ff       	call   801042ff <acquire>
      ticks++;
801056ed:	83 05 c0 71 11 80 01 	addl   $0x1,0x801171c0
      wakeup(&ticks);
801056f4:	c7 04 24 c0 71 11 80 	movl   $0x801171c0,(%esp)
801056fb:	e8 f6 e0 ff ff       	call   801037f6 <wakeup>
      release(&tickslock);
80105700:	c7 04 24 80 69 11 80 	movl   $0x80116980,(%esp)
80105707:	e8 58 ec ff ff       	call   80104364 <release>
8010570c:	83 c4 10             	add    $0x10,%esp
8010570f:	e9 5d ff ff ff       	jmp    80105671 <trap+0x61>
    ideintr();
80105714:	e8 5a c6 ff ff       	call   80101d73 <ideintr>
    lapiceoi();
80105719:	e8 7b cc ff ff       	call   80102399 <lapiceoi>
    break;
8010571e:	e9 53 ff ff ff       	jmp    80105676 <trap+0x66>
    kbdintr();
80105723:	e8 b5 ca ff ff       	call   801021dd <kbdintr>
    lapiceoi();
80105728:	e8 6c cc ff ff       	call   80102399 <lapiceoi>
    break;
8010572d:	e9 44 ff ff ff       	jmp    80105676 <trap+0x66>
    uartintr();
80105732:	e8 05 02 00 00       	call   8010593c <uartintr>
    lapiceoi();
80105737:	e8 5d cc ff ff       	call   80102399 <lapiceoi>
    break;
8010573c:	e9 35 ff ff ff       	jmp    80105676 <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105741:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80105744:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105748:	e8 f1 db ff ff       	call   8010333e <cpuid>
8010574d:	57                   	push   %edi
8010574e:	0f b7 f6             	movzwl %si,%esi
80105751:	56                   	push   %esi
80105752:	50                   	push   %eax
80105753:	68 54 74 10 80       	push   $0x80107454
80105758:	e8 ae ae ff ff       	call   8010060b <cprintf>
    lapiceoi();
8010575d:	e8 37 cc ff ff       	call   80102399 <lapiceoi>
    break;
80105762:	83 c4 10             	add    $0x10,%esp
80105765:	e9 0c ff ff ff       	jmp    80105676 <trap+0x66>
    if( myproc() == 0 || (tf->cs&3) == 0){
8010576a:	e8 ea db ff ff       	call   80103359 <myproc>
8010576f:	85 c0                	test   %eax,%eax
80105771:	74 5f                	je     801057d2 <trap+0x1c2>
80105773:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105777:	74 59                	je     801057d2 <trap+0x1c2>
...
80105779:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010577c:	8b 43 38             	mov    0x38(%ebx),%eax
8010577f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105782:	e8 b7 db ff ff       	call   8010333e <cpuid>
80105787:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010578a:	8b 53 34             	mov    0x34(%ebx),%edx
8010578d:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105790:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
80105793:	e8 c1 db ff ff       	call   80103359 <myproc>
80105798:	8d 48 6c             	lea    0x6c(%eax),%ecx
8010579b:	89 4d d8             	mov    %ecx,-0x28(%ebp)
8010579e:	e8 b6 db ff ff       	call   80103359 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801057a3:	57                   	push   %edi
801057a4:	ff 75 e4             	pushl  -0x1c(%ebp)
801057a7:	ff 75 e0             	pushl  -0x20(%ebp)
801057aa:	ff 75 dc             	pushl  -0x24(%ebp)
801057ad:	56                   	push   %esi
801057ae:	ff 75 d8             	pushl  -0x28(%ebp)
801057b1:	ff 70 10             	pushl  0x10(%eax)
801057b4:	68 ac 74 10 80       	push   $0x801074ac
801057b9:	e8 4d ae ff ff       	call   8010060b <cprintf>
    myproc()->killed = 1;
801057be:	83 c4 20             	add    $0x20,%esp
801057c1:	e8 93 db ff ff       	call   80103359 <myproc>
801057c6:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801057cd:	e9 a4 fe ff ff       	jmp    80105676 <trap+0x66>
801057d2:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057d5:	8b 73 38             	mov    0x38(%ebx),%esi
801057d8:	e8 61 db ff ff       	call   8010333e <cpuid>
801057dd:	83 ec 0c             	sub    $0xc,%esp
801057e0:	57                   	push   %edi
801057e1:	56                   	push   %esi
801057e2:	50                   	push   %eax
801057e3:	ff 73 30             	pushl  0x30(%ebx)
801057e6:	68 78 74 10 80       	push   $0x80107478
801057eb:	e8 1b ae ff ff       	call   8010060b <cprintf>
      panic("trap");
801057f0:	83 c4 14             	add    $0x14,%esp
801057f3:	68 4e 74 10 80       	push   $0x8010744e
801057f8:	e8 4b ab ff ff       	call   80100348 <panic>
    exit();
801057fd:	e8 91 dd ff ff       	call   80103593 <exit>
80105802:	e9 94 fe ff ff       	jmp    8010569b <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
80105807:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010580b:	0f 85 a2 fe ff ff    	jne    801056b3 <trap+0xa3>
    yield();
80105811:	e8 46 de ff ff       	call   8010365c <yield>
80105816:	e9 98 fe ff ff       	jmp    801056b3 <trap+0xa3>
    exit();
8010581b:	e8 73 dd ff ff       	call   80103593 <exit>
80105820:	e9 b3 fe ff ff       	jmp    801056d8 <trap+0xc8>
...
80105826:	89 e5                	mov    %esp,%ebp
  if(!uart)
80105828:	83 3d bc a5 10 80 00 	cmpl   $0x0,0x8010a5bc
8010582f:	74 15                	je     80105846 <uartgetc+0x21>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105831:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105836:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105837:	a8 01                	test   $0x1,%al
80105839:	74 12                	je     8010584d <uartgetc+0x28>
8010583b:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105840:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105841:	0f b6 c0             	movzbl %al,%eax
}
80105844:	5d                   	pop    %ebp
80105845:	c3                   	ret    
    return -1;
80105846:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010584b:	eb f7                	jmp    80105844 <uartgetc+0x1f>
    return -1;
8010584d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105852:	eb f0                	jmp    80105844 <uartgetc+0x1f>

80105854 <uartputc>:
  if(!uart)
80105854:	83 3d bc a5 10 80 00 	cmpl   $0x0,0x8010a5bc
8010585b:	74 3b                	je     80105898 <uartputc+0x44>
{
...
80105864:	bb 00 00 00 00       	mov    $0x0,%ebx
80105869:	eb 10                	jmp    8010587b <uartputc+0x27>
    microdelay(10);
8010586b:	83 ec 0c             	sub    $0xc,%esp
8010586e:	6a 0a                	push   $0xa
80105870:	e8 43 cb ff ff       	call   801023b8 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105875:	83 c3 01             	add    $0x1,%ebx
80105878:	83 c4 10             	add    $0x10,%esp
8010587b:	83 fb 7f             	cmp    $0x7f,%ebx
8010587e:	7f 0a                	jg     8010588a <uartputc+0x36>
80105880:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105885:	ec                   	in     (%dx),%al
80105886:	a8 20                	test   $0x20,%al
80105888:	74 e1                	je     8010586b <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010588a:	8b 45 08             	mov    0x8(%ebp),%eax
8010588d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105892:	ee                   	out    %al,(%dx)
}
80105893:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105896:	c9                   	leave  
80105897:	c3                   	ret    
...
8010589f:	b9 00 00 00 00       	mov    $0x0,%ecx
801058a4:	ba fa 03 00 00       	mov    $0x3fa,%edx
801058a9:	89 c8                	mov    %ecx,%eax
801058ab:	ee                   	out    %al,(%dx)
801058ac:	be fb 03 00 00       	mov    $0x3fb,%esi
801058b1:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801058b6:	89 f2                	mov    %esi,%edx
801058b8:	ee                   	out    %al,(%dx)
801058b9:	b8 0c 00 00 00       	mov    $0xc,%eax
801058be:	ba f8 03 00 00       	mov    $0x3f8,%edx
801058c3:	ee                   	out    %al,(%dx)
801058c4:	bb f9 03 00 00       	mov    $0x3f9,%ebx
801058c9:	89 c8                	mov    %ecx,%eax
801058cb:	89 da                	mov    %ebx,%edx
801058cd:	ee                   	out    %al,(%dx)
801058ce:	b8 03 00 00 00       	mov    $0x3,%eax
801058d3:	89 f2                	mov    %esi,%edx
801058d5:	ee                   	out    %al,(%dx)
801058d6:	ba fc 03 00 00       	mov    $0x3fc,%edx
801058db:	89 c8                	mov    %ecx,%eax
801058dd:	ee                   	out    %al,(%dx)
801058de:	b8 01 00 00 00       	mov    $0x1,%eax
801058e3:	89 da                	mov    %ebx,%edx
801058e5:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801058e6:	ba fd 03 00 00       	mov    $0x3fd,%edx
801058eb:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
801058ec:	3c ff                	cmp    $0xff,%al
801058ee:	74 45                	je     80105935 <uartinit+0x9b>
  uart = 1;
801058f0:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
801058f7:	00 00 00 
801058fa:	ba fa 03 00 00       	mov    $0x3fa,%edx
801058ff:	ec                   	in     (%dx),%al
80105900:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105905:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105906:	83 ec 08             	sub    $0x8,%esp
80105909:	6a 00                	push   $0x0
8010590b:	6a 04                	push   $0x4
8010590d:	e8 6c c6 ff ff       	call   80101f7e <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105912:	83 c4 10             	add    $0x10,%esp
80105915:	bb 70 75 10 80       	mov    $0x80107570,%ebx
8010591a:	eb 12                	jmp    8010592e <uartinit+0x94>
    uartputc(*p);
8010591c:	83 ec 0c             	sub    $0xc,%esp
8010591f:	0f be c0             	movsbl %al,%eax
80105922:	50                   	push   %eax
80105923:	e8 2c ff ff ff       	call   80105854 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105928:	83 c3 01             	add    $0x1,%ebx
8010592b:	83 c4 10             	add    $0x10,%esp
8010592e:	0f b6 03             	movzbl (%ebx),%eax
80105931:	84 c0                	test   %al,%al
80105933:	75 e7                	jne    8010591c <uartinit+0x82>
}
80105935:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105938:	5b                   	pop    %ebx
80105939:	5e                   	pop    %esi
8010593a:	5d                   	pop    %ebp
8010593b:	c3                   	ret    
...
80105942:	68 25 58 10 80       	push   $0x80105825
80105947:	e8 f2 ad ff ff       	call   8010073e <consoleintr>
}
...
80105953:	6a 00                	push   $0x0
  jmp alltraps
80105955:	e9 be fb ff ff       	jmp    80105518 <alltraps>
...
8010595a:	6a 00                	push   $0x0
  pushl $1
8010595c:	6a 01                	push   $0x1
  jmp alltraps
8010595e:	e9 b5 fb ff ff       	jmp    80105518 <alltraps>
...
80105965:	6a 02                	push   $0x2
  jmp alltraps
80105967:	e9 ac fb ff ff       	jmp    80105518 <alltraps>
...
8010596c:	6a 00                	push   $0x0
  pushl $3
8010596e:	6a 03                	push   $0x3
  jmp alltraps
80105970:	e9 a3 fb ff ff       	jmp    80105518 <alltraps>
...
80105975:	6a 00                	push   $0x0
  pushl $4
80105977:	6a 04                	push   $0x4
  jmp alltraps
80105979:	e9 9a fb ff ff       	jmp    80105518 <alltraps>
...
8010597e:	6a 00                	push   $0x0
  pushl $5
80105980:	6a 05                	push   $0x5
  jmp alltraps
80105982:	e9 91 fb ff ff       	jmp    80105518 <alltraps>
...
80105987:	6a 00                	push   $0x0
  pushl $6
80105989:	6a 06                	push   $0x6
  jmp alltraps
8010598b:	e9 88 fb ff ff       	jmp    80105518 <alltraps>
...
80105990:	6a 00                	push   $0x0
  pushl $7
80105992:	6a 07                	push   $0x7
  jmp alltraps
80105994:	e9 7f fb ff ff       	jmp    80105518 <alltraps>

80105999 <vector8>:
.globl vector8
vector8:
  pushl $8
80105999:	6a 08                	push   $0x8
  jmp alltraps
8010599b:	e9 78 fb ff ff       	jmp    80105518 <alltraps>
...
801059a0:	6a 00                	push   $0x0
  pushl $9
801059a2:	6a 09                	push   $0x9
  jmp alltraps
801059a4:	e9 6f fb ff ff       	jmp    80105518 <alltraps>

801059a9 <vector10>:
.globl vector10
vector10:
  pushl $10
801059a9:	6a 0a                	push   $0xa
  jmp alltraps
801059ab:	e9 68 fb ff ff       	jmp    80105518 <alltraps>

801059b0 <vector11>:
.globl vector11
vector11:
  pushl $11
801059b0:	6a 0b                	push   $0xb
  jmp alltraps
801059b2:	e9 61 fb ff ff       	jmp    80105518 <alltraps>

801059b7 <vector12>:
.globl vector12
vector12:
  pushl $12
801059b7:	6a 0c                	push   $0xc
  jmp alltraps
801059b9:	e9 5a fb ff ff       	jmp    80105518 <alltraps>

801059be <vector13>:
.globl vector13
vector13:
  pushl $13
801059be:	6a 0d                	push   $0xd
  jmp alltraps
801059c0:	e9 53 fb ff ff       	jmp    80105518 <alltraps>

801059c5 <vector14>:
.globl vector14
vector14:
  pushl $14
801059c5:	6a 0e                	push   $0xe
  jmp alltraps
801059c7:	e9 4c fb ff ff       	jmp    80105518 <alltraps>
...
801059cc:	6a 00                	push   $0x0
  pushl $15
801059ce:	6a 0f                	push   $0xf
  jmp alltraps
801059d0:	e9 43 fb ff ff       	jmp    80105518 <alltraps>
...
801059d7:	6a 10                	push   $0x10
  jmp alltraps
801059d9:	e9 3a fb ff ff       	jmp    80105518 <alltraps>

801059de <vector17>:
.globl vector17
vector17:
  pushl $17
801059de:	6a 11                	push   $0x11
  jmp alltraps
801059e0:	e9 33 fb ff ff       	jmp    80105518 <alltraps>
...
801059e5:	6a 00                	push   $0x0
  pushl $18
801059e7:	6a 12                	push   $0x12
  jmp alltraps
801059e9:	e9 2a fb ff ff       	jmp    80105518 <alltraps>
...
801059ee:	6a 00                	push   $0x0
  pushl $19
801059f0:	6a 13                	push   $0x13
  jmp alltraps
801059f2:	e9 21 fb ff ff       	jmp    80105518 <alltraps>
...
801059f7:	6a 00                	push   $0x0
  pushl $20
801059f9:	6a 14                	push   $0x14
  jmp alltraps
801059fb:	e9 18 fb ff ff       	jmp    80105518 <alltraps>
...
80105a00:	6a 00                	push   $0x0
  pushl $21
80105a02:	6a 15                	push   $0x15
  jmp alltraps
80105a04:	e9 0f fb ff ff       	jmp    80105518 <alltraps>
...
80105a09:	6a 00                	push   $0x0
  pushl $22
80105a0b:	6a 16                	push   $0x16
  jmp alltraps
80105a0d:	e9 06 fb ff ff       	jmp    80105518 <alltraps>
...
80105a12:	6a 00                	push   $0x0
  pushl $23
80105a14:	6a 17                	push   $0x17
  jmp alltraps
80105a16:	e9 fd fa ff ff       	jmp    80105518 <alltraps>
...
80105a1b:	6a 00                	push   $0x0
  pushl $24
80105a1d:	6a 18                	push   $0x18
  jmp alltraps
80105a1f:	e9 f4 fa ff ff       	jmp    80105518 <alltraps>
...
80105a24:	6a 00                	push   $0x0
  pushl $25
80105a26:	6a 19                	push   $0x19
  jmp alltraps
80105a28:	e9 eb fa ff ff       	jmp    80105518 <alltraps>
...
80105a2d:	6a 00                	push   $0x0
  pushl $26
80105a2f:	6a 1a                	push   $0x1a
  jmp alltraps
80105a31:	e9 e2 fa ff ff       	jmp    80105518 <alltraps>
...
80105a36:	6a 00                	push   $0x0
  pushl $27
80105a38:	6a 1b                	push   $0x1b
  jmp alltraps
80105a3a:	e9 d9 fa ff ff       	jmp    80105518 <alltraps>
...
80105a3f:	6a 00                	push   $0x0
  pushl $28
80105a41:	6a 1c                	push   $0x1c
  jmp alltraps
80105a43:	e9 d0 fa ff ff       	jmp    80105518 <alltraps>
...
80105a48:	6a 00                	push   $0x0
  pushl $29
80105a4a:	6a 1d                	push   $0x1d
  jmp alltraps
80105a4c:	e9 c7 fa ff ff       	jmp    80105518 <alltraps>
...
80105a51:	6a 00                	push   $0x0
  pushl $30
80105a53:	6a 1e                	push   $0x1e
  jmp alltraps
80105a55:	e9 be fa ff ff       	jmp    80105518 <alltraps>
...
80105a5a:	6a 00                	push   $0x0
  pushl $31
80105a5c:	6a 1f                	push   $0x1f
  jmp alltraps
80105a5e:	e9 b5 fa ff ff       	jmp    80105518 <alltraps>
...
80105a63:	6a 00                	push   $0x0
  pushl $32
80105a65:	6a 20                	push   $0x20
  jmp alltraps
80105a67:	e9 ac fa ff ff       	jmp    80105518 <alltraps>
...
80105a6c:	6a 00                	push   $0x0
  pushl $33
80105a6e:	6a 21                	push   $0x21
  jmp alltraps
80105a70:	e9 a3 fa ff ff       	jmp    80105518 <alltraps>
...
80105a75:	6a 00                	push   $0x0
  pushl $34
80105a77:	6a 22                	push   $0x22
  jmp alltraps
80105a79:	e9 9a fa ff ff       	jmp    80105518 <alltraps>
...
80105a7e:	6a 00                	push   $0x0
  pushl $35
80105a80:	6a 23                	push   $0x23
  jmp alltraps
80105a82:	e9 91 fa ff ff       	jmp    80105518 <alltraps>
...
80105a87:	6a 00                	push   $0x0
  pushl $36
80105a89:	6a 24                	push   $0x24
  jmp alltraps
80105a8b:	e9 88 fa ff ff       	jmp    80105518 <alltraps>
...
80105a90:	6a 00                	push   $0x0
  pushl $37
80105a92:	6a 25                	push   $0x25
  jmp alltraps
80105a94:	e9 7f fa ff ff       	jmp    80105518 <alltraps>
...
80105a99:	6a 00                	push   $0x0
  pushl $38
80105a9b:	6a 26                	push   $0x26
  jmp alltraps
80105a9d:	e9 76 fa ff ff       	jmp    80105518 <alltraps>
...
80105aa2:	6a 00                	push   $0x0
  pushl $39
80105aa4:	6a 27                	push   $0x27
  jmp alltraps
80105aa6:	e9 6d fa ff ff       	jmp    80105518 <alltraps>
...
80105aab:	6a 00                	push   $0x0
  pushl $40
80105aad:	6a 28                	push   $0x28
  jmp alltraps
80105aaf:	e9 64 fa ff ff       	jmp    80105518 <alltraps>
...
80105ab4:	6a 00                	push   $0x0
  pushl $41
80105ab6:	6a 29                	push   $0x29
  jmp alltraps
80105ab8:	e9 5b fa ff ff       	jmp    80105518 <alltraps>
...
80105abd:	6a 00                	push   $0x0
  pushl $42
80105abf:	6a 2a                	push   $0x2a
  jmp alltraps
80105ac1:	e9 52 fa ff ff       	jmp    80105518 <alltraps>
...
80105ac6:	6a 00                	push   $0x0
  pushl $43
80105ac8:	6a 2b                	push   $0x2b
  jmp alltraps
80105aca:	e9 49 fa ff ff       	jmp    80105518 <alltraps>
...
80105acf:	6a 00                	push   $0x0
  pushl $44
80105ad1:	6a 2c                	push   $0x2c
  jmp alltraps
80105ad3:	e9 40 fa ff ff       	jmp    80105518 <alltraps>
...
80105ad8:	6a 00                	push   $0x0
  pushl $45
80105ada:	6a 2d                	push   $0x2d
  jmp alltraps
80105adc:	e9 37 fa ff ff       	jmp    80105518 <alltraps>
...
80105ae1:	6a 00                	push   $0x0
  pushl $46
80105ae3:	6a 2e                	push   $0x2e
  jmp alltraps
80105ae5:	e9 2e fa ff ff       	jmp    80105518 <alltraps>
...
80105aea:	6a 00                	push   $0x0
  pushl $47
80105aec:	6a 2f                	push   $0x2f
  jmp alltraps
80105aee:	e9 25 fa ff ff       	jmp    80105518 <alltraps>
...
80105af3:	6a 00                	push   $0x0
  pushl $48
80105af5:	6a 30                	push   $0x30
  jmp alltraps
80105af7:	e9 1c fa ff ff       	jmp    80105518 <alltraps>
...
80105afc:	6a 00                	push   $0x0
  pushl $49
80105afe:	6a 31                	push   $0x31
  jmp alltraps
80105b00:	e9 13 fa ff ff       	jmp    80105518 <alltraps>
...
80105b05:	6a 00                	push   $0x0
  pushl $50
80105b07:	6a 32                	push   $0x32
  jmp alltraps
80105b09:	e9 0a fa ff ff       	jmp    80105518 <alltraps>
...
80105b0e:	6a 00                	push   $0x0
  pushl $51
80105b10:	6a 33                	push   $0x33
  jmp alltraps
80105b12:	e9 01 fa ff ff       	jmp    80105518 <alltraps>
...
80105b17:	6a 00                	push   $0x0
  pushl $52
80105b19:	6a 34                	push   $0x34
  jmp alltraps
80105b1b:	e9 f8 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b20:	6a 00                	push   $0x0
  pushl $53
80105b22:	6a 35                	push   $0x35
  jmp alltraps
80105b24:	e9 ef f9 ff ff       	jmp    80105518 <alltraps>
...
80105b29:	6a 00                	push   $0x0
  pushl $54
80105b2b:	6a 36                	push   $0x36
  jmp alltraps
80105b2d:	e9 e6 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b32:	6a 00                	push   $0x0
  pushl $55
80105b34:	6a 37                	push   $0x37
  jmp alltraps
80105b36:	e9 dd f9 ff ff       	jmp    80105518 <alltraps>
...
80105b3b:	6a 00                	push   $0x0
  pushl $56
80105b3d:	6a 38                	push   $0x38
  jmp alltraps
80105b3f:	e9 d4 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b44:	6a 00                	push   $0x0
  pushl $57
80105b46:	6a 39                	push   $0x39
  jmp alltraps
80105b48:	e9 cb f9 ff ff       	jmp    80105518 <alltraps>
...
80105b4d:	6a 00                	push   $0x0
  pushl $58
80105b4f:	6a 3a                	push   $0x3a
  jmp alltraps
80105b51:	e9 c2 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b56:	6a 00                	push   $0x0
  pushl $59
80105b58:	6a 3b                	push   $0x3b
  jmp alltraps
80105b5a:	e9 b9 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b5f:	6a 00                	push   $0x0
  pushl $60
80105b61:	6a 3c                	push   $0x3c
  jmp alltraps
80105b63:	e9 b0 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b68:	6a 00                	push   $0x0
  pushl $61
80105b6a:	6a 3d                	push   $0x3d
  jmp alltraps
80105b6c:	e9 a7 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b71:	6a 00                	push   $0x0
  pushl $62
80105b73:	6a 3e                	push   $0x3e
  jmp alltraps
80105b75:	e9 9e f9 ff ff       	jmp    80105518 <alltraps>
...
80105b7a:	6a 00                	push   $0x0
  pushl $63
80105b7c:	6a 3f                	push   $0x3f
  jmp alltraps
80105b7e:	e9 95 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b83:	6a 00                	push   $0x0
  pushl $64
80105b85:	6a 40                	push   $0x40
  jmp alltraps
80105b87:	e9 8c f9 ff ff       	jmp    80105518 <alltraps>
...
80105b8c:	6a 00                	push   $0x0
  pushl $65
80105b8e:	6a 41                	push   $0x41
  jmp alltraps
80105b90:	e9 83 f9 ff ff       	jmp    80105518 <alltraps>
...
80105b95:	6a 00                	push   $0x0
  pushl $66
80105b97:	6a 42                	push   $0x42
  jmp alltraps
80105b99:	e9 7a f9 ff ff       	jmp    80105518 <alltraps>
...
80105b9e:	6a 00                	push   $0x0
  pushl $67
80105ba0:	6a 43                	push   $0x43
  jmp alltraps
80105ba2:	e9 71 f9 ff ff       	jmp    80105518 <alltraps>
...
80105ba7:	6a 00                	push   $0x0
  pushl $68
80105ba9:	6a 44                	push   $0x44
  jmp alltraps
80105bab:	e9 68 f9 ff ff       	jmp    80105518 <alltraps>
...
80105bb0:	6a 00                	push   $0x0
  pushl $69
80105bb2:	6a 45                	push   $0x45
  jmp alltraps
80105bb4:	e9 5f f9 ff ff       	jmp    80105518 <alltraps>
...
80105bb9:	6a 00                	push   $0x0
  pushl $70
80105bbb:	6a 46                	push   $0x46
  jmp alltraps
80105bbd:	e9 56 f9 ff ff       	jmp    80105518 <alltraps>
...
80105bc2:	6a 00                	push   $0x0
  pushl $71
80105bc4:	6a 47                	push   $0x47
  jmp alltraps
80105bc6:	e9 4d f9 ff ff       	jmp    80105518 <alltraps>
...
80105bcb:	6a 00                	push   $0x0
  pushl $72
80105bcd:	6a 48                	push   $0x48
  jmp alltraps
80105bcf:	e9 44 f9 ff ff       	jmp    80105518 <alltraps>
...
80105bd4:	6a 00                	push   $0x0
  pushl $73
80105bd6:	6a 49                	push   $0x49
  jmp alltraps
80105bd8:	e9 3b f9 ff ff       	jmp    80105518 <alltraps>
...
80105bdd:	6a 00                	push   $0x0
  pushl $74
80105bdf:	6a 4a                	push   $0x4a
  jmp alltraps
80105be1:	e9 32 f9 ff ff       	jmp    80105518 <alltraps>
...
80105be6:	6a 00                	push   $0x0
  pushl $75
80105be8:	6a 4b                	push   $0x4b
  jmp alltraps
80105bea:	e9 29 f9 ff ff       	jmp    80105518 <alltraps>
...
80105bef:	6a 00                	push   $0x0
  pushl $76
80105bf1:	6a 4c                	push   $0x4c
  jmp alltraps
80105bf3:	e9 20 f9 ff ff       	jmp    80105518 <alltraps>
...
80105bf8:	6a 00                	push   $0x0
  pushl $77
80105bfa:	6a 4d                	push   $0x4d
  jmp alltraps
80105bfc:	e9 17 f9 ff ff       	jmp    80105518 <alltraps>
...
80105c01:	6a 00                	push   $0x0
  pushl $78
80105c03:	6a 4e                	push   $0x4e
  jmp alltraps
80105c05:	e9 0e f9 ff ff       	jmp    80105518 <alltraps>
...
80105c0a:	6a 00                	push   $0x0
  pushl $79
80105c0c:	6a 4f                	push   $0x4f
  jmp alltraps
80105c0e:	e9 05 f9 ff ff       	jmp    80105518 <alltraps>
...
80105c13:	6a 00                	push   $0x0
  pushl $80
80105c15:	6a 50                	push   $0x50
  jmp alltraps
80105c17:	e9 fc f8 ff ff       	jmp    80105518 <alltraps>
...
80105c1c:	6a 00                	push   $0x0
  pushl $81
80105c1e:	6a 51                	push   $0x51
  jmp alltraps
80105c20:	e9 f3 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c25:	6a 00                	push   $0x0
  pushl $82
80105c27:	6a 52                	push   $0x52
  jmp alltraps
80105c29:	e9 ea f8 ff ff       	jmp    80105518 <alltraps>
...
80105c2e:	6a 00                	push   $0x0
  pushl $83
80105c30:	6a 53                	push   $0x53
  jmp alltraps
80105c32:	e9 e1 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c37:	6a 00                	push   $0x0
  pushl $84
80105c39:	6a 54                	push   $0x54
  jmp alltraps
80105c3b:	e9 d8 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c40:	6a 00                	push   $0x0
  pushl $85
80105c42:	6a 55                	push   $0x55
  jmp alltraps
80105c44:	e9 cf f8 ff ff       	jmp    80105518 <alltraps>
...
80105c49:	6a 00                	push   $0x0
  pushl $86
80105c4b:	6a 56                	push   $0x56
  jmp alltraps
80105c4d:	e9 c6 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c52:	6a 00                	push   $0x0
  pushl $87
80105c54:	6a 57                	push   $0x57
  jmp alltraps
80105c56:	e9 bd f8 ff ff       	jmp    80105518 <alltraps>
...
80105c5b:	6a 00                	push   $0x0
  pushl $88
80105c5d:	6a 58                	push   $0x58
  jmp alltraps
80105c5f:	e9 b4 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c64:	6a 00                	push   $0x0
  pushl $89
80105c66:	6a 59                	push   $0x59
  jmp alltraps
80105c68:	e9 ab f8 ff ff       	jmp    80105518 <alltraps>
...
80105c6d:	6a 00                	push   $0x0
  pushl $90
80105c6f:	6a 5a                	push   $0x5a
  jmp alltraps
80105c71:	e9 a2 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c76:	6a 00                	push   $0x0
  pushl $91
80105c78:	6a 5b                	push   $0x5b
  jmp alltraps
80105c7a:	e9 99 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c7f:	6a 00                	push   $0x0
  pushl $92
80105c81:	6a 5c                	push   $0x5c
  jmp alltraps
80105c83:	e9 90 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c88:	6a 00                	push   $0x0
  pushl $93
80105c8a:	6a 5d                	push   $0x5d
  jmp alltraps
80105c8c:	e9 87 f8 ff ff       	jmp    80105518 <alltraps>
...
80105c91:	6a 00                	push   $0x0
  pushl $94
80105c93:	6a 5e                	push   $0x5e
  jmp alltraps
80105c95:	e9 7e f8 ff ff       	jmp    80105518 <alltraps>
...
80105c9a:	6a 00                	push   $0x0
  pushl $95
80105c9c:	6a 5f                	push   $0x5f
  jmp alltraps
80105c9e:	e9 75 f8 ff ff       	jmp    80105518 <alltraps>
...
80105ca3:	6a 00                	push   $0x0
  pushl $96
80105ca5:	6a 60                	push   $0x60
  jmp alltraps
80105ca7:	e9 6c f8 ff ff       	jmp    80105518 <alltraps>
...
80105cac:	6a 00                	push   $0x0
  pushl $97
80105cae:	6a 61                	push   $0x61
  jmp alltraps
80105cb0:	e9 63 f8 ff ff       	jmp    80105518 <alltraps>
...
80105cb5:	6a 00                	push   $0x0
  pushl $98
80105cb7:	6a 62                	push   $0x62
  jmp alltraps
80105cb9:	e9 5a f8 ff ff       	jmp    80105518 <alltraps>
...
80105cbe:	6a 00                	push   $0x0
  pushl $99
80105cc0:	6a 63                	push   $0x63
  jmp alltraps
80105cc2:	e9 51 f8 ff ff       	jmp    80105518 <alltraps>
...
80105cc7:	6a 00                	push   $0x0
  pushl $100
80105cc9:	6a 64                	push   $0x64
  jmp alltraps
80105ccb:	e9 48 f8 ff ff       	jmp    80105518 <alltraps>
...
80105cd0:	6a 00                	push   $0x0
  pushl $101
80105cd2:	6a 65                	push   $0x65
  jmp alltraps
80105cd4:	e9 3f f8 ff ff       	jmp    80105518 <alltraps>
...
80105cd9:	6a 00                	push   $0x0
  pushl $102
80105cdb:	6a 66                	push   $0x66
  jmp alltraps
80105cdd:	e9 36 f8 ff ff       	jmp    80105518 <alltraps>
...
80105ce2:	6a 00                	push   $0x0
  pushl $103
80105ce4:	6a 67                	push   $0x67
  jmp alltraps
80105ce6:	e9 2d f8 ff ff       	jmp    80105518 <alltraps>
...
80105ceb:	6a 00                	push   $0x0
  pushl $104
80105ced:	6a 68                	push   $0x68
  jmp alltraps
80105cef:	e9 24 f8 ff ff       	jmp    80105518 <alltraps>
...
80105cf4:	6a 00                	push   $0x0
  pushl $105
80105cf6:	6a 69                	push   $0x69
  jmp alltraps
80105cf8:	e9 1b f8 ff ff       	jmp    80105518 <alltraps>
...
80105cfd:	6a 00                	push   $0x0
  pushl $106
80105cff:	6a 6a                	push   $0x6a
  jmp alltraps
80105d01:	e9 12 f8 ff ff       	jmp    80105518 <alltraps>
...
80105d06:	6a 00                	push   $0x0
  pushl $107
80105d08:	6a 6b                	push   $0x6b
  jmp alltraps
80105d0a:	e9 09 f8 ff ff       	jmp    80105518 <alltraps>
...
80105d0f:	6a 00                	push   $0x0
  pushl $108
80105d11:	6a 6c                	push   $0x6c
  jmp alltraps
80105d13:	e9 00 f8 ff ff       	jmp    80105518 <alltraps>
...
80105d18:	6a 00                	push   $0x0
  pushl $109
80105d1a:	6a 6d                	push   $0x6d
  jmp alltraps
80105d1c:	e9 f7 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d21:	6a 00                	push   $0x0
  pushl $110
80105d23:	6a 6e                	push   $0x6e
  jmp alltraps
80105d25:	e9 ee f7 ff ff       	jmp    80105518 <alltraps>
...
80105d2a:	6a 00                	push   $0x0
  pushl $111
80105d2c:	6a 6f                	push   $0x6f
  jmp alltraps
80105d2e:	e9 e5 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d33:	6a 00                	push   $0x0
  pushl $112
80105d35:	6a 70                	push   $0x70
  jmp alltraps
80105d37:	e9 dc f7 ff ff       	jmp    80105518 <alltraps>
...
80105d3c:	6a 00                	push   $0x0
  pushl $113
80105d3e:	6a 71                	push   $0x71
  jmp alltraps
80105d40:	e9 d3 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d45:	6a 00                	push   $0x0
  pushl $114
80105d47:	6a 72                	push   $0x72
  jmp alltraps
80105d49:	e9 ca f7 ff ff       	jmp    80105518 <alltraps>
...
80105d4e:	6a 00                	push   $0x0
  pushl $115
80105d50:	6a 73                	push   $0x73
  jmp alltraps
80105d52:	e9 c1 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d57:	6a 00                	push   $0x0
  pushl $116
80105d59:	6a 74                	push   $0x74
  jmp alltraps
80105d5b:	e9 b8 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d60:	6a 00                	push   $0x0
  pushl $117
80105d62:	6a 75                	push   $0x75
  jmp alltraps
80105d64:	e9 af f7 ff ff       	jmp    80105518 <alltraps>
...
80105d69:	6a 00                	push   $0x0
  pushl $118
80105d6b:	6a 76                	push   $0x76
  jmp alltraps
80105d6d:	e9 a6 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d72:	6a 00                	push   $0x0
  pushl $119
80105d74:	6a 77                	push   $0x77
  jmp alltraps
80105d76:	e9 9d f7 ff ff       	jmp    80105518 <alltraps>
...
80105d7b:	6a 00                	push   $0x0
  pushl $120
80105d7d:	6a 78                	push   $0x78
  jmp alltraps
80105d7f:	e9 94 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d84:	6a 00                	push   $0x0
  pushl $121
80105d86:	6a 79                	push   $0x79
  jmp alltraps
80105d88:	e9 8b f7 ff ff       	jmp    80105518 <alltraps>
...
80105d8d:	6a 00                	push   $0x0
  pushl $122
80105d8f:	6a 7a                	push   $0x7a
  jmp alltraps
80105d91:	e9 82 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d96:	6a 00                	push   $0x0
  pushl $123
80105d98:	6a 7b                	push   $0x7b
  jmp alltraps
80105d9a:	e9 79 f7 ff ff       	jmp    80105518 <alltraps>
...
80105d9f:	6a 00                	push   $0x0
  pushl $124
80105da1:	6a 7c                	push   $0x7c
  jmp alltraps
80105da3:	e9 70 f7 ff ff       	jmp    80105518 <alltraps>
...
80105da8:	6a 00                	push   $0x0
  pushl $125
80105daa:	6a 7d                	push   $0x7d
  jmp alltraps
80105dac:	e9 67 f7 ff ff       	jmp    80105518 <alltraps>
...
80105db1:	6a 00                	push   $0x0
  pushl $126
80105db3:	6a 7e                	push   $0x7e
  jmp alltraps
80105db5:	e9 5e f7 ff ff       	jmp    80105518 <alltraps>
...
80105dba:	6a 00                	push   $0x0
  pushl $127
80105dbc:	6a 7f                	push   $0x7f
  jmp alltraps
80105dbe:	e9 55 f7 ff ff       	jmp    80105518 <alltraps>
...
80105dc3:	6a 00                	push   $0x0
  pushl $128
80105dc5:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105dca:	e9 49 f7 ff ff       	jmp    80105518 <alltraps>
...
80105dcf:	6a 00                	push   $0x0
  pushl $129
80105dd1:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105dd6:	e9 3d f7 ff ff       	jmp    80105518 <alltraps>
...
80105ddb:	6a 00                	push   $0x0
  pushl $130
80105ddd:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105de2:	e9 31 f7 ff ff       	jmp    80105518 <alltraps>
...
80105de7:	6a 00                	push   $0x0
  pushl $131
80105de9:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105dee:	e9 25 f7 ff ff       	jmp    80105518 <alltraps>
...
80105df3:	6a 00                	push   $0x0
  pushl $132
80105df5:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105dfa:	e9 19 f7 ff ff       	jmp    80105518 <alltraps>
...
80105dff:	6a 00                	push   $0x0
  pushl $133
80105e01:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105e06:	e9 0d f7 ff ff       	jmp    80105518 <alltraps>
...
80105e0b:	6a 00                	push   $0x0
  pushl $134
80105e0d:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105e12:	e9 01 f7 ff ff       	jmp    80105518 <alltraps>
...
80105e17:	6a 00                	push   $0x0
  pushl $135
80105e19:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e1e:	e9 f5 f6 ff ff       	jmp    80105518 <alltraps>
...
80105e23:	6a 00                	push   $0x0
  pushl $136
80105e25:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e2a:	e9 e9 f6 ff ff       	jmp    80105518 <alltraps>
...
80105e2f:	6a 00                	push   $0x0
  pushl $137
80105e31:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e36:	e9 dd f6 ff ff       	jmp    80105518 <alltraps>
...
80105e3b:	6a 00                	push   $0x0
  pushl $138
80105e3d:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e42:	e9 d1 f6 ff ff       	jmp    80105518 <alltraps>
...
80105e47:	6a 00                	push   $0x0
  pushl $139
80105e49:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105e4e:	e9 c5 f6 ff ff       	jmp    80105518 <alltraps>
...
80105e53:	6a 00                	push   $0x0
  pushl $140
80105e55:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105e5a:	e9 b9 f6 ff ff       	jmp    80105518 <alltraps>
...
80105e5f:	6a 00                	push   $0x0
  pushl $141
80105e61:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105e66:	e9 ad f6 ff ff       	jmp    80105518 <alltraps>
...
80105e6b:	6a 00                	push   $0x0
  pushl $142
80105e6d:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105e72:	e9 a1 f6 ff ff       	jmp    80105518 <alltraps>
...
80105e77:	6a 00                	push   $0x0
  pushl $143
80105e79:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105e7e:	e9 95 f6 ff ff       	jmp    80105518 <alltraps>
...
80105e83:	6a 00                	push   $0x0
  pushl $144
80105e85:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105e8a:	e9 89 f6 ff ff       	jmp    80105518 <alltraps>
...
80105e8f:	6a 00                	push   $0x0
  pushl $145
80105e91:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105e96:	e9 7d f6 ff ff       	jmp    80105518 <alltraps>
...
80105e9b:	6a 00                	push   $0x0
  pushl $146
80105e9d:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105ea2:	e9 71 f6 ff ff       	jmp    80105518 <alltraps>
...
80105ea7:	6a 00                	push   $0x0
  pushl $147
80105ea9:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105eae:	e9 65 f6 ff ff       	jmp    80105518 <alltraps>
...
80105eb3:	6a 00                	push   $0x0
  pushl $148
80105eb5:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105eba:	e9 59 f6 ff ff       	jmp    80105518 <alltraps>
...
80105ebf:	6a 00                	push   $0x0
  pushl $149
80105ec1:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105ec6:	e9 4d f6 ff ff       	jmp    80105518 <alltraps>
...
80105ecb:	6a 00                	push   $0x0
  pushl $150
80105ecd:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105ed2:	e9 41 f6 ff ff       	jmp    80105518 <alltraps>
...
80105ed7:	6a 00                	push   $0x0
  pushl $151
80105ed9:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105ede:	e9 35 f6 ff ff       	jmp    80105518 <alltraps>
...
80105ee3:	6a 00                	push   $0x0
  pushl $152
80105ee5:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105eea:	e9 29 f6 ff ff       	jmp    80105518 <alltraps>
...
80105eef:	6a 00                	push   $0x0
  pushl $153
80105ef1:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105ef6:	e9 1d f6 ff ff       	jmp    80105518 <alltraps>
...
80105efb:	6a 00                	push   $0x0
  pushl $154
80105efd:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105f02:	e9 11 f6 ff ff       	jmp    80105518 <alltraps>
...
80105f07:	6a 00                	push   $0x0
  pushl $155
80105f09:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105f0e:	e9 05 f6 ff ff       	jmp    80105518 <alltraps>
...
80105f13:	6a 00                	push   $0x0
  pushl $156
80105f15:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105f1a:	e9 f9 f5 ff ff       	jmp    80105518 <alltraps>
...
80105f1f:	6a 00                	push   $0x0
  pushl $157
80105f21:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f26:	e9 ed f5 ff ff       	jmp    80105518 <alltraps>
...
80105f2b:	6a 00                	push   $0x0
  pushl $158
80105f2d:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f32:	e9 e1 f5 ff ff       	jmp    80105518 <alltraps>
...
80105f37:	6a 00                	push   $0x0
  pushl $159
80105f39:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f3e:	e9 d5 f5 ff ff       	jmp    80105518 <alltraps>
...
80105f43:	6a 00                	push   $0x0
  pushl $160
80105f45:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f4a:	e9 c9 f5 ff ff       	jmp    80105518 <alltraps>
...
80105f4f:	6a 00                	push   $0x0
  pushl $161
80105f51:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105f56:	e9 bd f5 ff ff       	jmp    80105518 <alltraps>
...
80105f5b:	6a 00                	push   $0x0
  pushl $162
80105f5d:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105f62:	e9 b1 f5 ff ff       	jmp    80105518 <alltraps>
...
80105f67:	6a 00                	push   $0x0
  pushl $163
80105f69:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105f6e:	e9 a5 f5 ff ff       	jmp    80105518 <alltraps>
...
80105f73:	6a 00                	push   $0x0
  pushl $164
80105f75:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105f7a:	e9 99 f5 ff ff       	jmp    80105518 <alltraps>
...
80105f7f:	6a 00                	push   $0x0
  pushl $165
80105f81:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105f86:	e9 8d f5 ff ff       	jmp    80105518 <alltraps>
...
80105f8b:	6a 00                	push   $0x0
  pushl $166
80105f8d:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105f92:	e9 81 f5 ff ff       	jmp    80105518 <alltraps>
...
80105f97:	6a 00                	push   $0x0
  pushl $167
80105f99:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105f9e:	e9 75 f5 ff ff       	jmp    80105518 <alltraps>
...
80105fa3:	6a 00                	push   $0x0
  pushl $168
80105fa5:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105faa:	e9 69 f5 ff ff       	jmp    80105518 <alltraps>
...
80105faf:	6a 00                	push   $0x0
  pushl $169
80105fb1:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105fb6:	e9 5d f5 ff ff       	jmp    80105518 <alltraps>
...
80105fbb:	6a 00                	push   $0x0
  pushl $170
80105fbd:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105fc2:	e9 51 f5 ff ff       	jmp    80105518 <alltraps>
...
80105fc7:	6a 00                	push   $0x0
  pushl $171
80105fc9:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105fce:	e9 45 f5 ff ff       	jmp    80105518 <alltraps>
...
80105fd3:	6a 00                	push   $0x0
  pushl $172
80105fd5:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105fda:	e9 39 f5 ff ff       	jmp    80105518 <alltraps>
...
80105fdf:	6a 00                	push   $0x0
  pushl $173
80105fe1:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105fe6:	e9 2d f5 ff ff       	jmp    80105518 <alltraps>
...
80105feb:	6a 00                	push   $0x0
  pushl $174
80105fed:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105ff2:	e9 21 f5 ff ff       	jmp    80105518 <alltraps>
...
80105ff7:	6a 00                	push   $0x0
  pushl $175
80105ff9:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105ffe:	e9 15 f5 ff ff       	jmp    80105518 <alltraps>
...
80106003:	6a 00                	push   $0x0
  pushl $176
80106005:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010600a:	e9 09 f5 ff ff       	jmp    80105518 <alltraps>
...
8010600f:	6a 00                	push   $0x0
  pushl $177
80106011:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106016:	e9 fd f4 ff ff       	jmp    80105518 <alltraps>
...
8010601b:	6a 00                	push   $0x0
  pushl $178
8010601d:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106022:	e9 f1 f4 ff ff       	jmp    80105518 <alltraps>
...
80106027:	6a 00                	push   $0x0
  pushl $179
80106029:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010602e:	e9 e5 f4 ff ff       	jmp    80105518 <alltraps>
...
80106033:	6a 00                	push   $0x0
  pushl $180
80106035:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010603a:	e9 d9 f4 ff ff       	jmp    80105518 <alltraps>
...
8010603f:	6a 00                	push   $0x0
  pushl $181
80106041:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106046:	e9 cd f4 ff ff       	jmp    80105518 <alltraps>
...
8010604b:	6a 00                	push   $0x0
  pushl $182
8010604d:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106052:	e9 c1 f4 ff ff       	jmp    80105518 <alltraps>
...
80106057:	6a 00                	push   $0x0
  pushl $183
80106059:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010605e:	e9 b5 f4 ff ff       	jmp    80105518 <alltraps>
...
80106063:	6a 00                	push   $0x0
  pushl $184
80106065:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010606a:	e9 a9 f4 ff ff       	jmp    80105518 <alltraps>
...
8010606f:	6a 00                	push   $0x0
  pushl $185
80106071:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106076:	e9 9d f4 ff ff       	jmp    80105518 <alltraps>
...
8010607b:	6a 00                	push   $0x0
  pushl $186
8010607d:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106082:	e9 91 f4 ff ff       	jmp    80105518 <alltraps>
...
80106087:	6a 00                	push   $0x0
  pushl $187
80106089:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010608e:	e9 85 f4 ff ff       	jmp    80105518 <alltraps>
...
80106093:	6a 00                	push   $0x0
  pushl $188
80106095:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010609a:	e9 79 f4 ff ff       	jmp    80105518 <alltraps>
...
8010609f:	6a 00                	push   $0x0
  pushl $189
801060a1:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801060a6:	e9 6d f4 ff ff       	jmp    80105518 <alltraps>
...
801060ab:	6a 00                	push   $0x0
  pushl $190
801060ad:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801060b2:	e9 61 f4 ff ff       	jmp    80105518 <alltraps>
...
801060b7:	6a 00                	push   $0x0
  pushl $191
801060b9:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801060be:	e9 55 f4 ff ff       	jmp    80105518 <alltraps>
...
801060c3:	6a 00                	push   $0x0
  pushl $192
801060c5:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801060ca:	e9 49 f4 ff ff       	jmp    80105518 <alltraps>
...
801060cf:	6a 00                	push   $0x0
  pushl $193
801060d1:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801060d6:	e9 3d f4 ff ff       	jmp    80105518 <alltraps>
...
801060db:	6a 00                	push   $0x0
  pushl $194
801060dd:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801060e2:	e9 31 f4 ff ff       	jmp    80105518 <alltraps>
...
801060e7:	6a 00                	push   $0x0
  pushl $195
801060e9:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801060ee:	e9 25 f4 ff ff       	jmp    80105518 <alltraps>
...
801060f3:	6a 00                	push   $0x0
  pushl $196
801060f5:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801060fa:	e9 19 f4 ff ff       	jmp    80105518 <alltraps>
...
801060ff:	6a 00                	push   $0x0
  pushl $197
80106101:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106106:	e9 0d f4 ff ff       	jmp    80105518 <alltraps>
...
8010610b:	6a 00                	push   $0x0
  pushl $198
8010610d:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106112:	e9 01 f4 ff ff       	jmp    80105518 <alltraps>
...
80106117:	6a 00                	push   $0x0
  pushl $199
80106119:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010611e:	e9 f5 f3 ff ff       	jmp    80105518 <alltraps>
...
80106123:	6a 00                	push   $0x0
  pushl $200
80106125:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010612a:	e9 e9 f3 ff ff       	jmp    80105518 <alltraps>
...
8010612f:	6a 00                	push   $0x0
  pushl $201
80106131:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106136:	e9 dd f3 ff ff       	jmp    80105518 <alltraps>
...
8010613b:	6a 00                	push   $0x0
  pushl $202
8010613d:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106142:	e9 d1 f3 ff ff       	jmp    80105518 <alltraps>
...
80106147:	6a 00                	push   $0x0
  pushl $203
80106149:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010614e:	e9 c5 f3 ff ff       	jmp    80105518 <alltraps>
...
80106153:	6a 00                	push   $0x0
  pushl $204
80106155:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010615a:	e9 b9 f3 ff ff       	jmp    80105518 <alltraps>
...
8010615f:	6a 00                	push   $0x0
  pushl $205
80106161:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106166:	e9 ad f3 ff ff       	jmp    80105518 <alltraps>
...
8010616b:	6a 00                	push   $0x0
  pushl $206
8010616d:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106172:	e9 a1 f3 ff ff       	jmp    80105518 <alltraps>
...
80106177:	6a 00                	push   $0x0
  pushl $207
80106179:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010617e:	e9 95 f3 ff ff       	jmp    80105518 <alltraps>
...
80106183:	6a 00                	push   $0x0
  pushl $208
80106185:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010618a:	e9 89 f3 ff ff       	jmp    80105518 <alltraps>
...
8010618f:	6a 00                	push   $0x0
  pushl $209
80106191:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106196:	e9 7d f3 ff ff       	jmp    80105518 <alltraps>
...
8010619b:	6a 00                	push   $0x0
  pushl $210
8010619d:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801061a2:	e9 71 f3 ff ff       	jmp    80105518 <alltraps>
...
801061a7:	6a 00                	push   $0x0
  pushl $211
801061a9:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801061ae:	e9 65 f3 ff ff       	jmp    80105518 <alltraps>
...
801061b3:	6a 00                	push   $0x0
  pushl $212
801061b5:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801061ba:	e9 59 f3 ff ff       	jmp    80105518 <alltraps>
...
801061bf:	6a 00                	push   $0x0
  pushl $213
801061c1:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801061c6:	e9 4d f3 ff ff       	jmp    80105518 <alltraps>
...
801061cb:	6a 00                	push   $0x0
  pushl $214
801061cd:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801061d2:	e9 41 f3 ff ff       	jmp    80105518 <alltraps>
...
801061d7:	6a 00                	push   $0x0
  pushl $215
801061d9:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801061de:	e9 35 f3 ff ff       	jmp    80105518 <alltraps>
...
801061e3:	6a 00                	push   $0x0
  pushl $216
801061e5:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801061ea:	e9 29 f3 ff ff       	jmp    80105518 <alltraps>
...
801061ef:	6a 00                	push   $0x0
  pushl $217
801061f1:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801061f6:	e9 1d f3 ff ff       	jmp    80105518 <alltraps>
...
801061fb:	6a 00                	push   $0x0
  pushl $218
801061fd:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106202:	e9 11 f3 ff ff       	jmp    80105518 <alltraps>
...
80106207:	6a 00                	push   $0x0
  pushl $219
80106209:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010620e:	e9 05 f3 ff ff       	jmp    80105518 <alltraps>
...
80106213:	6a 00                	push   $0x0
  pushl $220
80106215:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010621a:	e9 f9 f2 ff ff       	jmp    80105518 <alltraps>
...
8010621f:	6a 00                	push   $0x0
  pushl $221
80106221:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106226:	e9 ed f2 ff ff       	jmp    80105518 <alltraps>
...
8010622b:	6a 00                	push   $0x0
  pushl $222
8010622d:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106232:	e9 e1 f2 ff ff       	jmp    80105518 <alltraps>
...
80106237:	6a 00                	push   $0x0
  pushl $223
80106239:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010623e:	e9 d5 f2 ff ff       	jmp    80105518 <alltraps>
...
80106243:	6a 00                	push   $0x0
  pushl $224
80106245:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010624a:	e9 c9 f2 ff ff       	jmp    80105518 <alltraps>
...
8010624f:	6a 00                	push   $0x0
  pushl $225
80106251:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106256:	e9 bd f2 ff ff       	jmp    80105518 <alltraps>
...
8010625b:	6a 00                	push   $0x0
  pushl $226
8010625d:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106262:	e9 b1 f2 ff ff       	jmp    80105518 <alltraps>
...
80106267:	6a 00                	push   $0x0
  pushl $227
80106269:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010626e:	e9 a5 f2 ff ff       	jmp    80105518 <alltraps>
...
80106273:	6a 00                	push   $0x0
  pushl $228
80106275:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010627a:	e9 99 f2 ff ff       	jmp    80105518 <alltraps>
...
8010627f:	6a 00                	push   $0x0
  pushl $229
80106281:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106286:	e9 8d f2 ff ff       	jmp    80105518 <alltraps>
...
8010628b:	6a 00                	push   $0x0
  pushl $230
8010628d:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106292:	e9 81 f2 ff ff       	jmp    80105518 <alltraps>
...
80106297:	6a 00                	push   $0x0
  pushl $231
80106299:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
8010629e:	e9 75 f2 ff ff       	jmp    80105518 <alltraps>
...
801062a3:	6a 00                	push   $0x0
  pushl $232
801062a5:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801062aa:	e9 69 f2 ff ff       	jmp    80105518 <alltraps>
...
801062af:	6a 00                	push   $0x0
  pushl $233
801062b1:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801062b6:	e9 5d f2 ff ff       	jmp    80105518 <alltraps>
...
801062bb:	6a 00                	push   $0x0
  pushl $234
801062bd:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801062c2:	e9 51 f2 ff ff       	jmp    80105518 <alltraps>
...
801062c7:	6a 00                	push   $0x0
  pushl $235
801062c9:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801062ce:	e9 45 f2 ff ff       	jmp    80105518 <alltraps>
...
801062d3:	6a 00                	push   $0x0
  pushl $236
801062d5:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801062da:	e9 39 f2 ff ff       	jmp    80105518 <alltraps>
...
801062df:	6a 00                	push   $0x0
  pushl $237
801062e1:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801062e6:	e9 2d f2 ff ff       	jmp    80105518 <alltraps>
...
801062eb:	6a 00                	push   $0x0
  pushl $238
801062ed:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801062f2:	e9 21 f2 ff ff       	jmp    80105518 <alltraps>
...
801062f7:	6a 00                	push   $0x0
  pushl $239
801062f9:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801062fe:	e9 15 f2 ff ff       	jmp    80105518 <alltraps>
...
80106303:	6a 00                	push   $0x0
  pushl $240
80106305:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010630a:	e9 09 f2 ff ff       	jmp    80105518 <alltraps>
...
8010630f:	6a 00                	push   $0x0
  pushl $241
80106311:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106316:	e9 fd f1 ff ff       	jmp    80105518 <alltraps>
...
8010631b:	6a 00                	push   $0x0
  pushl $242
8010631d:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106322:	e9 f1 f1 ff ff       	jmp    80105518 <alltraps>
...
80106327:	6a 00                	push   $0x0
  pushl $243
80106329:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010632e:	e9 e5 f1 ff ff       	jmp    80105518 <alltraps>
...
80106333:	6a 00                	push   $0x0
  pushl $244
80106335:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010633a:	e9 d9 f1 ff ff       	jmp    80105518 <alltraps>
...
8010633f:	6a 00                	push   $0x0
  pushl $245
80106341:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106346:	e9 cd f1 ff ff       	jmp    80105518 <alltraps>
...
8010634b:	6a 00                	push   $0x0
  pushl $246
8010634d:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106352:	e9 c1 f1 ff ff       	jmp    80105518 <alltraps>
...
80106357:	6a 00                	push   $0x0
  pushl $247
80106359:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010635e:	e9 b5 f1 ff ff       	jmp    80105518 <alltraps>
...
80106363:	6a 00                	push   $0x0
  pushl $248
80106365:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010636a:	e9 a9 f1 ff ff       	jmp    80105518 <alltraps>
...
8010636f:	6a 00                	push   $0x0
  pushl $249
80106371:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106376:	e9 9d f1 ff ff       	jmp    80105518 <alltraps>
...
8010637b:	6a 00                	push   $0x0
  pushl $250
8010637d:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106382:	e9 91 f1 ff ff       	jmp    80105518 <alltraps>
...
80106387:	6a 00                	push   $0x0
  pushl $251
80106389:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010638e:	e9 85 f1 ff ff       	jmp    80105518 <alltraps>
...
80106393:	6a 00                	push   $0x0
  pushl $252
80106395:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010639a:	e9 79 f1 ff ff       	jmp    80105518 <alltraps>
...
8010639f:	6a 00                	push   $0x0
  pushl $253
801063a1:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801063a6:	e9 6d f1 ff ff       	jmp    80105518 <alltraps>
...
801063ab:	6a 00                	push   $0x0
  pushl $254
801063ad:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801063b2:	e9 61 f1 ff ff       	jmp    80105518 <alltraps>
...
801063b7:	6a 00                	push   $0x0
  pushl $255
801063b9:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801063be:	e9 55 f1 ff ff       	jmp    80105518 <alltraps>
...
801063cc:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801063ce:	c1 ea 16             	shr    $0x16,%edx
801063d1:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
801063d4:	8b 1f                	mov    (%edi),%ebx
801063d6:	f6 c3 01             	test   $0x1,%bl
801063d9:	74 22                	je     801063fd <walkpgdir+0x3a>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801063db:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
801063e1:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
801063e7:	c1 ee 0c             	shr    $0xc,%esi
801063ea:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
801063f0:	8d 1c b3             	lea    (%ebx,%esi,4),%ebx
}
...
801063fd:	85 c9                	test   %ecx,%ecx
801063ff:	74 2b                	je     8010642c <walkpgdir+0x69>
80106401:	e8 b5 bc ff ff       	call   801020bb <kalloc>
80106406:	89 c3                	mov    %eax,%ebx
80106408:	85 c0                	test   %eax,%eax
8010640a:	74 e7                	je     801063f3 <walkpgdir+0x30>
    memset(pgtab, 0, PGSIZE);
8010640c:	83 ec 04             	sub    $0x4,%esp
8010640f:	68 00 10 00 00       	push   $0x1000
80106414:	6a 00                	push   $0x0
80106416:	50                   	push   %eax
80106417:	e8 8f df ff ff       	call   801043ab <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010641c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106422:	83 c8 07             	or     $0x7,%eax
80106425:	89 07                	mov    %eax,(%edi)
80106427:	83 c4 10             	add    $0x10,%esp
8010642a:	eb bb                	jmp    801063e7 <walkpgdir+0x24>
      return 0;
8010642c:	bb 00 00 00 00       	mov    $0x0,%ebx
80106431:	eb c0                	jmp    801063f3 <walkpgdir+0x30>
...
80106439:	83 ec 1c             	sub    $0x1c,%esp
8010643c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010643f:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80106442:	89 d3                	mov    %edx,%ebx
80106444:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010644a:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
8010644e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106454:	b9 01 00 00 00       	mov    $0x1,%ecx
80106459:	89 da                	mov    %ebx,%edx
8010645b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010645e:	e8 60 ff ff ff       	call   801063c3 <walkpgdir>
80106463:	85 c0                	test   %eax,%eax
80106465:	74 2e                	je     80106495 <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80106467:	f6 00 01             	testb  $0x1,(%eax)
8010646a:	75 1c                	jne    80106488 <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
8010646c:	89 f2                	mov    %esi,%edx
8010646e:	0b 55 0c             	or     0xc(%ebp),%edx
80106471:	83 ca 01             	or     $0x1,%edx
80106474:	89 10                	mov    %edx,(%eax)
    if(a == last)
80106476:	39 fb                	cmp    %edi,%ebx
80106478:	74 28                	je     801064a2 <mappages+0x6f>
      break;
    a += PGSIZE;
8010647a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80106480:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106486:	eb cc                	jmp    80106454 <mappages+0x21>
      panic("remap");
80106488:	83 ec 0c             	sub    $0xc,%esp
8010648b:	68 78 75 10 80       	push   $0x80107578
80106490:	e8 b3 9e ff ff       	call   80100348 <panic>
      return -1;
...
801064a7:	eb f1                	jmp    8010649a <mappages+0x67>
...
801064ad:	83 ec 14             	sub    $0x14,%esp
  c = &cpus[cpuid()];
801064b0:	e8 89 ce ff ff       	call   8010333e <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801064b5:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801064bb:	66 c7 80 f8 27 11 80 	movw   $0xffff,-0x7feed808(%eax)
801064c2:	ff ff 
801064c4:	66 c7 80 fa 27 11 80 	movw   $0x0,-0x7feed806(%eax)
801064cb:	00 00 
801064cd:	c6 80 fc 27 11 80 00 	movb   $0x0,-0x7feed804(%eax)
801064d4:	0f b6 88 fd 27 11 80 	movzbl -0x7feed803(%eax),%ecx
801064db:	83 e1 f0             	and    $0xfffffff0,%ecx
801064de:	83 c9 1a             	or     $0x1a,%ecx
801064e1:	83 e1 9f             	and    $0xffffff9f,%ecx
801064e4:	83 c9 80             	or     $0xffffff80,%ecx
801064e7:	88 88 fd 27 11 80    	mov    %cl,-0x7feed803(%eax)
801064ed:	0f b6 88 fe 27 11 80 	movzbl -0x7feed802(%eax),%ecx
801064f4:	83 c9 0f             	or     $0xf,%ecx
801064f7:	83 e1 cf             	and    $0xffffffcf,%ecx
801064fa:	83 c9 c0             	or     $0xffffffc0,%ecx
801064fd:	88 88 fe 27 11 80    	mov    %cl,-0x7feed802(%eax)
80106503:	c6 80 ff 27 11 80 00 	movb   $0x0,-0x7feed801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010650a:	66 c7 80 00 28 11 80 	movw   $0xffff,-0x7feed800(%eax)
80106511:	ff ff 
80106513:	66 c7 80 02 28 11 80 	movw   $0x0,-0x7feed7fe(%eax)
8010651a:	00 00 
8010651c:	c6 80 04 28 11 80 00 	movb   $0x0,-0x7feed7fc(%eax)
80106523:	0f b6 88 05 28 11 80 	movzbl -0x7feed7fb(%eax),%ecx
8010652a:	83 e1 f0             	and    $0xfffffff0,%ecx
8010652d:	83 c9 12             	or     $0x12,%ecx
80106530:	83 e1 9f             	and    $0xffffff9f,%ecx
80106533:	83 c9 80             	or     $0xffffff80,%ecx
80106536:	88 88 05 28 11 80    	mov    %cl,-0x7feed7fb(%eax)
8010653c:	0f b6 88 06 28 11 80 	movzbl -0x7feed7fa(%eax),%ecx
80106543:	83 c9 0f             	or     $0xf,%ecx
80106546:	83 e1 cf             	and    $0xffffffcf,%ecx
80106549:	83 c9 c0             	or     $0xffffffc0,%ecx
8010654c:	88 88 06 28 11 80    	mov    %cl,-0x7feed7fa(%eax)
80106552:	c6 80 07 28 11 80 00 	movb   $0x0,-0x7feed7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106559:	66 c7 80 08 28 11 80 	movw   $0xffff,-0x7feed7f8(%eax)
80106560:	ff ff 
80106562:	66 c7 80 0a 28 11 80 	movw   $0x0,-0x7feed7f6(%eax)
80106569:	00 00 
8010656b:	c6 80 0c 28 11 80 00 	movb   $0x0,-0x7feed7f4(%eax)
80106572:	c6 80 0d 28 11 80 fa 	movb   $0xfa,-0x7feed7f3(%eax)
80106579:	0f b6 88 0e 28 11 80 	movzbl -0x7feed7f2(%eax),%ecx
80106580:	83 c9 0f             	or     $0xf,%ecx
80106583:	83 e1 cf             	and    $0xffffffcf,%ecx
80106586:	83 c9 c0             	or     $0xffffffc0,%ecx
80106589:	88 88 0e 28 11 80    	mov    %cl,-0x7feed7f2(%eax)
8010658f:	c6 80 0f 28 11 80 00 	movb   $0x0,-0x7feed7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106596:	66 c7 80 10 28 11 80 	movw   $0xffff,-0x7feed7f0(%eax)
8010659d:	ff ff 
8010659f:	66 c7 80 12 28 11 80 	movw   $0x0,-0x7feed7ee(%eax)
801065a6:	00 00 
801065a8:	c6 80 14 28 11 80 00 	movb   $0x0,-0x7feed7ec(%eax)
801065af:	c6 80 15 28 11 80 f2 	movb   $0xf2,-0x7feed7eb(%eax)
801065b6:	0f b6 88 16 28 11 80 	movzbl -0x7feed7ea(%eax),%ecx
801065bd:	83 c9 0f             	or     $0xf,%ecx
801065c0:	83 e1 cf             	and    $0xffffffcf,%ecx
801065c3:	83 c9 c0             	or     $0xffffffc0,%ecx
801065c6:	88 88 16 28 11 80    	mov    %cl,-0x7feed7ea(%eax)
801065cc:	c6 80 17 28 11 80 00 	movb   $0x0,-0x7feed7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
801065d3:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[0] = size-1;
801065d8:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
...
801065ef:	83 c4 14             	add    $0x14,%esp
801065f2:	5b                   	pop    %ebx
801065f3:	5d                   	pop    %ebp
801065f4:	c3                   	ret    
...
801065f8:	a1 c4 71 11 80       	mov    0x801171c4,%eax
...
8010660d:	83 ec 1c             	sub    $0x1c,%esp
80106610:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80106613:	85 f6                	test   %esi,%esi
80106615:	0f 84 dd 00 00 00    	je     801066f8 <switchuvm+0xf1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
8010661b:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
8010661f:	0f 84 e0 00 00 00    	je     80106705 <switchuvm+0xfe>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106625:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80106629:	0f 84 e3 00 00 00    	je     80106712 <switchuvm+0x10b>
    panic("switchuvm: no pgdir");

  pushcli();
8010662f:	e8 ee db ff ff       	call   80104222 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106634:	e8 a9 cc ff ff       	call   801032e2 <mycpu>
80106639:	89 c3                	mov    %eax,%ebx
8010663b:	e8 a2 cc ff ff       	call   801032e2 <mycpu>
80106640:	8d 78 08             	lea    0x8(%eax),%edi
80106643:	e8 9a cc ff ff       	call   801032e2 <mycpu>
80106648:	83 c0 08             	add    $0x8,%eax
8010664b:	c1 e8 10             	shr    $0x10,%eax
8010664e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106651:	e8 8c cc ff ff       	call   801032e2 <mycpu>
80106656:	83 c0 08             	add    $0x8,%eax
80106659:	c1 e8 18             	shr    $0x18,%eax
8010665c:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80106663:	67 00 
80106665:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
8010666c:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
80106670:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106676:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
8010667d:	83 e2 f0             	and    $0xfffffff0,%edx
80106680:	83 ca 19             	or     $0x19,%edx
80106683:	83 e2 9f             	and    $0xffffff9f,%edx
80106686:	83 ca 80             	or     $0xffffff80,%edx
80106689:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
8010668f:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106696:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010669c:	e8 41 cc ff ff       	call   801032e2 <mycpu>
801066a1:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801066a8:	83 e2 ef             	and    $0xffffffef,%edx
801066ab:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801066b1:	e8 2c cc ff ff       	call   801032e2 <mycpu>
801066b6:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801066bc:	8b 5e 08             	mov    0x8(%esi),%ebx
801066bf:	e8 1e cc ff ff       	call   801032e2 <mycpu>
801066c4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801066ca:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801066cd:	e8 10 cc ff ff       	call   801032e2 <mycpu>
801066d2:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
801066d8:	b8 28 00 00 00       	mov    $0x28,%eax
801066dd:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
801066e0:	8b 46 04             	mov    0x4(%esi),%eax
801066e3:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
801066e8:	0f 22 d8             	mov    %eax,%cr3
  popcli();
801066eb:	e8 6f db ff ff       	call   8010425f <popcli>
}
...
801066fb:	68 7e 75 10 80       	push   $0x8010757e
80106700:	e8 43 9c ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
80106705:	83 ec 0c             	sub    $0xc,%esp
80106708:	68 94 75 10 80       	push   $0x80107594
8010670d:	e8 36 9c ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
80106712:	83 ec 0c             	sub    $0xc,%esp
80106715:	68 a9 75 10 80       	push   $0x801075a9
8010671a:	e8 29 9c ff ff       	call   80100348 <panic>
...
80106724:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
80106727:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010672d:	77 4c                	ja     8010677b <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
8010672f:	e8 87 b9 ff ff       	call   801020bb <kalloc>
80106734:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106736:	83 ec 04             	sub    $0x4,%esp
80106739:	68 00 10 00 00       	push   $0x1000
8010673e:	6a 00                	push   $0x0
80106740:	50                   	push   %eax
80106741:	e8 65 dc ff ff       	call   801043ab <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106746:	83 c4 08             	add    $0x8,%esp
80106749:	6a 06                	push   $0x6
8010674b:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106751:	50                   	push   %eax
80106752:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106757:	ba 00 00 00 00       	mov    $0x0,%edx
8010675c:	8b 45 08             	mov    0x8(%ebp),%eax
8010675f:	e8 cf fc ff ff       	call   80106433 <mappages>
  memmove(mem, init, sz);
80106764:	83 c4 0c             	add    $0xc,%esp
80106767:	56                   	push   %esi
80106768:	ff 75 0c             	pushl  0xc(%ebp)
8010676b:	53                   	push   %ebx
8010676c:	e8 b5 dc ff ff       	call   80104426 <memmove>
}
80106771:	83 c4 10             	add    $0x10,%esp
80106774:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106777:	5b                   	pop    %ebx
80106778:	5e                   	pop    %esi
80106779:	5d                   	pop    %ebp
8010677a:	c3                   	ret    
...
8010677e:	68 bd 75 10 80       	push   $0x801075bd
...
80106791:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80106794:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
8010679b:	75 07                	jne    801067a4 <loaduvm+0x1c>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
8010679d:	bb 00 00 00 00       	mov    $0x0,%ebx
801067a2:	eb 3c                	jmp    801067e0 <loaduvm+0x58>
    panic("loaduvm: addr must be page aligned");
801067a4:	83 ec 0c             	sub    $0xc,%esp
801067a7:	68 78 76 10 80       	push   $0x80107678
801067ac:	e8 97 9b ff ff       	call   80100348 <panic>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801067b1:	83 ec 0c             	sub    $0xc,%esp
801067b4:	68 d7 75 10 80       	push   $0x801075d7
...
801067be:	05 00 00 00 80       	add    $0x80000000,%eax
801067c3:	56                   	push   %esi
801067c4:	89 da                	mov    %ebx,%edx
801067c6:	03 55 14             	add    0x14(%ebp),%edx
801067c9:	52                   	push   %edx
801067ca:	50                   	push   %eax
801067cb:	ff 75 10             	pushl  0x10(%ebp)
801067ce:	e8 a0 af ff ff       	call   80101773 <readi>
801067d3:	83 c4 10             	add    $0x10,%esp
801067d6:	39 f0                	cmp    %esi,%eax
801067d8:	75 47                	jne    80106821 <loaduvm+0x99>
  for(i = 0; i < sz; i += PGSIZE){
801067da:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801067e0:	39 fb                	cmp    %edi,%ebx
801067e2:	73 30                	jae    80106814 <loaduvm+0x8c>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801067e4:	89 da                	mov    %ebx,%edx
801067e6:	03 55 0c             	add    0xc(%ebp),%edx
801067e9:	b9 00 00 00 00       	mov    $0x0,%ecx
801067ee:	8b 45 08             	mov    0x8(%ebp),%eax
801067f1:	e8 cd fb ff ff       	call   801063c3 <walkpgdir>
801067f6:	85 c0                	test   %eax,%eax
801067f8:	74 b7                	je     801067b1 <loaduvm+0x29>
    pa = PTE_ADDR(*pte);
801067fa:	8b 00                	mov    (%eax),%eax
801067fc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106801:	89 fe                	mov    %edi,%esi
80106803:	29 de                	sub    %ebx,%esi
80106805:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010680b:	76 b1                	jbe    801067be <loaduvm+0x36>
      n = PGSIZE;
8010680d:	be 00 10 00 00       	mov    $0x1000,%esi
80106812:	eb aa                	jmp    801067be <loaduvm+0x36>
      return -1;
  }
  return 0;
...
80106826:	eb f1                	jmp    80106819 <loaduvm+0x91>
...
80106831:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80106834:	39 7d 10             	cmp    %edi,0x10(%ebp)
80106837:	73 11                	jae    8010684a <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
80106839:	8b 45 10             	mov    0x10(%ebp),%eax
8010683c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106842:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106848:	eb 19                	jmp    80106863 <deallocuvm+0x3b>
    return oldsz;
8010684a:	89 f8                	mov    %edi,%eax
8010684c:	eb 64                	jmp    801068b2 <deallocuvm+0x8a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010684e:	c1 eb 16             	shr    $0x16,%ebx
80106851:	83 c3 01             	add    $0x1,%ebx
80106854:	c1 e3 16             	shl    $0x16,%ebx
80106857:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010685d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106863:	39 fb                	cmp    %edi,%ebx
80106865:	73 48                	jae    801068af <deallocuvm+0x87>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106867:	b9 00 00 00 00       	mov    $0x0,%ecx
8010686c:	89 da                	mov    %ebx,%edx
8010686e:	8b 45 08             	mov    0x8(%ebp),%eax
80106871:	e8 4d fb ff ff       	call   801063c3 <walkpgdir>
80106876:	89 c6                	mov    %eax,%esi
    if(!pte)
80106878:	85 c0                	test   %eax,%eax
8010687a:	74 d2                	je     8010684e <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
8010687c:	8b 00                	mov    (%eax),%eax
8010687e:	a8 01                	test   $0x1,%al
80106880:	74 db                	je     8010685d <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106882:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106887:	74 19                	je     801068a2 <deallocuvm+0x7a>
        panic("kfree");
      char *v = P2V(pa);
80106889:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010688e:	83 ec 0c             	sub    $0xc,%esp
80106891:	50                   	push   %eax
80106892:	e8 0d b7 ff ff       	call   80101fa4 <kfree>
      *pte = 0;
80106897:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
8010689d:	83 c4 10             	add    $0x10,%esp
801068a0:	eb bb                	jmp    8010685d <deallocuvm+0x35>
        panic("kfree");
801068a2:	83 ec 0c             	sub    $0xc,%esp
801068a5:	68 e6 6e 10 80       	push   $0x80106ee6
801068aa:	e8 99 9a ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
801068af:	8b 45 10             	mov    0x10(%ebp),%eax
}
...
801068c3:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
801068c6:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801068c9:	85 ff                	test   %edi,%edi
801068cb:	0f 88 c1 00 00 00    	js     80106992 <allocuvm+0xd8>
  if(newsz < oldsz)
801068d1:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801068d4:	72 5c                	jb     80106932 <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
801068d6:	8b 45 0c             	mov    0xc(%ebp),%eax
801068d9:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801068df:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
801068e5:	39 fb                	cmp    %edi,%ebx
801068e7:	0f 83 ac 00 00 00    	jae    80106999 <allocuvm+0xdf>
    mem = kalloc();
801068ed:	e8 c9 b7 ff ff       	call   801020bb <kalloc>
801068f2:	89 c6                	mov    %eax,%esi
    if(mem == 0){
801068f4:	85 c0                	test   %eax,%eax
801068f6:	74 42                	je     8010693a <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
801068f8:	83 ec 04             	sub    $0x4,%esp
801068fb:	68 00 10 00 00       	push   $0x1000
80106900:	6a 00                	push   $0x0
80106902:	50                   	push   %eax
80106903:	e8 a3 da ff ff       	call   801043ab <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106908:	83 c4 08             	add    $0x8,%esp
8010690b:	6a 06                	push   $0x6
8010690d:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106913:	50                   	push   %eax
80106914:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106919:	89 da                	mov    %ebx,%edx
8010691b:	8b 45 08             	mov    0x8(%ebp),%eax
8010691e:	e8 10 fb ff ff       	call   80106433 <mappages>
80106923:	83 c4 10             	add    $0x10,%esp
80106926:	85 c0                	test   %eax,%eax
80106928:	78 38                	js     80106962 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
8010692a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106930:	eb b3                	jmp    801068e5 <allocuvm+0x2b>
    return oldsz;
80106932:	8b 45 0c             	mov    0xc(%ebp),%eax
80106935:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106938:	eb 5f                	jmp    80106999 <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
8010693a:	83 ec 0c             	sub    $0xc,%esp
8010693d:	68 f5 75 10 80       	push   $0x801075f5
80106942:	e8 c4 9c ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106947:	83 c4 0c             	add    $0xc,%esp
8010694a:	ff 75 0c             	pushl  0xc(%ebp)
8010694d:	57                   	push   %edi
8010694e:	ff 75 08             	pushl  0x8(%ebp)
80106951:	e8 d2 fe ff ff       	call   80106828 <deallocuvm>
      return 0;
80106956:	83 c4 10             	add    $0x10,%esp
80106959:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106960:	eb 37                	jmp    80106999 <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
80106962:	83 ec 0c             	sub    $0xc,%esp
80106965:	68 0d 76 10 80       	push   $0x8010760d
8010696a:	e8 9c 9c ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010696f:	83 c4 0c             	add    $0xc,%esp
80106972:	ff 75 0c             	pushl  0xc(%ebp)
80106975:	57                   	push   %edi
80106976:	ff 75 08             	pushl  0x8(%ebp)
80106979:	e8 aa fe ff ff       	call   80106828 <deallocuvm>
      kfree(mem);
8010697e:	89 34 24             	mov    %esi,(%esp)
80106981:	e8 1e b6 ff ff       	call   80101fa4 <kfree>
      return 0;
80106986:	83 c4 10             	add    $0x10,%esp
80106989:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106990:	eb 07                	jmp    80106999 <allocuvm+0xdf>
    return 0;
80106992:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
80106999:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010699c:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010699f:	5b                   	pop    %ebx
801069a0:	5e                   	pop    %esi
801069a1:	5f                   	pop    %edi
801069a2:	5d                   	pop    %ebp
...
801069ae:	74 1a                	je     801069ca <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
801069b0:	83 ec 04             	sub    $0x4,%esp
801069b3:	6a 00                	push   $0x0
801069b5:	68 00 00 00 80       	push   $0x80000000
801069ba:	56                   	push   %esi
801069bb:	e8 68 fe ff ff       	call   80106828 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801069c0:	83 c4 10             	add    $0x10,%esp
801069c3:	bb 00 00 00 00       	mov    $0x0,%ebx
801069c8:	eb 10                	jmp    801069da <freevm+0x36>
    panic("freevm: no pgdir");
801069ca:	83 ec 0c             	sub    $0xc,%esp
801069cd:	68 29 76 10 80       	push   $0x80107629
801069d2:	e8 71 99 ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
801069d7:	83 c3 01             	add    $0x1,%ebx
801069da:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
801069e0:	77 1f                	ja     80106a01 <freevm+0x5d>
    if(pgdir[i] & PTE_P){
801069e2:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
801069e5:	a8 01                	test   $0x1,%al
801069e7:	74 ee                	je     801069d7 <freevm+0x33>
      char * v = P2V(PTE_ADDR(pgdir[i]));
801069e9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801069ee:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
801069f3:	83 ec 0c             	sub    $0xc,%esp
801069f6:	50                   	push   %eax
801069f7:	e8 a8 b5 ff ff       	call   80101fa4 <kfree>
801069fc:	83 c4 10             	add    $0x10,%esp
801069ff:	eb d6                	jmp    801069d7 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
80106a01:	83 ec 0c             	sub    $0xc,%esp
80106a04:	56                   	push   %esi
80106a05:	e8 9a b5 ff ff       	call   80101fa4 <kfree>
}
80106a0a:	83 c4 10             	add    $0x10,%esp
80106a0d:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106a10:	5b                   	pop    %ebx
80106a11:	5e                   	pop    %esi
80106a12:	5d                   	pop    %ebp
80106a13:	c3                   	ret    
...
80106a42:	73 35                	jae    80106a79 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
80106a44:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106a47:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106a4a:	29 c1                	sub    %eax,%ecx
80106a4c:	83 ec 08             	sub    $0x8,%esp
80106a4f:	ff 73 0c             	pushl  0xc(%ebx)
80106a52:	50                   	push   %eax
80106a53:	8b 13                	mov    (%ebx),%edx
80106a55:	89 f0                	mov    %esi,%eax
80106a57:	e8 d7 f9 ff ff       	call   80106433 <mappages>
80106a5c:	83 c4 10             	add    $0x10,%esp
80106a5f:	85 c0                	test   %eax,%eax
80106a61:	78 05                	js     80106a68 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106a63:	83 c3 10             	add    $0x10,%ebx
80106a66:	eb d4                	jmp    80106a3c <setupkvm+0x28>
      freevm(pgdir);
80106a68:	83 ec 0c             	sub    $0xc,%esp
80106a6b:	56                   	push   %esi
80106a6c:	e8 33 ff ff ff       	call   801069a4 <freevm>
      return 0;
80106a71:	83 c4 10             	add    $0x10,%esp
80106a74:	be 00 00 00 00       	mov    $0x0,%esi
}
80106a79:	89 f0                	mov    %esi,%eax
80106a7b:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106a7e:	5b                   	pop    %ebx
80106a7f:	5e                   	pop    %esi
80106a80:	5d                   	pop    %ebp
80106a81:	c3                   	ret    
...
80106a85:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106a88:	e8 87 ff ff ff       	call   80106a14 <setupkvm>
80106a8d:	a3 c4 71 11 80       	mov    %eax,0x801171c4
  switchkvm();
80106a92:	e8 5e fb ff ff       	call   801065f5 <switchkvm>
}
80106a97:	c9                   	leave  
80106a98:	c3                   	ret    
...
80106aa4:	8b 55 0c             	mov    0xc(%ebp),%edx
80106aa7:	8b 45 08             	mov    0x8(%ebp),%eax
80106aaa:	e8 14 f9 ff ff       	call   801063c3 <walkpgdir>
  if(pte == 0)
80106aaf:	85 c0                	test   %eax,%eax
80106ab1:	74 05                	je     80106ab8 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106ab3:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106ab6:	c9                   	leave  
80106ab7:	c3                   	ret    
    panic("clearpteu");
80106ab8:	83 ec 0c             	sub    $0xc,%esp
80106abb:	68 3a 76 10 80       	push   $0x8010763a
80106ac0:	e8 83 98 ff ff       	call   80100348 <panic>
...
80106ac8:	57                   	push   %edi
80106ac9:	56                   	push   %esi
80106aca:	53                   	push   %ebx
80106acb:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80106ace:	e8 41 ff ff ff       	call   80106a14 <setupkvm>
80106ad3:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106ad6:	85 c0                	test   %eax,%eax
80106ad8:	0f 84 c4 00 00 00    	je     80106ba2 <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106ade:	bf 00 00 00 00       	mov    $0x0,%edi
80106ae3:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106ae6:	0f 83 b6 00 00 00    	jae    80106ba2 <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106aec:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106aef:	b9 00 00 00 00       	mov    $0x0,%ecx
80106af4:	89 fa                	mov    %edi,%edx
80106af6:	8b 45 08             	mov    0x8(%ebp),%eax
80106af9:	e8 c5 f8 ff ff       	call   801063c3 <walkpgdir>
80106afe:	85 c0                	test   %eax,%eax
80106b00:	74 65                	je     80106b67 <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106b02:	8b 00                	mov    (%eax),%eax
80106b04:	a8 01                	test   $0x1,%al
80106b06:	74 6c                	je     80106b74 <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106b08:	89 c6                	mov    %eax,%esi
80106b0a:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
80106b10:	25 ff 0f 00 00       	and    $0xfff,%eax
80106b15:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
80106b18:	e8 9e b5 ff ff       	call   801020bb <kalloc>
80106b1d:	89 c3                	mov    %eax,%ebx
80106b1f:	85 c0                	test   %eax,%eax
80106b21:	74 6a                	je     80106b8d <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106b23:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106b29:	83 ec 04             	sub    $0x4,%esp
80106b2c:	68 00 10 00 00       	push   $0x1000
80106b31:	56                   	push   %esi
80106b32:	50                   	push   %eax
80106b33:	e8 ee d8 ff ff       	call   80104426 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106b38:	83 c4 08             	add    $0x8,%esp
80106b3b:	ff 75 e0             	pushl  -0x20(%ebp)
80106b3e:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106b44:	50                   	push   %eax
80106b45:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106b4a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106b4d:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106b50:	e8 de f8 ff ff       	call   80106433 <mappages>
80106b55:	83 c4 10             	add    $0x10,%esp
80106b58:	85 c0                	test   %eax,%eax
80106b5a:	78 25                	js     80106b81 <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
80106b5c:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106b62:	e9 7c ff ff ff       	jmp    80106ae3 <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
80106b67:	83 ec 0c             	sub    $0xc,%esp
80106b6a:	68 44 76 10 80       	push   $0x80107644
80106b6f:	e8 d4 97 ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
80106b74:	83 ec 0c             	sub    $0xc,%esp
80106b77:	68 5e 76 10 80       	push   $0x8010765e
80106b7c:	e8 c7 97 ff ff       	call   80100348 <panic>
      kfree(mem);
...
80106b90:	ff 75 dc             	pushl  -0x24(%ebp)
80106b93:	e8 0c fe ff ff       	call   801069a4 <freevm>
  return 0;
80106b98:	83 c4 10             	add    $0x10,%esp
80106b9b:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
80106ba2:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
80106bb0:	83 ec 08             	sub    $0x8,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80106bb3:	b9 00 00 00 00       	mov    $0x0,%ecx
80106bb8:	8b 55 0c             	mov    0xc(%ebp),%edx
80106bbb:	8b 45 08             	mov    0x8(%ebp),%eax
80106bbe:	e8 00 f8 ff ff       	call   801063c3 <walkpgdir>
  if((*pte & PTE_P) == 0)
80106bc3:	8b 00                	mov    (%eax),%eax
80106bc5:	a8 01                	test   $0x1,%al
80106bc7:	74 10                	je     80106bd9 <uva2ka+0x2c>
    return 0;
  if((*pte & PTE_U) == 0)
80106bc9:	a8 04                	test   $0x4,%al
80106bcb:	74 13                	je     80106be0 <uva2ka+0x33>
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
80106bcd:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106bd2:	05 00 00 00 80       	add    $0x80000000,%eax
}
80106bd7:	c9                   	leave  
80106bd8:	c3                   	ret    
    return 0;
80106bd9:	b8 00 00 00 00       	mov    $0x0,%eax
80106bde:	eb f7                	jmp    80106bd7 <uva2ka+0x2a>
    return 0;
80106be0:	b8 00 00 00 00       	mov    $0x0,%eax
80106be5:	eb f0                	jmp    80106bd7 <uva2ka+0x2a>
...
80106bec:	53                   	push   %ebx
80106bed:	83 ec 0c             	sub    $0xc,%esp
80106bf0:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80106bf3:	eb 25                	jmp    80106c1a <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
80106bf5:	8b 55 0c             	mov    0xc(%ebp),%edx
80106bf8:	29 f2                	sub    %esi,%edx
80106bfa:	01 d0                	add    %edx,%eax
80106bfc:	83 ec 04             	sub    $0x4,%esp
80106bff:	53                   	push   %ebx
80106c00:	ff 75 10             	pushl  0x10(%ebp)
80106c03:	50                   	push   %eax
80106c04:	e8 1d d8 ff ff       	call   80104426 <memmove>
    len -= n;
80106c09:	29 df                	sub    %ebx,%edi
    buf += n;
80106c0b:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80106c0e:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
80106c14:	89 45 0c             	mov    %eax,0xc(%ebp)
80106c17:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
80106c1a:	85 ff                	test   %edi,%edi
80106c1c:	74 2f                	je     80106c4d <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
80106c1e:	8b 75 0c             	mov    0xc(%ebp),%esi
80106c21:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106c27:	83 ec 08             	sub    $0x8,%esp
80106c2a:	56                   	push   %esi
80106c2b:	ff 75 08             	pushl  0x8(%ebp)
80106c2e:	e8 7a ff ff ff       	call   80106bad <uva2ka>
    if(pa0 == 0)
80106c33:	83 c4 10             	add    $0x10,%esp
80106c36:	85 c0                	test   %eax,%eax
80106c38:	74 20                	je     80106c5a <copyout+0x73>
    n = PGSIZE - (va - va0);
80106c3a:	89 f3                	mov    %esi,%ebx
80106c3c:	2b 5d 0c             	sub    0xc(%ebp),%ebx
80106c3f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
80106c45:	39 df                	cmp    %ebx,%edi
80106c47:	73 ac                	jae    80106bf5 <copyout+0xe>
      n = len;
80106c49:	89 fb                	mov    %edi,%ebx
80106c4b:	eb a8                	jmp    80106bf5 <copyout+0xe>
  }
  return 0;
...
80106c5f:	eb f1                	jmp    80106c52 <copyout+0x6b>
